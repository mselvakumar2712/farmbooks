...
/** View Crop master related view by using the given functions **/
    public function index(){
		if (!check_staff_permission($_SESSION['profile_type'], 100101)){
            redirect(base_url('staff/access_denied'), 'refresh');  
        }
	...
	public function addcrop(){
		if (!check_staff_permission($_SESSION['profile_type'], 100102)){
            redirect(base_url('staff/access_denied'), 'refresh');  
        }
	...
	public function edit_crop($crop_id){
	    if (!check_staff_permission($_SESSION['profile_type'], 100103)){
            redirect(base_url('staff/access_denied'), 'refresh');  
        }
