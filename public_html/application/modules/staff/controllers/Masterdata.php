...
class Masterdata extends CI_Controller {
   ...
   public function __construct() {
      ...
      header('Access-Control-Allow-Origin: *');
		if(!check_staff_permission($_SESSION['profile_type'], 210) || !check_staff_permission($_SESSION['profile_type'], 216) || !check_staff_permission($_SESSION['profile_type'], 211)){
	...
	public function post_state() {
		if( $this->Location_Model->add_state()){
		 ...
		 redirect('staff/masterdata/statelist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_state');
		}
	}
    ...
    public function updatestate() {
		...
		if($this->Location_Model->update_state($state_id)){
		 ...
		 redirect('staff/masterdata/edit_state');
		}
	}
    ...
    public function delete_state( $state_id ) {
        ...
        redirect('staff/masterdata/statelist',"refresh");
	}
	...
	public function post_district() {
		...
		if(!empty($result)){
		 ...
		 redirect('staff/masterdata/districtlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_district');
		}
	}
    ...
    public function updatedistrict($district_id) {
		if($this->Location_Model->update_district($district_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_district');
		}
	}
    ...
    public function delete_district( $district_id ) {
        ...
        redirect('staff/masterdata/districtlist',"refresh");
	}
	//district master end//
	...
	public function post_block() {
		if( $this->Location_Model->add_block()){
		 ...
		 redirect('staff/masterdata/blocklist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_block');
		}
	}
    ...
    public function updateblock($block_id) {
		if($this->Location_Model->update_block($block_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_block');
		}
	}
    ...
    public function delete_block( $block_id ) {
        ...
        redirect('staff/masterdata/blocklist',"refresh");
	}
	//block master end//
	...
	public function post_taluk() {
		if($this->Location_Model->add_taluk()){
		 ...
		 redirect('staff/masterdata/taluklist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/viewtaluk');
		}
	}
    ...
    public function delete_taluk( $taluk_id ) {
        ...
        redirect('staff/masterdata/taluklist',"refresh");
	}
	...
	public function post_panchayat() {
		if($this->Location_Model->add_panchayat()){
		 ...
		 redirect('staff/masterdata/grampanchayatlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/viewpanchayat');
		}
	}
    ...
    public function delete_panchayat($panchayat_id) {
        ...
        redirect('staff/masterdata/grampanchayatlist',"refresh");
	}
	...
	public function post_village() {
		if($this->Location_Model->add_village()){
		 ...
		 redirect('staff/masterdata/villagelist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/viewvillage');
		}
	}
    ...
    public function delete_village($village_id) {
        ...
        redirect('staff/masterdata/villagelist',"refresh");
	}
	...
	public function post_category() {
        if( $this->Masterdata_Model->add_category()){
		 ...
		 redirect('staff/masterdata/categorylist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_category');
		}
	}
	 ...
	 public function updatecategory($category_id) {
		...
		if($this->Masterdata_Model->update_category($category_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_category');
		}
	}
	...
	public function delete_category( $category_id ) {
        ...
        redirect('staff/masterdata/categorylist',"refresh");
	}
	...
	public function post_subcategory() {
        if( $this->Masterdata_Model->add_subcategory()){
		 ...
		 redirect('staff/masterdata/subcategorylist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_subcategory');
		}
	}
	 ...
	 public function updatesubcategory($subcategory_id) {
		if($this->Masterdata_Model->update_subcategory($subcategory_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_subcategory');
		}
	}
	...
	public function delete_subcategory( $subcategory_id ) {
        ...
        redirect('staff/masterdata/subcategorylist',"refresh");
	}
	...
	public function getsubcategory() { 	 
		...
		} else if($this->input->post('stock_group_id') == 2){
	...
	public function getproduct(){
		...
		if($this->input->post('stock_group_id') == 1){
			...
			} else if($this->input->post('category_id') == 4){
				$result = $this->Masterdata_Model->brandListBySuppliers(2, $subcategory_id);
			} else if($this->input->post('category_id') == 5){
   ...
   public function gstdetail() {        
	...
	public function post_product() {
		if( $this->Masterdata_Model->add_product()){
		 ...
		 redirect('staff/masterdata/productlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_product');
		}
	}
    ...
    public function updateproduct($product_id) {
		if($this->Masterdata_Model->update_product($product_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_product');
		}
	}
    ...
    public function delete_product( $product_id ) {
        ...
        redirect('staff/masterdata/productlist',"refresh");
	}
	...
	public function productfpolist(){
		if(!check_staff_permission($_SESSION['profile_type'], 21001)){
            redirect(base_url('staff/access_denied'), 'refresh');  
        }
	...
	public function addproductfpo(){
		if(!check_staff_permission($_SESSION['profile_type'], 21002)){
            redirect(base_url('staff/access_denied'), 'refresh');  
        }
        $data['page'] = 'Product FPO Mapping';
	...
	public function post_productfpo(){
		if($this->Masterdata_Model->add_productfpo()){
		 $this->session->set_flashdata('success', 'New Product added successfully');       
		 redirect('staff/masterdata/productfpolist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/productfpolist');
		}
    ...
    public function delete_productfpo( $product_id ) {
        ...
        redirect('staff/masterdata/productfpolist',"refresh");
	}	
	...
	public function post_bank() {
		if( $this->Masterdata_Model->add_bank()){
		 ...
		 redirect('staff/masterdata/banklist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_bank');
		}
	}
    ...
    public function delete_bank( $bank_id ) {
		...
		$this->session->set_flashdata('success', 'Product Deleted successfully');
        redirect('staff/masterdata/banklist',"refresh");
	}
	//bank master end//
	...
	public function post_uom() {
		if( $this->Masterdata_Model->add_uom()){
		 ...
		 redirect('staff/masterdata/uomlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/adduom');
		}
	}
    ...
    public function delete_uom( $uom_id ) {
        ...
        redirect('staff/masterdata/uomlist',"refresh");
	}
	//uom master end//
	...
	public function post_humidity() {
		if($this->Masterdata_Model->add_humidity()){
		 ...
		 redirect('staff/masterdata/humiditylist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addhumidity');
		}
	}
    ...
    public function delete_humidity( $humidity_id ) {
        ...
        redirect('staff/masterdata/humiditylist',"refresh");
	}
	//humidity master end//
	...
	public function post_size() {
		if($this->Masterdata_Model->add_size()){
		 ...
		 redirect('staff/masterdata/sizelist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addsize');
		}
	}
    ...
    public function delete_size( $size_id ) {
        ...
        redirect('staff/masterdata/sizelist',"refresh");
	}
	//size master end//  
	...
	public function post_colour() {
		if($this->Masterdata_Model->add_colour()){
		 ...
		 redirect('staff/masterdata/colourlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addcolour');
		}
	}
    ...
    public function delete_colour($colour_id) {
        ...
        redirect('staff/masterdata/colourlist',"refresh");
	}
	//colour master end//  	
	
	//godown master start//	
	public function godownlist(){
		if(!check_staff_permission($_SESSION['profile_type'], 21601)){
            redirect(base_url('staff/access_denied'), 'refresh');  
        }
	...
	public function addgodown(){
		if(!check_staff_permission($_SESSION['profile_type'], 21602)){
            redirect(base_url('staff/access_denied'), 'refresh');  
        }
        $data['page'] = 'Godown Master';
	...
	public function post_godown() {
		if( $this->Masterdata_Model->add_godown()){
		 ...
		 redirect('staff/masterdata/godownlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addgodown');
		}
	}
    ...
    public function delete_godown( $godown_id ) {
        ...
        redirect('staff/masterdata/godownlist',"refresh");
	}
	...
	public function post_business() {
		if( $this->Masterdata_Model->add_business_nature()){
		 ...
		 redirect('staff/masterdata/natureofbusinesslist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/add_business');
		}
	}
    ...
    public function updatebusiness( $business_id ) {
		if($this->Masterdata_Model->update_business_nature($business_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_business');
		}
	}
    ...
    public function delete_business( $business_id ) {
        ...
        redirect('staff/masterdata/natureofbusinesslist',"refresh");
	}
	...
	public function post_seed() {
		if( $this->Masterdata_Model->add_seed()){
		 ...
		 redirect('staff/masterdata/seedlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addseed');
		}
	}
    ...
    public function updateseed($seed_id) {
		if($this->Masterdata_Model->update_seed($seed_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/viewseed');
		}
	}
    ...
    public function delete_seed( $seed_id ) {
        ...
        redirect('staff/masterdata/seedlist',"refresh");
	}
	//seed master   end//  
	...
	public function post_nutrient() {
		if( $this->Masterdata_Model->add_nutrient()){
		 ...
		 redirect('staff/masterdata/nutrientlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addnutrient');
		}
	}
    ...
    public function updatenutrient($nutrient_id) {
		if($this->Masterdata_Model->update_nutrient($nutrient_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/viewnutrient');
		}
	}
    ...
    public function delete_nutrient( $nutrient_id ) {
        ...
        redirect('staff/masterdata/nutrientlist',"refresh");
	}
	//nutrient master end//
	...
	public function post_fertilizer() {
		if( $this->Masterdata_Model->add_fertilizer()){
		 ...
		 redirect('staff/masterdata/fertilizerlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addfertilizer');
		}
	}
    ...
    public function updatefertilizer($fertilizer_id) {
		if($this->Masterdata_Model->update_fertilizer($fertilizer_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/viewfertilizer');
		}
	}
    ...
    public function delete_fertilizer( $fertilizer_id ) {
        ...
        redirect('staff/masterdata/pesticideslist',"refresh");
	}
	...
	public function post_pesticides() {
		if( $this->Masterdata_Model->add_pesticide()){
		 ...
		 redirect('staff/masterdata/pesticideslist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addpesticides');
		}
	}
	...
	public function post_season() {
		if( $this->Masterdata_Model->add_season()){
		 ...
		 redirect('staff/masterdata/seasonlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addseason');
		}
	}
	...
	public function delete_season($season_id) {
        ...
        redirect('staff/masterdata/seasonlist',"refresh");
	}
	//season master end//
	...
	public function post_postharvest() {
		if( $this->Masterdata_Model->add_postharvest()){
		 ...
		 redirect('staff/masterdata/postharvestlist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addpostharvest');
		}
	}
	...
	public function delete_postharvest($postharvest_id) {
        ...
        redirect('staff/masterdata/postharvestlist',"refresh");
	}
	...
	public function post_farmimplements() {
		if( $this->Masterdata_Model->add_farm_implements()){
		 ...
		 redirect('staff/masterdata/farmimplementslist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addfarmimplements');
		}
	}
	 ...
	 public function update_farmimplements($farmimplements_id) {
		if($this->Masterdata_Model->update_farm_implements($farmimplements_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_farmimplements');
		}
	}
	...
	public function delete_farmimplements($farmimplements_id) {
        ...
        redirect('staff/masterdata/farmimplementslist',"refresh");
	}
	...
	public function post_farmimplementsmake() {
		if( $this->Masterdata_Model->add_farm_implements_make()){
		 ...
		 redirect('staff/masterdata/farmimplementsmakelist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addfarmimplementsmake');
		}
	}
	...
	public function delete_farmimplementsmake($farm_id) {
        ...
        redirect('staff/masterdata/farmimplementsmakelist',"refresh");
	}
	...
	public function post_live_stocks() {
		if( $this->Masterdata_Model->add_live_stock()){
		 ...
		 redirect('staff/masterdata/livestockslist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/addlivestocks');
		}
	}
	 ...
	 public function updatelive_stocks() {
		...
		if($this->Masterdata_Model->update_live_stock($livestock_id)){
		 ...
		 $this->session->set_flashdata('warning', 'Data not updated.');       
		 redirect('staff/masterdata/edit_livestocks');
		}
	}
	...
	public function delete_livestocks($livestock_id) {
		...
		$this->session->set_flashdata('success', 'Live stocks Deleted successfully');
        redirect('staff/masterdata/livestockslist',"refresh");
	}
	...
	public function post_live_stocks_variety() {
		if( $this->Masterdata_Model->add_live_stock_variety()){
		 ...
		 redirect('staff/masterdata/livestocksvarietylist');
		}else{
		 $this->session->set_flashdata('warning', 'Data not inserted.');       
		 redirect('staff/masterdata/livestocksvarietylist');
		}
	...
	public function delete_livestocks_variety($livestock_id) {
        ...
        redirect('staff/masterdata/livestocksvarietylist',"refresh");
	}
