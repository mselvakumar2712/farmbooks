       ...
       <div class="breadcrumbs">
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Search Outstanding Purchase Orders</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/inventory/outstandingpurchase');?>">Search Outstanding Purchase Orders</a></li>
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
			  <form  action="<?php echo base_url('fpo/inventory/getoutstandingorder')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >
				<div class="container">
				<div class="row ">
					<div class="form-group col-md-3">
						<label for="inputAddress2">PO Order No.</label>
						<input  class="form-control" type="text"  placeholder="" maxlength="10" id="reference" name="reference" >
                    ...
                    <div class="card">
						<div class="card-body">
						  <table id="example" class="table table-striped table-bordered" width="100%">
							...
							<td>
							<a href="<?php echo base_url('fpo/inventory/grn/' . $row->order_no); ?>"  class="text-success" title="Edit">GRN</a>
							</td>
							</tr>
							<?php endforeach; ?>
							<?php } ?>
