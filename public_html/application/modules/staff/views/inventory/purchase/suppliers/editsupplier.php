			...
			<div class="content mt-3">
				...
				<div class="animated fadeIn">
                  ...
                  <?php 
                           if($page_module == 'inventory') {
                              ?>
                             <form  action="<?php echo base_url('staff/inventory/postupdatesuppliers/'.$supplier_info[0]->supplier_id)?>" method="post" id="supplier_add" name="sentMessage" role="form" id="form-step-0" novalidate="novalidate" data-toggle="validator">           
                           <?php }else if($page_module == 'finance') {
                              ?>
                                <form  action="<?php echo base_url('staff/finance/postupdatesuppliers/'.$supplier_info[0]->supplier_id)?>" method="post" id="supplier_add" name="sentMessage" role="form" id="form-step-0" novalidate="novalidate" data-toggle="validator">           
                           <?php }else {
                              ?>
                                <form  action="<?php echo base_url('staff/inventory/postupdatesuppliers/'.$supplier_info[0]->supplier_id)?>" method="post" id="supplier_add" name="sentMessage" role="form" id="form-step-0" novalidate="novalidate" data-toggle="validator">           
                           <?php }?>
							...
							<div class="container-fluid">
                              ...
                              <div class="form-group col-md-3">
                                 ...
                                 <div class="form-group col-md-3">
												...
												<input type="text" class="form-control numberOnly"  maxlength="15"  value="<?php echo $supplier_info[0]->opening_balance; ?>" id="opening_balance" name="opening_balance" placeholder="Opening Balance">														 
												</div>
											<div class="col-md-3">
												...
												<label class=" form-control-label">Balance Type<span class="text-danger">*</span></label>
												 <select id="transaction_type" name="transaction_type" class="form-control" required >
													...
													<option value="1" <?php if($supplier_info[0]->transaction_type == 1){ ?>selected<?php } ?>>Credit</option>
													<option value="2" <?php if($supplier_info[0]->transaction_type == 2){ ?>selected<?php } ?>>Debit</option>
												</select>
													<div class="help-block with-errors text-danger"></div>
												</div>
										</div>
                               ...
                               <?php 
                                 if($page_module == 'inventory') {
                                 ?>
                              <a href="<?php echo base_url('staff/inventory/suppliers');?>" id="cancel" class="btn btn-outline-dark btn-fs ml-2" > <i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
                                 <?php }else if($page_module == 'finance') {
                                 ?>
                              <a href="<?php echo base_url('staff/finance/suppliers');?>" id="cancel" class="btn btn-outline-dark btn-fs ml-2" > <i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
                                 <?php }else {
                                 ?>
                              <a href="<?php echo base_url('staff/inventory/suppliers');?>" id="cancel" class="btn btn-outline-dark btn-fs ml-2" > <i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
                                 <?php }?>
