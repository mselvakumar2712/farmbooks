						...
						<div class="page-title">
                         ...
                         <?php 
                           if($page_module == 'inventory') {
                              ?>
								<li><a class="active" href="<?php echo base_url('staff/inventory/suppliers');?>">Suppliers</a></li>
                           <?php }else if($page_module == 'finance') {
                              ?>
								<li><a class="active" href="<?php echo base_url('staff/finance/suppliers');?>">Suppliers</a></li>
                           <?php }else {
                              ?>
								<li><a class="active" href="<?php echo base_url('staff/inventory/suppliers');?>">Suppliers</a></li>
                           <?php }?>
				...
				<div class="animated fadeIn">
					...
					<div class="card">
                        ...
                        <?php 
                           if($page_module == 'inventory') {
                              ?>
                             <form  action="<?php echo base_url('staff/inventory/post_suppliers')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >           
                           <?php }else if($page_module == 'finance') {
                              ?>
                                <form  action="<?php echo base_url('staff/finance/post_suppliers')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >           
                           <?php }else {
                              ?>
                                <form  action="<?php echo base_url('staff/inventory/post_suppliers')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >           
                           <?php }?>
                                 ...
                                 <h4 class="text-center text-success">Address</h1>
										...
										<div class="form-group col-md-6">	
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control numberOnly" pattern="^[6-9]\d{9}$" maxlength="10" id="billing_mobile_num" name="billing_mobile_num">
													 <div class="help-block with-errors text-danger"></div>
												</div>
												<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													<label for="inputAddress2">Mobile Number  </label>
													<input type="text" class="form-control numberOnly" pattern="^[6-9]\d{9}$" maxlength="10" id="shipping_mobile_num" name="shipping_mobile_num">
													<div class="help-block with-errors text-danger"></div>
												</div>
												<div class="form-group col-md-6">
													<label for="inputAddress2">STD Code</label>
                              ...
                              <div class="form-group col-md-3">
                                 ...
                                 <div class="form-group col-md-3">
												...
												<input type="text" class="form-control numberOnly"  maxlength="15"  id="opening_balance" name="opening_balance" placeholder="Opening Balance">														 
												</div>
											<div class="col-md-3">
                                 ...
                                 if($page_module == 'inventory') {
                                 ?>
                                 <a href="<?php echo base_url('staff/inventory/suppliers');?>" class="btn btn-outline-dark ml-2"><i class="fa fa-close" aria-hidden="true"></i>Cancel</a>
                                 <?php }else if($page_module == 'finance') {
                                 ?>
                                 <a href="<?php echo base_url('staff/finance/suppliers');?>" class="btn btn-outline-dark ml-2"><i class="fa fa-close" aria-hidden="true"></i>Cancel</a>
                                 <?php }else {
                                 ?>
                                 <a href="<?php echo base_url('staff/inventory/suppliers');?>" class="btn btn-outline-dark ml-2"><i class="fa fa-close" aria-hidden="true"></i>Cancel</a>
                                 <?php }?>
...
function fnCustomer(element, id) {
 ...
 $(document).on('click', function(event) {
	...
	if (this.checked==true) {
	 	...
	 	function activeClick(supplierval) {
				if(supplierval.checked == true) { 
					...
					$.ajax({
						url: '<?php echo base_url('staff/inventory/getallsupplier')?>',
						type: "GET",
						success:function(response) {
							responsearr=$.parseJSON(response);
					 ...
					 $("#supplier option").remove() ;		
					$.ajax({
						url: '<?php echo base_url('staff/inventory/getactivesupplier')?>',
						type: "GET",
						success:function(response) {
							responsearr=$.parseJSON(response);
							var div_data = '<option value="0">New Supplier</option>';
		...
		$('select[name="supplier"]').on('change', function(e) {
         ...
         if($page_module == 'inventory') {
         ?>
         window.location = "<?php echo base_url();?>staff/inventory/editsupplier/"+supplier;    
         <?php }else if($page_module == 'finance') {
         ?>
         window.location = "<?php echo base_url();?>staff/finance/editsupplier/"+supplier;          
         <?php }else {
         ?>
         window.location = "<?php echo base_url();?>staff/inventory/editsupplier/"+supplier;    
         <?php }?>
		...
		$('form[id="supplier_search"]').submit(function(e){
			...
			{
				 $.ajax({
					url:"<?php echo base_url();?>staff/inventory/suppliersearch",
					type:"POST",
					data:searchdata,
					dataType:"html",
					cache:false,			
				...
				alert('Please provide mandatory fields ');
					...
					swal({
					 ...
					 if (result.value) {          
						...
						$.ajax({
						  url: "<?php echo base_url();?>staff/inventory/delete_supplier/"+supplier_id,
						  type: "POST",
						  data: {
						  ...
						  success: function() {        
							 setTimeout(function() {
							  window.location.replace("<?php echo base_url('staff/inventory/suppliers')?>");
							 }, 1000);
						  },
						  error: function() {
   ...
   function getBankAddressByBankName( bank_name_id ) {
    ...
    if(bank_name_id != ''){    
	   $.ajax({
		  url:"<?php echo base_url();?>staff/inventory/getBankAddressByBankName",
		  type:"POST",
...
$('#pin_code').focusout(function(e) 
{
   ...
   function getbanklist(state_id) {
      $("#bank_name option").remove();
			$.ajax({
				url:"<?php echo base_url();?>staff/inventory/getbanklist/"+state_id,
				type:"GET",
				data:"",
				dataType:"html",
				cache:false,			
