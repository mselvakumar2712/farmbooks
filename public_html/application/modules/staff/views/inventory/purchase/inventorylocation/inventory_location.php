  ...
  <body>
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
			...
			<form  action="<?php echo base_url('staff/inventory/post_locationtransfer')?>" id="inventorylocation"  method="post"  name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
		...
		$('#dynamic_field').on('change', 'tr input[name="qty[]"]', function () {
			...
			if(from_loc == ""){
				...
				swal('',"Please select from location");
				   ...
				   $.ajax({
					url:"<?php echo base_url();?>staff/inventory/checkavailablequantity",
					type:"POST",
