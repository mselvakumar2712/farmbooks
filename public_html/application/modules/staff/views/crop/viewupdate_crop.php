                     ...
                     <input type="hidden"  name="updatebrandname" id="updatebrandname" > 
						...
						<!--weeding-->
                           ...
                           <div class="col-md-12 text-center">
                                 <div id="success"></div>
                                 <a href="<?php echo base_url('fpo/updatecrop/edit_updatecrop?id=').$_REQUEST['id']?>" id="edit" class="btn-fs btn btn-success text-center"><i class="fa fa-edit"></i> Edit Update Crop<a>
