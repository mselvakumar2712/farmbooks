      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('staff/fig');?>">FIG</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('staff/fig/updatefig/'.$fig_info['id'])?>" method="post" name="sentMessage" id="editfigform" novalidate="novalidate" >
									...
									<div class="card-body">
										...
										<div class="row row-space">
										 ...
										 <div class="col-md-12 text-center">
											  <div id="success"></div>
												<?php if(check_staff_permission($_SESSION['profile_type'], 10403)){ ?>
												...
												<a href="<?php echo base_url('staff/fig');?>" id="ok"  class="btn-fs btn btn-outline-dark text-center"><i class="fa fa-arrow-circle-left"></i>  Back</a>
												<a href="<?php echo base_url('staff/fig');?>" id="cancel" value="Cancel" style="display:none" class="btn-fs btn btn-outline-dark text-center"><i class="fa fa-close" aria-hidden="true"></i>  Cancel</a>
	...
	$('a.del').click(function() {
		...
		swal({
         ...
         if (result.value) {          
            ...
            $.ajax({
              url: "<?php echo base_url();?>staff/fig/deletefig/"+fig_id,
              type: "POST",
              data: {
                 this_delete: fig_id,
              },
              ...
              success: function() {        
                 setTimeout(function() {
                  window.location.replace("<?php echo base_url('staff/fig')?>");
                 }, 1000);
              },
              error: function() {
