...
<link href="<?php echo asset_url()?>css/dataTables.staff/.min.css" rel="stylesheet">
                        ...
                        <div class="card-body">
							...
							<tbody id="memberlist">
                                ...
                                <tr>
									...
									<td><a href="<?php echo base_url('fpo/share/viewsharedetails/' . $shareholders_list[$i]->folio_number); ?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a></td>
                               </tr>
                                <?php } ?>
                            </tbody>
							</table>
