      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/share/post_shares_value')?>" method="post"  id="gstform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                 ...
                                 <?php $sharerelease=$row->shares_released;?>
											<tr> 
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('staff/share/shareshistory'); ?>" class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
                                    </td>                                              
											</tr>
											<?php endforeach; 
											} else {?>	
                                 ...
                                 <div class="form-group col-md-12 mt-4">	
                                    <div class="row row-space">
                                         <div class="form-group col-md-12 text-center">
                                             ...
                                             <a href="<?php echo base_url('staff/share/sharesvalue');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
                                         </div>											 
                                     </div>
											 </div>
										  </div>
