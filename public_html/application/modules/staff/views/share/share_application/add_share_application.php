        ...
        <div class="breadcrumbs">
         ...
         <div class="content mt-3">
            ...
            <div class="animated fadeIn">
               <form action="<?php echo base_url('staff/share/postShareApplication')?>" method="post" id="addshare_application" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                              <div class="container-fluid">                                                                         
                                 <div class="farmer_to_member_form" id="farmer_to_member_form" style="">                                            
                                    <div class="row row-space mt-4">                
                                       ...
                                       <div class="form-group col-md-4">
                                          ...
                                          <input type="text" class="form-control" minlength="2" maxlength="60" name="alias_name" id="alias_name" placeholder="Alias - Father / Spouse Name" readonly>
                                          <div class="help-block with-errors text-danger"></div>
                                       </div>
                                    </div>
                                    <div class="row row-space mt-4">
                                 ...
                                 <div class="form-row">
                                       ...
                                       <a href="<?php echo base_url('staff/share');?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
                                    </div>											 
                                 </div>                                            
                              </div>
								   </div>
