    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                    <form action="<?php echo base_url('staff/share/updateShareApplication/'.$share_application[0]->id)?>" method="post" id="editshare_application" name="sentMessage" novalidate="novalidate" >
                    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                        ...
                                        <div class="farmer_to_member_form" id="farmer_to_member_form" style="">
                                            ...
                                            <div class="row row-space mt-4">                          
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control numberOnly" minlength="12" maxlength="14" name="aadhaar_number" id="aadhaar_number" placeholder="AADHAAR Number" readonly required data-validation-required-message="Provide the aadhaar number" value="<?php $str=substr_replace($share_application[0]->aadhaar_number, str_repeat("X", 8),0, 8);echo wordwrap($str , 4 , ' ' , true ); ?>">
                                                     <div class="help-block with-errors text-danger"></div>
                                                </div>
                                            </div>   
										...
										<div class="form-row">
								            <div class="form-group col-md-12 text-center">
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('staff/share');?>" id="ok" class="btn-fs btn btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
												<a href="<?php echo base_url('staff/share');?>" id="cancel" class="btn-fs btn btn-outline-dark" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
											 </div>											 
								        </div>
...
function searchFarmerWithOption(search_farmer) {    
       $.ajax({
			url:"<?php echo base_url();?>staff/share/searchFarmer",
			type:"POST",
			data:search_farmer,
			dataType:"html",
            cache:false,			
