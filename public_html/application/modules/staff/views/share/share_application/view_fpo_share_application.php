      ...
      <div id="right-panel" class="right-panel">
         ...
         <div class="content mt-3">
            <div class="animated fadeIn">
               <form action="<?php echo base_url('staff/share/updateShareApplicationByFPO/'.$share_application['id'])?>" method="post" id="editshare_application" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                              <div class="container-fluid">                                                                         
                                 ...
                                 <div class="form-row">
                                    ...
                                    <a href="<?php echo base_url('staff/share/fpo_shareapplication_list');?>"><button id="ok" href="" class="btn btn-fs btn-outline-dark text-center" type="button"><i class="fa fa-arrow-circle-left"></i> Back</button></a>
                                    <a href="<?php echo base_url('staff/share/fpo_shareapplication_list');?>"><button id="cancel" href="" style="display:none" class="btn btn-fs btn-outline-dark text-center" type="button"> <i class="fa fa-close" aria-hidden="true"></i> Cancel</button></a>
                                    ...
                                    <!--<a href="<?php echo base_url('staff/share/fpo_shareapplication_list');?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	-->
                                    </div>											 
                                 </div>                                            
                              </div>
								   </div>
