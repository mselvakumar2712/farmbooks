                        ...
                        <div class="card-body">	
                           <div class="container">
								<div class="" style="text-align:right;margin-bottom:20px;" >
									<a href="<?php echo base_url('staff/share/addshareapplication');?>">
                        ...
                        <tr>
                           ...
                           <th>Action</th>
							...
							<tbody id="memberlist">
								...
								?></td>
                                <td>
                                    <a href="<?php echo base_url('staff/share/viewshareapplication/' . $share_applications[$i]->id); ?>" class="btn btn-warning btn-sm" title="Edit">
