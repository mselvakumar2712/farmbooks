     ...
     <div class="container-fluid pl-0 pr-0">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>List Existing Share Holder Setup</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" >List Existing Share Holder Setup</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <?php if($this->session->flashdata('success')){ ?>
            ...
            <div class="animated fadeIn">
               <form action="<?php echo base_url('staff/share/postfpo_farmer')?>" method="post" id="debit_note_form" name="sentMessage" novalidate="novalidate" >            
                <div class="row">				
                <div class="col-md-12">
                    <div class="card">					
                        <div class="card-body">	
                          <div class="container">
                           ...
                           <thead>
                              <tr>
                                 ...
                                 <tbody id="memberlist">
                                      <?php for($i=0;$i<count($farmer_list);$i++){ ?>
                                      <tr id="<?php echo $i;?>"><input type="hidden"  value="<?php echo $farmer_list[$i]->id; ?>" id="farmer_id<?php echo $i;?>" name="farmer_id[]">
                                      <td><?php echo $farmer_list[$i]->profile_name."-".$farmer_list[$i]->door_no."-".$farmer_list[$i]->street; ?></td>
...
function loadFarmers(panchayatCode, villageCode, mobile_number) {
    if(panchayatCode || villageCode || mobile_number != "") {
        ...
        $.ajax({
				url:"<?php echo base_url();?>staff/share/fpofarmersByLocation",
				type:"POST",
                data:formedCode,
				dataType:"html",
				cache:false,			
