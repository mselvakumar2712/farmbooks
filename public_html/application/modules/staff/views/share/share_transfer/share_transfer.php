    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
                    <form action="<?php echo base_url('staff/share/postShareTransfer')?>" method="post" id="shareTransferForm" name="sentMessage" novalidate="novalidate" >
                    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                        ...
                                        <div class="transfer_to_member" id="transfer_to_member" style="">
                                            ...
                                            <div class="row row-space">                
                                                <div class="form-group col-md-6">
                                                    <label for="inputAddress2">Transferor Member Mobile Number <span class="text-danger">*</span></label>
                                            ...
                                            <div class="row row-space" id="transferContent">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="hidden" class="form-control" name="folio_no" id="folio_no" placeholder="" required>
                                                    <input type="date" class="form-control" id="transfer_date" name="transfer_date" placeholder="Date" value="<?php echo date("Y-m-d");?>" max="<?php echo date("Y-m-d");?>" data-validation-required-message="Provide the transfer date">
										...
										<div class="form-row" id="buttonContent">
								            <div class="form-group col-md-12 text-center">
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('staff/share/sharetransfer');?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
											 </div>											 
								        </div>
...
$("#transferor_member").focusout(function() {
	...
	if(transferor_member != '' && transferee_member != "") {
		if(transferor_member == transferee_member ) {
			var str = 'Transferor member mobile number and Transferee member mobile number should not be same.';
			swal('', str);
			$(this).val(''); 
			return;
		}
...
$("#certificate_number").focusout(function() {
	...
	if(certificate_number != ""){
		...
		$("#certificate_validate").html("<div class='alert alert-danger'>Provide the cerificate Number</div>");
        $("#certificate_number").focus();
        $("#certificate_number").val('');
	}		
});
