                    ...
                    <div class="card">
                        <div class="card-body">
						    ...
						    <div class="container-fluid">
								<form action="<?php echo base_url('staff/share/postCalculateBonus')?>" id="bonusCalculationForm" novalidate="novalidate" method="post">
								<div id="bonus_shares">
								...
								<form action="<?php echo base_url('staff/share/postBonusShares')?>" name="sentMessage" id="allotmentForm" novalidate="novalidate" method="post"> 
										...
										<table class="table table-bordered">
											...
											<tbody>
                                                ...
                                                <?php if(isset($share_applied)) {
                                                    ...
                                                    $bonus_share = ($new_shares/$existing_shares*$share_applied[$i]->total_share_value)
                                                ?>
                                                <tr>
                                                     <td class="text-left">
                                                         <?php echo ($i+1); ?>
                                                    ...
                                                    <td class="text-right"><input type="text" name="share_applied[<?php echo $i; ?>][new_share_value]" id="new_share_value" value="<?php echo round($bonus_share); ?>" class="form-control numberOnly" maxlength="4"></td>
									...
									<div class="row row-space" id="buttonContent">
								        ...
								        <a href="<?php echo base_url('staff/share/sharebonusissue')?>" class="btn-fs btn btn-outline-dark mt-10"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
									</div>				
								   </div> 
...
$(document).ready(function() {	
    ...
    if(resolution_number && resolution_date !='' && sharecount!=0){        
        $("#bonus_resolution_date").attr("readonly", true);$("#bonus_cutoff_date").attr("readonly", true);
        $("#bonus_existing_shares").attr("readonly", true);$("#bonus_new_shares").attr("readonly", true);
