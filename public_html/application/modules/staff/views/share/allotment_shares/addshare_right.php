                    ...
                    <div class="card">
                        <div class="card-body">
						    ...
						    <div class="container-fluid">
								<form action="<?php echo base_url('staff/share/postCalculateRights')?>" id="rightsCalculationForm" novalidate="novalidate" method="post">
								...
								<form action="<?php echo base_url('staff/share/postRightsShares')?>" name="sentMessage" id="allotmentForm" novalidate="novalidate" method="post"> 
										...
										<table class="table table-bordered">
											...
											<tbody>
                                                ...
                                                <?php if(isset($share_applied)) {
                                                    ...
                                                    $rights_share = ($new_shares/$existing_shares*$share_applied[$i]->total_share_value)
                                                ?>
                                                <tr>
                                                     <td class="text-left">
                                                         <?php echo ($i+1); ?>
                                                    ...
                                                    <td class="text-right"><input type="text" name="share_applied[<?php echo $i; ?>][new_share_value]" id="new_share_value" value="<?php echo round($rights_share); ?>" class="form-control numberOnly" maxlength="4"></td>
									...
									<div class="row row-space" id="buttonContent">
								        ...
								        <a href="<?php echo base_url('staff/share/sharerightissue')?>" class="btn-fs btn btn-outline-dark mt-10"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
									</div>				
								   </div> 
...
$(document).ready(function() {	
    ...
    var sharecount = "<?php echo count($share_applied);?>";
    $('#rights_shares_detail1').show();
	$('#rights_shares_detail2').show();
