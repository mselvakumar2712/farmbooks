    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
                    <form action="<?php echo base_url('staff/share/postbonuscertificate')?>" novalidate="novalidate" method="post" >
					<div class="row">
					<div class="col-md-12">
					<div class="card">
						<div class="card-body">
						...
						<div class="row row-space mt-4">
						   ...
						   <div class="form-group col-md-3">
							...
							<form action="<?php echo base_url('staff/share/postIssueBonusCertificate')?>" novalidate="novalidate" method="post" >
									...
									<div class="form-row">
										<div class="form-group col-md-12 text-center">
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('staff/share/bonussharecertificate')?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										</div>											 
									 </div>
									<?php } if(empty($list_member)){ ?>
