...
$(document).ready(function() {
    $.ajax({
        url: "<?php echo base_url();?>staff/farmer/livestock_list",
        type: "GET",
        dataType:"html",
        cache:false,			
              ...
              var count=1;
                $.each(responseArray.livestock_list,function(key,value){
                    ...
                    if(value.live_stocks == 1) {            
                        livestock_list += '<tr><td>'+value.profile_name+'</td><td>'+type+'</td><td>'+value.live_stock_name+'</td><td>'+variety_name+'</td><td>'+live_stock_count+'</td><td><a href="<?php echo base_url("staff/farmer/viewlivestock?id='+value.id+'");?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a><a href="<?php echo base_url("staff/farmer/viewlivestock?id='+value.id+'");?>" class="btn btn-warning ml-1 btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a></td></tr>';
                    }
                });
