                    ...
                    <div class="card">					
                        ...
                        <div id="step-2" >
				                ...
				                <div class="form-group col-md-12 text-center">											         <input id="sendMessageButton" name="profilesubmit" value="Save" class="btn btn-success text-center" type="submit">
									<a href="<?php echo base_url('staff/farmer/landlist');?>" class="btn btn-outline-dark">Cancel</a>	
				                </div>
...
//	   return false;           
	   ...
	   return false;           
        ...
        $.ajax({
			url:"<?php echo base_url();?>staff/farmer/postLandDetail",
			type:"POST",
			data:farmerdata,
			dataType:"html",
            cache:false,			
...
function getFarmerProfileLocation(type){
	...
	if(type == 1){
		...
		$.ajax({
			url:"<?php echo base_url();?>staff/farmer/edit_Farmer/"+farmer_id,
			type:"GET",
			data:"",
			dataType:"html",
			cache:false,			
