      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('staff/masterdata/productfpolist');?>">Product FPO Mapping</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/masterdata/post_productfpo')?>" method="post"  id="figform" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="row row-space">											
											...
											<a href="<?php echo base_url('staff/masterdata/gstdetail');?>" class="text-success ml-1">Refer Current GST Rates</a>
											<p class="help-block text-danger"></p>
											</div>											
										</div>
										<div class="form-row">
											<div class="form-group col-md-12 text-center">
												<div id="success"></div>
													...
													<a href="<?php echo base_url('staff/masterdata/productfpolist');?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
												</div>											 
										</div>
										  </div>
										</div>
...
<script>	
	$(document).ready(function(){
		...
		$('#stock_group').on('change', function(e) {
				...
				if(group) { 
					$.ajax({
						url: '<?php echo base_url('staff/masterdata/getcategory')?>',
						type: "POST",
						data:{group:group},
			...
			$('#category').on('change', function(e) {
				...
				if(category) { 
					$.ajax({
						url: '<?php echo base_url('staff/masterdata/getsubcategory')?>',
						type: "POST",
			...
			$('#sub_category').on('change', function(e) {
				...
				if(product) { 
						$.ajax({
							url: '<?php echo base_url('staff/masterdata/getproduct')?>',
							type: "POST",
