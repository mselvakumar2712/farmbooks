			 ...
			 <div class="page-header float-right">                    
				 <div class="page-title">                        
					 <ol class="breadcrumb text-right">							 
						 ...
						 <li><a class="active" href="<?php echo base_url('staff/masterdata/productfpolist');?>">List Product FPO Mapping</a></li>                            
	 ...
	 <div class="animated fadeIn">               
		 <div class="container">				
			 <div class="" style="text-align:right;margin-bottom:20px;" >				
				 <a href="<?php echo base_url('staff/masterdata/addproductfpo');?>">					
	 ...
	 <div class="card-body">						  
			...
			<tr>
								...
								<tr>
									...
									<a href="<?php echo base_url('staff/masterdata/viewproductfpo/'.$row->id); ?>"  class="btn btn-warning btn-sm" title="Edit"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
									</td>							
								</tr>
							<?php endforeach; ?>							
							</tbody>						  
