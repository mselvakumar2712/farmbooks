				...
				<div class="col-sm-8">
					<div class="page-header float-right">
                        ...
                        <?php 
                           ...
                           ?>
								<li><a class="active" href="<?php echo base_url('staff/market/customerbranches');?>">Customer Branches</a></li>
                           <?php }else if($page_module == 'finance') {
                           ?>
								<li><a class="active" href="<?php echo base_url('staff/finance/customerbranches');?>">Customer Branches</a></li>
                           <?php }else {
                           ?>
								<li><a class="active" href="<?php echo base_url('staff/market/customerbranches');?>">Customer Branches</a></li>
                           <?php }?>
            ...
            <?php }?>
				<div class="animated fadeIn">
                    ...
                    <?php 
                     if($page_module == 'market') {
                     ?>
							<form  id="addpopi_Form"  method="POST" action="<?php echo base_url('staff/Market/postcustomerbranch')?>" role="form" name="sentMessage" novalidate="novalidate" data-toggle="validator"  accept-charset="utf-8">
                     <?php }else if($page_module == 'finance') {
                     ?>
							<form  id="addpopi_Form"  method="POST" action="<?php echo base_url('staff/finance/postcustomerbranch')?>" role="form" name="sentMessage" novalidate="novalidate" data-toggle="validator"  accept-charset="utf-8">
                     <?php }else {
                     ?>
							<form  id="addpopi_Form"  method="POST" action="<?php echo base_url('staff/Market/postcustomerbranch')?>" role="form" name="sentMessage" novalidate="novalidate" data-toggle="validator"  accept-charset="utf-8">
                     <?php }?>
								...
								<!--<div id="smartwizard">-->
									...
									<div id="form-step-0" class="form-horizontal" role="form" data-toggle="validator">
										...
										<div class="form-group col-md-6 ">
											...
											<input type="text" class="form-control" maxlength="20" id="branch_short_name" name="branch_short_name" placeholder="Customer Short Name"  data-validation-required-message="Please enter branch short name.">
											 <div class="help-block with-errors text-danger"></div>
										</div>
										</div>
										...
										<div class="form-group col-md-6">	
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control numberOnly" pattern="^[6-9]\d{9}$" maxlength="10" id="mobile_num" name="mobile_num">
													<div class="help-block with-errors text-danger"></div>
												</div>
												<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													<label for="inputAddress2">Mobile Number  </label>
													<input type="text" class="form-control numberOnly" pattern="^[6-9]\d{9}$" maxlength="10" id="physical_mobile_num" name="physical_mobile_num">
													<div class="help-block with-errors text-danger"></div>
												</div>
												<div class="form-group col-md-6">
													<label for="inputAddress2">STD Code</label>
  ...
  $("#same_address").click(CopyAdd);
    ...
    $('select[name="customer"]').on('change', function(e) {
		$("#form-step-0").show();
			...
			if(customer) { 
			$.ajax({
				url: "<?php echo base_url();?>staff/Market/customerbranchlist/"+customer,
				type: "GET",
				data:"",
						dataType:"html",
						cache:false,			
						...
						console.log(responseArray);
						 if(responseArray.status == 1){
							...
							customerbranch_list += '<tr><td>'+value.branch_ref+'</td><td>'+value.br_name+'</td><td>'+value.contact_name+'</td><td></td><td></td><td><?php if($page_module == 'market') {?><a href="<?php echo base_url("staff/market/editcustomerbranch/'+value.branch_code+'");?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a><?php }else if($page_module == 'finance') {?><a href="<?php echo base_url("staff/finance/editcustomerbranch/'+value.branch_code+'");?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a><?php }else {?><a href="<?php echo base_url("staff/market/editcustomerbranch/'+value.branch_code+'");?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a></td><?php }?></tr>';
							});
