     ...
     <div class="container-fluid pl-0 pr-0">
       ...
       <div class="breadcrumbs">
		...
		<div class="content mt-3">
			...
			<form action="<?php echo base_url('staff/finance/updateglAccount_group/'.$glgroup_info[0]->account_code2)?>" id="" name="sentMessage" method="post" novalidate="novalidate" >
	            <div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<input type="hidden" name="gl_acc_grp_id" value="<?php echo $glgroup_info[0]->account_code2;?>" id="gl_acc_grp_id">									
									    ...
									    <div class="form-row">
											  ...
											  <div id="success"></div>
											    ...
											    <a href="<?php echo base_url('staff/finance/glaccount_groups');?>" id="cancel" class="btn btn-outline-dark"> <i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
											  </div>											 
									     </div>
									</div>
								</div>
