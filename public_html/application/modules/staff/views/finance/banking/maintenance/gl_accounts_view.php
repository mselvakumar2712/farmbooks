...
//echo $glgroup_info[0]->account_code2;
?>
     ...
     <div class="container-fluid pl-0 pr-0">
       ...
       <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="">GL Accounts View</a></li>
		...
		<div class="content mt-3">
			...
			<form action="<?php echo base_url('staff/finance/updateglAccounts/')?>" method="post" id="gl_account_form" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">									
									<div class="container-fluid mt-5">  
										...
										<div class="form-group col-md-3">
											...
											<div class="form-group col-md-3">
													...
													<input class="form-control" type="text" maxlength="75" readonly value="<?php echo $glgroup_info[0]->account_name; ?>" placeholder="Account Name" id="account_name" name="account_name" required="required" data-validation-required-message="Please enter account name.">
												    <p class="help-block text-danger"></p>
											</div>	
										...
										<div class="form-row">
											  ...
											  <div id="success"></div>
												<!--<a href="<?php //echo base_url('staff/finance/editglaccounts/'. $glgroup_info[0]->account_code);?>" class="btn btn-success text-center" ><i class="fa fa-edit"></i> Edit</a>-->
											    <a href="<?php echo base_url('staff/finance/glaccounts');?>" id="cancel" class="btn btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
											  </div>											 
									     </div>
									</div>
								</div>
