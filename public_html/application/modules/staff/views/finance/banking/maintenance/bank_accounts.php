            ...
            <div class="animated fadeIn">
			          <div class="row">
						<div class="col-md-12">
									...
									<div class="table-responsive">  
										<table class="table table-bordered">
											...
											<tr> 
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('staff/finance/viewbankAccounts/'. $row->id); ?>" class="btn btn-warning btn-sm" title="Edit"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
                                                </td>
											</tr>
											<?php endforeach; ?>												
											</tbody>
                           ...
                           <form action="<?php echo base_url('staff/finance/postbankaccount')?>" id="addBankAccountForm" name="sentMessage" method="post" novalidate="novalidate">
        
									<div class="container-fluid">  
										<div class="row">
                                 <div class="form-group col-md-4">
												<label for="inputAddress2">Account Number <span class="text-danger">*</span></label>
												<input class="form-control numberOnly" type="text" placeholder="Account Number" id="account_no" name="account_no" required data-validation-required-message="Enter account number" minlength="9" maxlength="17">
                                 ...
                                 <div class="form-group col-md-3">
												...
												<input class="form-control inputfilter" placeholder="Opening Balance" id="opening_balance" name="opening_balance" required data-validation-required-message="Enter the opening balance" minlength="1" maxlength="10">
												<p class="help-block text-danger"></p>
											</div>
                                 <div class="form-group col-md-3">
