...
<body>
     <div class="container-fluid pl-0 pr-0">
       ...
       <div class="breadcrumbs">
		...
		<div class="content mt-3">
            ...
            <form action="<?php echo base_url('staff/finance/postglaccounts')?>" method="post" id="gl_account_form" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">  
                                       ...
                                       <th class="text-center" width="25%">Opening Balance</th>
												</tr>
											</thead>
											<tbody>
											<?php 
                                    if($gl_type == 'gl') {
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row" >
                                             <input type="text" id="<?php echo $glgroup_info[$i]->account_code; ?>" <?php //if($glgroup_info[$i]->amount > 0){ echo "readonly";};?>  value="<?php echo abs($glgroup_info[$i]->amount);?> " name="amount[]" class="form-control numberOnly col-md-6 ml-4" maxlength="7">
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row"><input type="text" <?php //if($bank_info[$i]->opening_balance > 0){ echo "readonly";};?>  value="<?php echo abs($bank_info[$i]->opening_balance);?> " name="amount[]" class="form-control numberOnly col-md-6  ml-4" maxlength="7">
                                             <select class="form-control col-md-4 ml-1"  name="crdr[]">
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row"><input type="text" <?php //if($customer_info[$i]->opening_balance > 0){ echo "readonly";};?>  value="<?php echo abs($customer_info[$i]->opening_balance);?> " name="amount[]" class="form-control numberOnly col-md-6 ml-4" maxlength="7">
                                             <select class="form-control col-md-4 ml-1"  name="crdr[]">
                                                <option value="" <?php echo ($customer_info[$i]->opening_balance > 0 )?'selected':''; ?>>Cr</option>
                                                <option value="-" <?php echo ($customer_info[$i]->opening_balance <= 0 )?'selected':''; ?>>Dr</option>
                                             </select>
                                             </td>
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row"><input type="text" <?php //if($supplier_info[$i]->opening_balance > 0){ echo "readonly";};?>  value="<?php echo abs($supplier_info[$i]->opening_balance);?> " name="amount[]" class="form-control numberOnly col-md-6 ml-4" maxlength="7">
                                             <select class="form-control col-md-4 ml-1"  name="crdr[]">
                                                <option value="" <?php echo ($supplier_info[$i]->opening_balance >= 0 )?'selected':''; ?>>Cr</option>
                                                <option value="-" <?php echo ($supplier_info[$i]->opening_balance < 0 )?'selected':''; ?>>Dr</option>
                                             </select>
                                             </td>
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row"><input type="text" <?php //if($cash_info[$i]->opening_balance > 0){ echo "readonly";};?>  value="<?php echo abs($cash_info[$i]->amount);?> " name="amount[]" class="form-control numberOnly col-md-6  ml-4" maxlength="7">
                                             <select class="form-control col-md-4 ml-1"  name="crdr[]">
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row">
                                                <input type="text" <?php if($bank_info[$i]->opening_balance > 0){ echo "readonly";};?>  value="<?php echo abs($bank_info[$i]->opening_balance);?> " name="bank_amount[]" class="form-control numberOnly col-6 ml-3" maxlength="7">
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row">
                                                <input type="text" <?php if($customer_info[$i]->opening_balance > 0){ echo "readonly";};?>  value="<?php echo abs($customer_info[$i]->opening_balance);?> " name="customer_amount[]" class="form-control numberOnly col-6 ml-3" maxlength="7">
                                                <select class="form-control col-4 ml-1"  name="crdr[]">
                                                   <option value="">Cr</option>
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row">
                                                <input type="text" <?php if($supplier_info[$i]->opening_balance > 0){ echo "readonly";};?>  value="<?php echo abs($supplier_info[$i]->opening_balance);?> " name="supplier_amount[]" class="form-control numberOnly col-6 ml-3" maxlength="7">
                                                <select class="form-control col-4 ml-1"  name="crdr[]">
                                                   <option value="">Cr</option>
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row">
                                                <input type="text" id="<?php echo $glgroup_info[$i]->account_code; ?>" <?php if($glgroup_info[$i]->amount > 0){ echo "readonly";};?>  value="<?php echo abs($glgroup_info[$i]->amount);?> " name="gl_amount[]" class="form-control numberOnly col-6 ml-3" maxlength="7">
                                                <select class="form-control col-4 ml-1"  name="crdr[]">
                                                   <option value="">Cr</option>
                                       ...
                                       ?>
                                          <tr>                                     
                                             ...
                                             <td class="row">
                                                <input type="text" id="<?php echo $cash_info[$i]->account_code; ?>" <?php if($cash_info[$i]->amount > 0){ echo "readonly";};?>  value="<?php echo abs($cash_info[$i]->amount);?> " name="gl_amount[]" class="form-control numberOnly col-6 ml-3" maxlength="7">
                                                <select class="form-control col-4 ml-1"  name="crdr[]">
                                                   <option value="">Cr</option>
   ...
   $(document).ready(function() {
      ...
      $('#sel_gl_account').on('change', function() {
         ...
         if(gl_type == '') {
            window.location = '<?php echo base_url('staff/finance/glaccounts'); ?>';
         }
         else {
            window.location = '<?php echo base_url('staff/finance/glaccounts'); ?>/'+gl_type;
         }
      });
