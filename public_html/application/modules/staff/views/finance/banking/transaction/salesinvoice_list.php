                    ...
                    <div class="card">					
                     <div class="card-body">
                        ...
                        <td class="text-center">                      
                           <a href="<?php echo base_url('staff/finance/salesinvoicepdf/'.$row->voucher_no.'/'.$row->inv_no.'/'.$row->account_code); ?>" class="btn btn-primary btn-sm mt-1" title="Download"><i class="fa fa-download" aria-hidden="true" title="Download"></i></a>
                           <a href="<?php echo base_url('staff/finance/viewSalesInvoice/'.$row->voucher_no.'/'.$row->inv_no.'/'.$row->account_code); ?>" class="btn btn-warning btn-sm mt-1" title="Print"><i class="fa fa-print" aria-hidden="true" title="Print"></i></a>
                        </td>
								</tr>
							<?php endforeach; ?>
							</tbody>
