...
<body>
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('staff/finance/creditnote');?>"class="active">Credit Note</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
			...
			<form action="<?php echo base_url('staff/finance/postCreditnote')?>" method="post" id="debit_note_form" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
                                         ...
                                         <?php }else{?>
                                          <option  value="<?php echo $gl_trans_list[$i]->account_code.'-'.$gl_trans_list[$i]->account_name; ?>"><?php echo $gl_trans_list[$i]->account_code.'-'.$gl_trans_list[$i]->account_name; ?></option>			                                         
												...
												<div class="form-group col-md-4">
													<label for="inputAddress">Credit Note <span class="text-danger">*</span></label>
													<input  class="form-control inputfilter" maxlength="6" id="credit_note" name="credit_note" placeholder="Credit Note " required="required" data-validation-required-message="Please enter crdit note">
		...
		$.ajax({
			...
			success:function(response) { 
				...
				if(responseArray.type == 'supplier'){
					...
					console.log(value.supp_reference);
