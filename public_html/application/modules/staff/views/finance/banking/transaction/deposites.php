  ...
  <body>
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('staff/finance/deposits');?>"class="active">Receipt</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
			...
			<form action="<?php echo base_url('staff/finance/postDeposit')?>" method="post" id="depositform" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
										  ...
										  <div class="row">
												<div class="form-group col-md-3">
													...
													<input class="form-control" type="date" id="receipt_date" name="receipt_date" required data-validation-required-message="Select the deposit date" value="<?php echo date("Y-m-d"); ?>" max="<?php echo date("Y-m-d"); ?>">
												...
												<div class="form-group col-md-4">
													...
													<input class="form-control" id="deposit_ref" name="deposit_ref" placeholder="Voucher No" required data-validation-required-message="Enter the voucher no." value="<?php echo 'trv_DT_'.mt_rand(0,10000); ?>" readonly>
													<p class="help-block text-danger"></p>
												</div>
											</div>
											...
											<div class="table-responsive mt-3">  
												<table class="table table-bordered low-padded" id="dynamic_field">
													...
													<tr id="row0">  
														<!--<td width="25%">
                                                            <select class="form-control" id="received_from" name="deposit[0][received_from]" required data-validation-required-message="Select bank to received from">
															 <option value="">Select Received From</option>
														    </select>
														    <p class="help-block text-danger"></p>
                                                        </td>-->
                                                        <td width="25%">
                                                            <select class="form-control" id="cost_center"  name="deposit[0][cost_center]" required data-validation-required-message="Select any cost center">
															<option value="">Select Cost Center</option>
														    </select>
														    <span class="help-block text-danger"></span>
                                                        </td>
														<td width="25%">
                                                            <select class="form-control" id="deposit_into"  name="deposit[0][deposit_into]" required data-validation-required-message="Select deposit into.">
														...
														<td width="15%">
                                                            <input type="text" name="deposit[0][amount]" required class="form-control numberOnly" maxlength="6" readonly id="amount_0">
                                                            <span class="help-block text-danger"></span>
                                                        </td>  														 
														<td width="10%">
...
function getAllCustomersByFPO(received_from) { 
    $.ajax({
        url:"<?php echo base_url();?>staff/finance/getAllDebtorsByFPO",
        type:"GET",
        data:"",
        dataType:"html",
        cache:false,			
      ...
      dataType:"html",        
        ...
        success:function(response) {
            ...
            if(responseArray.account_balance != null) {
				...
				console.log(temp_totalBalance[accId]);
...
function verifyBalanceAmount(amountValue, amountInputId, accountId, updateBalanceId){    
    ...
    /*if(Number(amountValue) > Number(temp_totalBalance[accountId])) {
        swal('Sorry',"Given amount should be less than the balance");
        $('#'+amountInputId).val('');
    } else{*/
		accountId = accountId.split("-");
        temp_totalBalance[accountId[0]] = (Number(temp_totalBalance[accountId[0]])+Number(amountValue));
        console.log(temp_totalBalance[accountId[0]]);
