  ...
  <body>
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('staff/finance/journalentry');?>"class="active">Journal</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
			...
			<form action="<?php echo base_url('staff/finance/postJournalEntry')?>" method="post" id="journalEntryForm" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">   
										   ...
										   <div class="row">
								                <div class="form-group col-md-4">
													...
													<input class="form-control" type="date" id="journal_date" name="journal_date" required data-validation-required-message="Select the journal date" value="<?php echo date("Y-m-d"); ?>" >
												...
												<div class="form-group col-md-4">
													...
													<input type="text" class="form-control" id="journal_ref" name="journal_ref" placeholder="Reference" value="<?php echo 'trv_JE_'.mt_rand(0,10000); ?>" readonly>
													<p class="help-block text-danger"></p>
												</div>
                                          ...
                                          <td width="55%">
                                          <select class="form-control" id="cost_center_0"  name="journal_entry[0][cost_center]" required data-validation-required-message="Select any cost center">
                                          ...
                                          <td width="28%">
                                          <select class="form-control" id="cost_center_1"  name="journal_entry[1][cost_center]" required data-validation-required-message="Select any cost center">
                                          <option value="">Select Ledger Type</option>
                                          </select>
                                          </td>  
                                          <td width="15%">
