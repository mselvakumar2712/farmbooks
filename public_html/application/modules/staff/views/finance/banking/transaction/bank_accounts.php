...
<body>
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('staff/finance/bankaccounts');?>"class="active">Contra</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
			...
			<form action="<?php echo base_url('staff/finance/postBankAccountTransfer')?>" method="post" id="bank_transfer_form" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
										  ...
										  <div class="row">
                                                <div class="form-group col-md-4">
													...
													<input class="form-control" type="date" id="transfer_date" name="transfer_date" required data-validation-required-message="provide the transfer date" value="<?php echo date("Y-m-d"); ?>" max="<?php echo date("Y-m-d"); ?>">
												...
												<div class="form-group col-md-4">
													...
													<input class="form-control" id="transfer_ref" name="transfer_ref" placeholder="Reference" required data-validation-required-message="Enter the reference" value="<?php echo 'trv_BA_'.mt_rand(0,10000); ?>" readonly>
													<p class="help-block text-danger"></p>
												</div>	
                                          ...
                                          <?php for($i=0; $i<count($banks);$i++) { ?>
                                                ...
                                                <div class="form-group col-md-4">
													<label for="inputAddress">Amount (<i class="fa fa-inr" aria-hidden="true"></i>) <span class="text-danger">*</span></label>
													<input class="form-control numberOnly" type="text" placeholder="Amount" id="amount" maxlength="6" name="amount" required data-validation-required-message="Enter the amount to transfer">
													<p class="help-block text-danger"></p>
												</div>
											</div>
...
$("#amount").focusout(function() {    
    ...
    if(account_from == "") {
        ...
        if(Number(from_AccountBalance) < Number(actual_amount)) {
            swal("Sorry!", "Given amount is greater than the from account", "warning"); 
            $(this).val('');
			$(this).focus();
			return false;      
        } else {
            ...
            temp_to_AccountBalance = (Number(temp_to_AccountBalance)+Number(actual_amount));
                $('#accountBalance_from').html('<strong> Total Balance: '+temp_from_AccountBalance+'</strong>');
                $('#accountBalance_to').html('<strong> Total Balance: '+temp_to_AccountBalance+'</strong>');
            //$("#amount").attr('readonly','true');
        }
        
//        $.ajax({
//            url:"<?php echo base_url();?>staff/finance/getPettyCashAccuntByFPO/"+account_from,
//            type:"GET",
//            data:"",
//            dataType:"html",
//            cache:false,			
      ...
      dataType:"html",        
        ...
        success:function(response) {
            ...
            if(responseArray.account_balance != null) {
                $('#'+accountBalance).html('<strong> Balance: <i class="fa fa-inr" aria-hidden="true"></i>'+responseArray.account_balance+'</strong>');
            } else {
