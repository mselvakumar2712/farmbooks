     ...
     <div class="container-fluid pl-0 pr-0">
       ...
       <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/finance/balancesheetdrilldown');?>">Balance Sheet Drilldown</a></li>
                        </ol>
                    </div>
                </div>
            </div>
		...
		<div class="content mt-3">
			...
			<form action="<?php echo base_url('staff/finance/balanceSheetReports')?>" method="post" id="balance_sheet_report" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<div class="container-fluid">  
										<form action="<?php echo base_url('staff/finance/balanceSheetReports')?>" method="post" id="balance_sheet" name="sentMessage" novalidate="novalidate">
											<div class="row">
												...
												<div class="form-group col-md-6">
													<div class="form-group col-md-8">
														...
														<input class="form-control" type="date" id="as_at" name="as_at" value="<?php echo $toValue; ?>" min="<?php echo $fromValue; ?>">
													</div>
                                 ...
                                 <tbody>
											...
											<tr id="row_closing">
												<td width="80%" class="text-right text-danger font-weight-bold">Opening Balance Difference (<i class="fa fa-inr" aria-hidden="true"></i>)</td>
												<td align="right" class="text-right text-danger font-weight-bold"><?php echo ltrim($ledgerBalance, '-');echo (substr($ledgerBalance, 0, 1) == '-')?' Cr':' Dr'; ?></td>
											</tr>
											<?php } ?>	
										</tbody>
                              <tbody>
											<tr>
												<td width="80%" class="text-right text-danger font-weight-bold">Asset / Liability Ratio</td>
                                    ...
                                    <?php 
                                       ...
                                       $asset_rto = ($cur_asst>0?$cur_asst:1)/($cur_liab>0?$cur_liab:1);
                                       echo "1:".$asset_rto
                                    ?>
                                    </td>
											</tr>
                              ...
                              <tbody>
                                       ...
                                       <?php 
                                          ...
                                          $eqty_rto = round(abs(abs($debts) > 0?$debts:1)/($liabilities > 0?$liabilities:1));
                                          echo "1:".$eqty_rto;
                                       ?>
                                    </td>
											</tr>
...
function getChildrenNodeByAccountCode(selectedCode, value, has_child, toggleID, person_type_id) {	
	...
	if(toggleID == 1){
		...
		if(has_child == 1){
			...
			var childList = {"profit_loss_from":"", "profit_loss_to":profit_loss_to, "accountCode":selectedCode};
...
function childNodeAppendLists(parentAccountCode, person_type_id){
	...
	var profit_loss_to = $("#as_at").val();
	var childList = {"profit_loss_from":"", "profit_loss_to":profit_loss_to, "accountCode":parentAccountCode, "person_type_id":person_type_id};
