                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/finance/bankaccountinquiry');?>">Bank Statement</a></li>
                        </ol>
                    </div>
                </div>
            </div>
...
$('#search_transfer').click(function() {
    ...
    var balance="";
    $.ajax({
        url:"<?php echo base_url();?>staff/finance/postBankAccountInquiry",
		type:"POST",
		data:accountInquiry,
		dataType:"html",
        cache:false,			
