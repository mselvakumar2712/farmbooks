										...
										<div class="row">
											...
											<div class="form-group col-md-6">
												<div class="form-group col-md-6">
													...
													<input class="form-control" type="date" id="profit_loss_from" name="profit_loss_from" value="<?php echo $fromValue; ?>" max="<?php echo date("Y-m-d"); ?>">		
												</div>
												<div class="form-group col-md-6">
								...
								<?php //if(isset($incomeGLData) || isset($expenseGLData)){ ?>
									<div class="table-responsive mt-3" id="p_and_l_account_balance">  
										...
										<table class="table table-bordered" id='total_balance_show'>
											<tr bgcolor="#afd66b">		
												<th width="80%" class="text-danger text-right"><strong>Net Profit/Loss</strong></th>
												<th class="text-danger text-right"><strong><?php echo (isset($netIncome))?ltrim($netIncome, '-'):ltrim($netExpense, '-'); if(isset($netIncome)){ echo (substr($netIncome, 0, 1) == '-')?' Dr':' Cr'; } else { echo (substr($netExpense, 0, 1) == '-')?' Dr':' Cr'; } ?></strong></th>
											</tr>											
					...
					if(responseArray.status == 1) {
						...
						$.each(responseArray.glCategory, function(key, value){
							if(value.has_child != 0){
								...
								childNodeAppend += '</tr>';*/
								//window.location = "<?php echo base_url();?>staff/finance/viewledger/"+selectedCode;
