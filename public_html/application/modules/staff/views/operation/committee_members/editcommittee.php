      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/editcommittee');?>">Edit Committee Members</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/update_committee/'.$committee_info[0]->id)?>"  method="post"  id="directorform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('staff/operation/committeelist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
...
function deleterow(delete_committee,delete_director,is_ceo) {
	...
	swal({
	 ...
	 if (result.value) {          
		...
		$.ajax({
		  url: "<?php echo base_url();?>staff/operation/deletecommittee/"+delete_committee+"/"+director_id+"/"+is_ceo,
		  type: "POST",
		  data: {
		  ...
		  success: function() {        
			 setTimeout(function() {
				 return true;
			  window.location.replace("<?php echo base_url('staff/operation/committeelist')?>");
			 }, 1000);
		  },
		  error: function() {
