							...
							<div class="col-md-12">
								...
								<?php }?>
												...
												<div class="row row-space"> 
													  ...
													  <div class="form-group col-md-6">
														...
														<div class="form-group col-md-3" id="costHolder">
															...
															<input type="text" id="involved_cost_value" name="involved_cost_value" value="<?php echo $director['involved_cost']; ?>" class="form-control numberOnly ml-2" readonly placeholder="Cost Involved" data-validation-required-message="Please provide the involved cost">												
															<div class="help-block with-errors text-danger"></div>
														</div> 
												</div>
										...
										<div class="col-md-12 text-center">
											<a href="<?php echo base_url('staff/operation/edittraining_directors/'.$director['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Training<a>
											<a href="<?php echo base_url('staff/operation/training_directorslist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
