                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/company_secretarylist');?>">List Company Secretary</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                           ...
                           <div class="container">
								...
								<?php 
									if($active_secretary >0) {
										...
										?>
											<a href="<?php echo base_url('staff/operation/addcompany_secretary');?>">
							...
							<tbody id="secretarylist">
                              ...
                              <?php if(isset($secretary->terminated_on) && $secretary->terminated_on != '0000-00-00'){ ?>
											<a href="<?php echo base_url('staff/operation/viewcompany_secretary/'.$secretary->id); ?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
                              <?php } else { ?>
											<a href="<?php echo base_url('staff/operation/viewcompany_secretary/'.$secretary->id); ?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
											<?php if($secretary->status == 1){ ?>
											<a href="<?php echo base_url('staff/operation/editcompany_secretary/'.$secretary->id); ?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
											<?php }} ?>
										</td>
									</tr>
									<?php
