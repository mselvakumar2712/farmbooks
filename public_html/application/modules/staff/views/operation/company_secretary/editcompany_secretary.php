      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/editcompany_secretary/'.$secretary['id']);?>">Edit Company Secretary</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/update_secretary/'.$secretary['id'])?>"  method="post"  id="secretaryform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('staff/operation/company_secretarylist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
...
$("#reg_number").focusout(function(){
	...
	if(secretary_name!= "" && reg_number!= ""){
		...
		$.ajax({
            url:"<?php echo base_url();?>staff/operation/getCompanySecretaryInformation",
            type:"POST",
            data:secretary_info,
            dataType:"html",
            cache:false,			
