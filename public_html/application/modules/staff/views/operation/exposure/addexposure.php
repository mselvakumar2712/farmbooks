      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/addexposure');?>">Add  Exposure Visit </a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
					<form action="<?php //echo base_url('staff/operation/post_exposure_visit')?>"  method="post"  id="directorform" name="sentMessage" novalidate="novalidate" enctype="multipart/form-data">                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">									
                                    ...
                                    <p id="validate_amount" class="help-block text-danger"></p>
										...
										<div class="row row-space">
										  ...
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('staff/operation/exposurelist');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										  </div>											 
										</div>
									</div>
								</div>
...
$(document).ready(function() {
   ...
   $('#sendMessageButton').click(function(event) {
      ...
      if(validate){
         ...
         $.ajax({
             url: "<?php echo base_url();?>staff/operation/post_exposure_visit",
             method: 'post',
             data: data,
             cache: false,
             contentType: false,
