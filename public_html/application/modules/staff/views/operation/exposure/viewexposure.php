                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/viewtraining_ceo');?>">View Exposure Visit</a></li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="col-md-12 text-center mt-4">
											<a href="<?php echo base_url('staff/operation/editexposure/'.$exposure['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit<a>
											<a href="<?php echo base_url('staff/operation/exposurelist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
