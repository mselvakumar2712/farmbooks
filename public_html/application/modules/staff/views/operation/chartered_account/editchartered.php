      ...
      <div class="container-fluid pl-0 pr-0">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Edit Chartered Accountant</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/editchartered'.$accountant['id']);?>">Edit Chartered Accountant</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/update_chartered_accountant/'.$accountant['id'])?>"  method="post"  id="directorform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
												...
												<div class="row row-space  mt-4">
													...
													<div class="form-group col-md-2">
													 ...
													 <div class="form-group col-md-4">
														 ...
														 <input type="email" class="form-control" maxlength="50" disabled id="email_address" name="email_address" value="<?php echo $accountant['email']; ?>" placeholder="E-Mail Address">
													  <div class="help-block with-errors text-danger"></div>
                                         </div>
													   <div class="form-group col-md-4">
										...
										<div class="col-md-12 text-center">
											<button id="sendMessageButton" class="btn btn-fs btn-success confirmation text-center" type="submit"> <i class="fa fa-check-circle"></i> Update Accountant</button>
											<a href="<?php echo base_url('staff/operation/charteredlist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
...
/* $("#date_of_appoinment").focusout(function() {
	
    $("#terminated_on").attr("min", date_completeion);
}); */
$('#terminated_on').on('change', function () {
   var date_certificate=document.getElementById("terminated_on").value;  
   var date_of_appointment= '<?php echo $accountant['appointment_date'];?>';
...
var appoinment_date='<?php echo $accountant['appointment_date'];?>';
