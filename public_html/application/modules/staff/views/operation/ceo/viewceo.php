                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/viewceo/'.$ceo['id']);?>">View Chief Executive Officer</a></li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
                                    ...
                                    <div class="form-group col-md-4">
										...
										<?php 
											if($ceo['status'] == 1) {
											?>
												<a href="<?php echo base_url('staff/operation/editceo/'.$ceo['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit<a>
											<?php
											}
											?>
											<a href="<?php echo base_url('staff/operation/ceolist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
