      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/postUpdateBaselineInformation')?>" method="post" id="directorform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
									...
									<?php }?>
										...
										<div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('staff/operation/baselinelist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
