      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
							...
							<li><a href="<?php echo base_url('staff/operation/baselinelist');?>">Baseline Information</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/post_baseline')?>"  method="post"  id="directorform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="col-md-12 text-center">
											<a href="<?php echo base_url('staff/operation/editbaseline/'.$baseline_info['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Baseline Info<a>
											<a href="<?php echo base_url('staff/operation/baselinelist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
...
function getClusterInformation(cluster_id) {
	$.ajax({
           url:"<?php echo base_url();?>staff/operation/getClusterInformation/"+cluster_id,
           type:"GET",
           data:"",
           dataType:"html",
           cache:false,			
...
function getFarmersLandCount(villagesCoveredList) {
	var villagesCovered = {'villagesCovered':villagesCoveredList};
		$.ajax({
			url:"<?php echo base_url();?>staff/operation/getFarmersByVillage",
			type:"Post",
