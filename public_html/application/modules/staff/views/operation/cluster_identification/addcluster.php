      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/postAddClusterIdentification')?>" method="post" id="clusterAddForm" role="form" novalidate="novalidate" data-toggle="validator" name="sentMessage" accept-charset="utf-8">
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
									...
									<?php }?>
										...
										<div class="row row-space" id="buttonAction">
										  ...
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('staff/operation/clusterlist');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										  </div>											 
										</div>
									</div>
								</div>
