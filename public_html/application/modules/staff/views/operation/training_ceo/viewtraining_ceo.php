								...
								<?php }?>
									...
									<div class="container-fluid">
												<div class="row row-space  mt-4"> 
													...
													<div class="row row-space">
														...
														<div class="form-group col-md-4" id="costHolder">
															...
															<input type="text" id="involved_cost_value" name="involved_cost_value" class="form-control numberOnly ml-2" placeholder="Cost Involved" data-validation-required-message="Please provide the involved cost" value="<?php echo $ceo['involved_cost']; ?>" disabled>	
															<div class="help-block with-errors text-danger"></div>
														</div>  
													</div>													  										
										...
										<div class="col-md-12 text-center">
											<a href="<?php echo base_url('staff/operation/edittraining_ceo/'.$ceo['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Training<a>
											<a href="<?php echo base_url('staff/operation/training_ceolist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
