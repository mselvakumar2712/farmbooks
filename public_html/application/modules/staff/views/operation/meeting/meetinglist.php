                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/meetinglist');?>">List Meetings</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">					
                        <div class="card-body">	
                           <!--<div class="container">
								...
								<a href="<?php echo base_url('staff/operation/meetinglist');?>">
								...
								<div class="form-group col-md-4"></div>
									<div class="form-group col-md-4">
										  ...
										  <select class="form-control" id="meeting_type" name="meeting_type" onchange="javascript:handleSelect(this)" required data-validation-required-message="Select chairman of the meeting">
											...
											<option value="<?php echo base_url('staff/operation/boardmeetinglist')?>" >Board Meeting</option>
											<option value="<?php echo base_url('staff/operation/committeemeetinglist')?>" >Committee Meeting</option>
											<option value="<?php echo base_url('staff/operation/annualmeetinglist')?>" >Annual General Meeting</option>
										 </select>
