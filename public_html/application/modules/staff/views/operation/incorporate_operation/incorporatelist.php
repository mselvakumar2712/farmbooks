                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/incorporatelist');?>">List Upload Incorporation Documents </a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">					
                        <div class="card-body">	
                           <div class="container">
								...
								<a href="<?php echo base_url('staff/operation/addincorporate');?>">
									<button type="button" class="btn btn-success btn-labeled">
										<i class="fa fa-plus-square"></i> <span class="ml-2"> Add Upload Incorporation Documents</span>
									</button>
								</a>
							 </div>
						   </div>							
