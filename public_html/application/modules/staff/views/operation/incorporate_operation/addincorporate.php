      ...
      <div class="container-fluid pl-0 pr-0">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Add Upload Incorporation Documents</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/addincorporate');?>">Add Upload Incorporation Documents</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/post_incorporate')?>"  method="post"  enctype="multipart/form-data" id="directorform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="row row-space">
										  ...
										  <a href="<?php echo base_url('staff/operation/incorporatelist');?>" class="btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
...
$(document).ready(function() {	
		...
		if(validate){
			...
			i++;
			$('#dynamic_field').prepend('<tr id="row'+i+'" class="dynamic-added"><td><select class="form-control document_type_chng1" id="document_name'+i+'" name="document_name[]" data-validation-required-message="Please select document."><option value="">Select Document Name</option><?php for($i=0; $i<count($doc_type);$i++) { ?><option value="<?php echo $doc_type[$i]->id; ?>"><?php echo $doc_type[$i]->doc_name; ?></option><?php } ?></select><p class="help-block text-danger"></p></td><td><select class="form-control restrict_type" id="document_type'+i+'" name="document_type[]" data-validation-required-message="Please select document."><option value="">Select Document Name</option></select><p class="help-block text-danger"></p></td><td><input type="file" name="file_path[]" id="file_type'+i+'" class="form-control fl_upload"> </td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">-</button></td></tr>');  
         initnumberOnly();
			initfiletype();
