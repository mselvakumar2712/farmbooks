      ...
      <div class="container-fluid pl-0 pr-0">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Edit Notice to Directors</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/editnotice');?>">Edit Notice to Directors</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('staff/operation/update_notice/'.$notice_info[0]->id)?>"  method="post" id="noticeform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
												<div class="row row-space  mt-4"> 
													  <div class="form-group col-md-3">
														  <label for="">Date of Notice <span class="text-danger">*</span></label>
															 <input type="date" class="form-control" value="<?php echo $notice_info[0]->notice_date; ?>" min="<?php echo date("Y-m-d"); ?>" value="<?php echo date("Y-m-d"); ?>" id="notice_date" name="notice_date" required="required" data-validation-required-message="Please enter notice date.">
														 <p class="help-block text-danger"></p>
													  </div>
													  <div class="form-group col-md-3">
														<label for="">Date of Meetings <span class="text-danger">*</span></label>
														<input type="date" class="form-control" max="<?php echo date("Y-m-d",strtotime("+7 days")); ?>" value="<?php echo $notice_info[0]->meeting_date; ?>" id="meeting_date" name="meeting_date" required="required" data-validation-required-message="Please enter date of meeting.">
														<div class="help-block with-errors text-danger"></div>
													  </div>
													  <div class="form-group col-md-3">
														<label for="">Time <span class="text-danger">*</span></label>
														<input type="time" class="form-control" id="meeting_time" name="meeting_time" value="<?php $time=$notice_info[0]->meeting_time;echo $time; ?>" required="required" data-validation-required-message="Please enter meeting time.">
														<div class="help-block with-errors text-danger"></div>
													  </div>
													  <div class="form-group col-md-3">
														<label for="">Place of Meeting <span class="text-danger">*</span></label>
														<input type="text" maxlength="50" class="form-control" placeholder="Place of Meeting" value="<?php echo $notice_info[0]->place_of_meeting; ?>" id="meeting_place" name="meeting_place" required="required" data-validation-required-message="Please enter meeting place.">
														<div class="help-block with-errors text-danger"></div>
													  </div>
												</div>
												<div class="row row-space  mt-4"> 
													<div class="form-group col-md-4">
														...
														<input type="text" class="form-control numberOnly this_pin_code" readonly   onkeyup="getPincode(this.value)" pattern="[1-9][0-9]{5}" id="pin_code" name="pin_code" placeholder="PINCODE" required="required" data-validation-required-message="Please enter pin code." >
												...
												<div class="form-group col-md-4">						    
													...
													<select  class="form-control sel_panchayat" id="gram_panchayat" name="gram_panchayat" readonly required="required" data-validation-required-message="Please select gram panchayat." onchange="getVillageList(this.value);">
										...
										<div class="row row-space  mt-4"> 	
											<div class="form-group col-md-4">						    
												...
												<select class="form-control sel_village" id="village" name="village" readonly required="required" data-validation-required-message="Please select village."> 
										...
										<div class="row row-space  mt-4"> 
											<div class="form-group col-md-6">
												...
												<textarea class="form-control" maxlength="1000" id="agenda" name="agenda" placeholder="Agenda" required="required" data-validation-required-message="Please select agenda."><?php echo $notice_info[0]->agenda; ?></textarea>
												<div class="help-block with-errors text-danger"></div>
											</div>
											<div class="form-group col-md-6" id="reason1">
												...
												<textarea class="form-control" maxlength="1000" readonly id="reason_notice" name="reason_notice" placeholder="Reason for Short Notice" ><?php echo $notice_info[0]->short_notice_reason; ?></textarea>
												<div class="help-block with-errors text-danger"></div>
											</div>
											<div class="form-group col-md-6" id="reason2">
												<label for="inputAddress2">Reason for Short Notice <span class="text-danger">*</span></label>
												<textarea class="form-control" maxlength="1000"  id="reason_notice" name="reason_notice" placeholder="Reason for Short Notice" required="required" data-validation-required-message="Please select reason for short notice."><?php echo $notice_info[0]->short_notice_reason; ?></textarea>
												<div class="help-block with-errors text-danger"></div>
											</div>
										</div>
										</div>										
										<div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('staff/operation/noticelist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
...
$('#meeting_date').on('change', function() {
  ...
  $("#reason_notice").prop('readonly',false);
  $('#reason2').show();
  $('#reason1').hide();
});
...
function getFPODetails(fpo_id) {
    $.ajax({
           url:"<?php echo base_url();?>staff/operation/getLocationByFpo/"+fpo_id,
           type:"GET",
           data:"",
           dataType:"html",
           cache:false,			
