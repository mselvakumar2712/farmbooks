      ...
      <div class="container-fluid pl-0 pr-0">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>View Notice to Directors</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/viewnotice');?>">View Notice to Directors</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="#"  method="post" id="noticeform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
												...
												<div class="row row-space  mt-4"> 
													  <div class="form-group col-md-3">
														  <label for="">Date of Notice <span class="text-danger">*</span></label>
															 <input type="date" class="form-control" value="<?php echo $notice_info[0]->notice_date; ?>" readonly id="notice_date" value="<?php echo date("Y-m-d"); ?>" min="<?php echo date("Y-m-d"); ?>" name="notice_date" required="required" data-validation-required-message="Please enter notice date.">
														 <p class="help-block text-danger"></p>
													  </div>
													  <div class="form-group col-md-3">
														<label for="">Date of Meetings <span class="text-danger">*</span></label>
														<input type="date" class="form-control" readonly value="<?php echo $notice_info[0]->meeting_date; ?>" max="<?php echo date("Y-m-d",strtotime("+7 days")); ?>" id="meeting_date" name="meeting_date" required="required" data-validation-required-message="Please enter date of meeting.">
														<div class="help-block with-errors text-danger"></div>
													  </div>
													  <div class="form-group col-md-3">
														<label for="">Time <span class="text-danger">*</span></label>
														<input type="time" class="form-control" readonly id="meeting_time" name="meeting_time" value="<?php echo $notice_info[0]->meeting_time; ?>" required="required" data-validation-required-message="Please enter meeting time.">
														<div class="help-block with-errors text-danger"></div>
													  </div>
													   <div class="form-group col-md-3">
														<label for="">Place of Meeting <span class="text-danger">*</span></label>
														<input type="text" maxlength="50" readonly class="form-control" placeholder="Place of Meeting" value="<?php echo $notice_info[0]->place_of_meeting; ?>"  id="meeting_place" name="meeting_place" required="required" data-validation-required-message="Please enter meeting place.">
														<div class="help-block with-errors text-danger"></div>
													  </div>
												</div>
												<div class="row row-space  mt-4"> 
													<div class="form-group col-md-4">
														...
														<input type="text" class="form-control numberOnly this_pin_code" readonly onkeyup="getPincode(this.value)" pattern="[1-9][0-9]{5}" id="pin_code" name="pin_code" placeholder="PINCODE" required="required" data-validation-required-message="Please enter pin code." disabled>
										...
										<div class="row row-space  mt-4"> 	
											...
											<div class="form-group col-md-4">
												...
												<input type="text" class="form-control" value="<?php echo $fpo_list[0]->street;?>" maxlength="75" id="street" name="street" placeholder="Street" disabled>
											</div>
											<div class="form-group col-md-4">
												<label for="inputAddress2">Door No</label>
												<input type="text" class="form-control" maxlength="10" value="<?php echo $fpo_list[0]->door_no;?>" id="door_no" name="door_no" placeholder="Door No"disabled>
											</div>
										</div>
										<div class="row row-space  mt-4"> 
											<div class="form-group col-md-6">
												<label for="inputAddress2">Agenda <span class="text-danger">*</span></label>
												<textarea class="form-control" maxlength="1000" readonly id="agenda" name="agenda" value="" placeholder="Agenda" required="required" data-validation-required-message="Please select agenda."><?php echo $notice_info[0]->agenda; ?></textarea>
												<div class="help-block with-errors text-danger"></div>
											</div>
											<div class="form-group col-md-6">
												<label for="inputAddress2">Reason for Short Notice <span class="text-danger">*</span></label>
												<textarea class="form-control" maxlength="1000" disabled id="reason_notice" name="reason_notice" value="" placeholder="Reason for Short Notice" required="required" data-validation-required-message="Please select reason for short notice."><?php echo $notice_info[0]->short_notice_reason; ?></textarea>
												<div class="help-block with-errors text-danger"></div>
											</div>
										</div>
										</div>										
										<div class="col-md-12 text-center">
											<a href="<?php echo base_url('staff/operation/editnotice/'). $notice_info[0]->id;?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit<a>
											<a href="<?php echo base_url('staff/operation/noticelist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
