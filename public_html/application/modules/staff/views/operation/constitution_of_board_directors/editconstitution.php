                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/editconstitution/'.$constitution_info['id']);?>">Edit Constitution of Board of Directors</a></li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="col-md-12 text-center">
										  ...
										  <a href="<?php echo base_url('staff/operation/constitutionlist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
