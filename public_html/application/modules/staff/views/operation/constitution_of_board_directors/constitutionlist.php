                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('staff/operation/constitutionlist');?>">List Constitution of Board of Directors</a></li>
                        </ol>
                    </div>
                </div>
            </div>
							...
							<div class="" style="text-align:right;margin-bottom:20px;" >
								<?php 
									if($active_constitution >0) {
										...
										?>
										<a href="<?php echo base_url('staff/operation/addconstitution');?>">
                         ...
                         <th width="30%">Director</th>	                         
                           ...
                           <td><?php echo implode(',', $row->directors);?></td>                          
									<td class="text-center">
										<a href="<?php echo base_url('staff/operation/editconstitution/' . $row->id); ?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
										<a href="<?php echo base_url('staff/operation/viewconstitution/' . $row->id); ?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
									</td>							
