                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li ><a  class="active" href="<?php echo base_url('staff/fpg');?>">List FPG</a></li>
            ...
            <div class="animated fadeIn">
						<div class="container">
							...
							<div class="" style="text-align:right;margin-bottom:20px;" >
								...
								<a href="<?php echo base_url('staff/fpg/addfpg');?>">
											...
											<thead>
											 ...
											 <tbody id="fpglist">
													...
													<tr> 																							
														...
														?></td>																			 
														<td >
														<a href="<?php echo base_url('staff/fpg/viewfpg/' . $row->id); ?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-eye" aria-hidden="true" title="Edit"></i></a>
														</td>							
													</tr>
												<?php endforeach; ?>
											</tbody> 
											<!--<tbody id="fpglist">
												<?php //foreach($fpg_info as $fpg){?>
												<tr>
													...
													<td><a href="<?php //echo base_url("staff/fpg/viewfpg/".$fpg->id);?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a></td>
												</tr>
												<?php //} ?>
											</tbody>-->
										</table>
