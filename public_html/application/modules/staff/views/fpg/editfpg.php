      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('staff/fpg/updatefpg/'.$fpg_info->id)?>" method="post" name="sentMessage" novalidate="novalidate" id="editfpgform" >
									...
									<div class="card-body">
										...
										<div class="row row-space">
										 ...
										 <div class="form-row">
											  ...
											  <div id="success"></div>
												<?php if(check_staff_permission($_SESSION['profile_type'], 10303)){ ?>
											...
											<!--	<a href="#" id="" class="del btn btn-danger"> Delete</a>-->
												<a href="<?php echo base_url('staff/fpg');?>" id="back" href="" class="btn-fs btn btn-outline-dark text-center"><i class="fa fa-arrow-circle-left"></i>  Back</a>
												<a href="<?php echo base_url('staff/fpg');?>" id="cancel" style="display:none" class="btn-fs btn btn-outline-dark text-center"> <i class="fa fa-close" aria-hidden="true"></i>  Cancel</a>
											  </div>
		...
		swal({
         ...
         if (result.value) {          
            ...
            $.ajax({
              ...
              success: function() {        
                 setTimeout(function() {
                  window.location.replace("<?php echo base_url('staff/fpg')?>");
                 }, 1000);
              },
              error: function() {
