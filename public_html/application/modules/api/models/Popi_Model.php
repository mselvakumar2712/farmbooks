...
/** POPI Starts **/
   ...
   function popiByID($popi_id) {
      ...
      $this->db->join('trv_panchayat_master', 'trv_panchayat_master.id = trv_popi.panchayat', 'left');
      $this->db->join('trv_taluk_master', 'trv_taluk_master.id = trv_popi.taluk', 'left');
      $this->db->join('trv_block_master', 'trv_block_master.id = trv_popi.block', 'left');
      $this->db->where(array('trv_popi.id' => $popi_id));
      return $this->db->get()->result();
   }
...
//        $this->db->join('trv_taluk_master', 'trv_taluk_master.id = trv_popi.taluk');
    ...
    function verifyChildByPOPI( $popi_id ) {
        $popi_count = $this->db->get_where('trv_fpo', array('popi_id' => $popi_id))->num_rows();
		return $popi_count;
    }
    ...
    function popiDropDownList() {
        ...
        $this->db->select('trv_popi.id, trv_popi.institution_name');
