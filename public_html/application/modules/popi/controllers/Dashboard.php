...
class Dashboard extends CI_Controller {
   ...
   public function __construct() {
      ...
      if (!$this->session->userdata('name')  || $this->session->userdata('is_active') == 0  || ($this->session->userdata('user_type') != 1  && $this->session->userdata('user_type') != 2) ){ 
         redirect('login');
		}
	...
	public function index()
	{
      ...
      $data['farmer_count']=$this->Dashboard_Model->farmerCount();
      $data['farmer_Monthwise']=$this->Dashboard_Model->farmerMonthwiseCount();
      $data['fpo_count']=$this->Dashboard_Model->fpoCount();
      $data['fpo_Monthwise']=$this->Dashboard_Model->fpoMonthwiseCount();
      $data['fig_count']=$this->Dashboard_Model->figCount();
      $data['fig_Monthwise']=$this->Dashboard_Model->figMonthwiseCount();
      $data['fpg_count']=$this->Dashboard_Model->fpgCount();
      $data['fpg_Monthwise']=$this->Dashboard_Model->fpgMonthwiseCount();
      $data['crop_count']=$this->Dashboard_Model->harvestedCropcount();
      $data['farming_area']=$this->Dashboard_Model->farmingArea();
      $data['yearly_harvest']=$this->Dashboard_Model->yearlyHarvest();
      $data['farming_previousyear']=$this->Dashboard_Model->farmingPreviousyeararea();//print_r($data['fig_Monthwise']);
      $data['previous_yearlyharvest']=$this->Dashboard_Model->previousYearharvest();
