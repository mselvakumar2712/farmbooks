                ...
                <div class="col-md-12">
                    <div class="card">					
                        <div class="card-body">	
                            ...
                            <?php }?>
							<form action="<?php echo base_url('popi/farmer/updateFarmer/'.$farmer_list[0]->id); ?>" id="farmer_profileForm" name="farmer_profileForm" method="post" enctype="multipart/form-data" >
			...
			$('a.del').click(function(){
                ...
                swal({
                 ...
                 if (result.value) {          
                    ...
                    $.ajax({
                      url: "<?php echo base_url();?>popi/farmer/deleteFarmer/"+farmer_id,
                      type: "POST",
                      data: {
                      ...
                      success: function() {        
                         setTimeout(function() {
                          window.location.replace("<?php echo base_url('popi/farmer/profilelist')?>");
                         }, 1000);
                      },
                      error: function() {
