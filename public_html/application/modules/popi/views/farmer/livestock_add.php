							 ...
							 <div id="form-step-3" role="form" data-toggle="validator">
								...
								<div id="live_stocks_form_0" style="display:none;">
                                 ...
                                 <div class="form-group col-md-12 text-center">											         <button id="sendMessageButton" class="btn btn-fs btn-success text-center" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
									<a href="<?php echo base_url('popi/farmer/livestocklist');?>" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
				                </div>
						       </form>
						     </div>
					      </div>
...
$('select[id="live_stocks_type"]').on('change', function() {
    ...
    $.ajax({
			url:"<?php echo base_url();?>popi/farmer/getLiveStocks/"+live_stocks_type,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,			
...
$('form').submit(function(e){
    e.preventDefault();
        ...
        $.ajax({
			url:"<?php echo base_url();?>popi/farmer/postLiveStock",
			type:"POST",
			data:farmerdata,
			dataType:"html",
            cache:false,			
