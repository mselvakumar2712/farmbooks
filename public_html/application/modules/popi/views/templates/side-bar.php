      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?php echo base_url('popi/dashboard');?>"><img class="img-fluid" src="<?php echo asset_url()?>img/logo-mobile.png" style="margin:auto; max-height:60px;" alt="FPO"></a>
