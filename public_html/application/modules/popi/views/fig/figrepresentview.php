                ...
                <div class="page-header float-right">
                    <div class="page-title">
                      <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('popi/fig/figrepresentativelist');?>">FIG Representative</a></li>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<form action="<?php echo base_url('popi/fig/updatefigrepresent/'.$figrepresent_list[0]->id)?>" name="sentMessage" method="post" id="editfigrepresent" novalidate="novalidate" >				
							...
							<div class="row">								
							  <div class="form-group col-md-12 text-center">
								<div id="success"></div>
									...
									<a href="<?php echo base_url('popi/fig/figrepresentativelist');?>" id="ok"  class="btn-fs btn btn-outline-dark text-center mt-3" ><i class="fa fa-arrow-circle-left"></i>  Back</a>
									<a href="<?php echo base_url('popi/fig/figrepresentativelist');?>" id="cancel"  class="btn-fs btn btn-outline-dark text-center mt-3" style="display:none"><i class="fa fa-close" aria-hidden="true"></i>  Cancel </a>
							  </div>
						    </div>
...
//fig_list 
	function getFig( fpo_id  ) {
		...
		if( fpo_id !='') {   
			 $.ajax({
				url:"<?php echo base_url();?>popi/fig/figname/"+fpo_id,
				type:"GET",
				data:"",
				dataType:"html",
				cache:false,			
				...
				console.log(response);
					...
					$("#fig_list").append($('<option></option>').val(value.id).html(value.FIG_Name));
					});
					}
				},
				error:function(response){
	...
	function verifyMember(mobile_or_aadhaar_value) {
			$.ajax({
				url:"<?php echo base_url();?>popi/Fig/verifyMember/",
				type:"POST",
	...
	$('a.del').click(function() {
		...
		swal({
         ...
         if (result.value) {          
            ...
            $.ajax({
              url: "<?php echo base_url();?>popi/fig/deletefigrepresent/"+figrepresent_id,
              type: "POST",
              data: {
              ...
              success: function() {        
                 setTimeout(function() {
                  window.location.replace("<?php echo base_url('popi/fig/figrepresentativelist')?>");
                 }, 1000);
              },
              error: function() {                 
                 setTimeout(function() {
	...
	if(memeber_ship) {
		$.ajax({
			url:"<?php echo base_url();?>fpo/Fig/getmember/"+memeber_ship,
			type:"POST",
			data:memeber_ship,
			dataType:"html",
			cache:false,      
