      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('popi/fig/postfig')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="form-group col-md-6">						    
										 ...
										 <div class="row row-space">
												...
												<label for="inputAddress2">Name of the Farmer Interest Group <span class="text-danger">*</span> </label>
													<input type="text" class="form-control" maxlength="50" id="interest_group" minlength="3" maxlength="50" name="interest_group" placeholder="Name of the Farmer Interest Group" required="required" data-validation-required-message="Please enter name of the farmer interest group.">
													<p class="help-block text-danger"></p>
												</div>
												</div>
												<div class="row row-space">
										 ...
										 <div class="form-row">
											  ...
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('popi/fig');?>" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
											  </div>
		...
		console.log(responseArray.fpo_list);
		 if(responseArray.status == 1){
			...
			$.each(responseArray.fpo_list,function(key,value){
			 fig_list += '<option value='+value.user_id+'>'+value.producer_organisation_name+'</option>';
			});
