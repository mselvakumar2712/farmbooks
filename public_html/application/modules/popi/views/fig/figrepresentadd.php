            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<form action="<?php echo base_url('popi/fig/postfigrepresent')?>" name="sentMessage" method="post" id="figrepresent" novalidate="novalidate" >				
						<div class="row row-space">	
						 ...
						 <div class="row row-space mt-3">
						    <div class="form-group col-md-4">
								<label for="inputAddress2">Mobile <span class="text-danger">*</span></label>	
								<input type="text" class="form-control numberOnly" minlength="10" maxlength="12" id="mobile_or_aadhaar" name="mobile_or_aadhaar" placeholder="Mobile No" required data-validation-required-message="Provide any Mobile or Aadhaar no.">
							...
							<div class="row mt-5">
							  <div class="col-md-12 text-center">
								...
								<a href="<?php echo base_url('popi/fig/figrepresentativelist');?>" class="btn-fs btn btn-outline-dark mt-10"><i class="fa fa-close" aria-hidden="true"></i>  Cancel</a>	
							  </div>
						    </div>
...
$(document).ready(function() {
	var popi_id =<?php echo $this->session->userdata('user_id');?>;
   //fpo list
	$.ajax({
			url:"<?php echo base_url();?>popi/fig/fponame/"+popi_id,
			type:"GET",
			data:"",
			dataType:"html",
			cache:false,			
