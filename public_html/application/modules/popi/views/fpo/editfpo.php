   ...
   <body>
      <div class="container-fluid pl-0 pr-0">
		...
		<div class="content mt-3">
			...
			<div class="card">
			<div class="card-body">
			    <form action="<?php echo base_url('popi/fpo/updatefpo/'.$fpo_info['id'])?>" id="editfpo_Form" role="form" novalidate="novalidate" data-toggle="validator" method="post" accept-charset="utf-8">
			    <div id="smartwizard">
					<ul>
				...
				<div>
				 <div  id="step-1">
					    <div id="form-step-0" class="form-horizontal" role="form" data-toggle="validator">
							...
							<div class="form-group col-md-12 mt-1">
								...
								<div class="form-group col-md-4">
									...
									<select  class="form-control sel_taluk" id="taluk" name="taluk_id" disabled  placeholder="Taluk" required>
										<?php foreach($taluk_info as $taluk){
                                                if($taluk->taluk_code == $fpo_info['taluk'])
								...
								<div class="form-group col-md-4">
									...
									<select  class="form-control sel_block" id="block" name="block" disabled  placeholder="Block" required>
							...
							<div class="form-group col-md-12 mt-1">
								...
								<div class="form-group col-md-4">
									...
									<input type="text" class="form-control numberOnly" title="Landline number starts with '0'" pattern="^[0][0-9]{2,8}$" value="<?php echo $fpo_info['std_code']?>" id="std_code" name="std_code" maxlength="8" minlength="3" placeholder="Ex:012"disabled>
								</div>
								<div class="form-group col-md-4">
							...
							<div class="form-group col-md-12 mt-1">
								<div class="form-group col-md-4">
									...
									<input type="text" class="form-control numberOnly" readonly pattern="^[6-9]\d{9}$" value="<?php echo $fpo_info['mobile']?>" id="mobile" name="mobile" placeholder="Mobile Number" required="required" data-validation-required-message="Please enter mobile number.">
								...
								<div class="form-group col-md-4">
											...
											<input type="radio" id="constitution1" name="constitution" value="1" class="form-check-input" required="required" data-validation-required-message="Please select constitution."disabled>
											Company
											</label>
											</div> 
											</div>
											...
											<input type="radio" id="constitution2" name="constitution" value="2" class="form-check-input" required="required" data-validation-required-message="Please select constitution."disabled>
											Society
											</label>
											</div>
											</div>			
							...
							<div  id="step-2">
							    <div id="form-step-1" class="form-horizontal" role="form" data-toggle="validator">								
									<div class="form-group col-md-12 mt-1">
										...
										<input type="date" class="form-control" onfocusout="calculateformdate(this.value);"  name="date_formation"  id="date_formation" min="01-01-20" value="<?php echo $fpo_info['date_formation']?>" placeholder="Date of Formation" required="required" data-validation-required-message="Please enter date of formation." title="If need date picker, click the arrow " disabled>
										<div class="help-block with-errors text-danger"></div>
									</div>
										<div class="form-group col-md-4">
									...
									<div class="form-group col-md-12 mt-1">
											<div class="form-group col-md-4">
												...
												<input type="text" class="form-control text-uppercase" id="tax_deduction" maxlength="10" value="<?php echo $fpo_info['tax_deduction']?>" name="tax_deduction" placeholder="Ex:AAAA00000A" disabled>
											</div>
											<div class="form-group col-md-4">
									...
									<div class="form-group col-md-12 mt-1">
										<div class="form-group col-md-4">
												...
												<input type="text" class="form-control" maxlength="100" name="contact_person" value="<?php echo $fpo_info['contact_person']?>"  id="contact_person" placeholder="Name of the Contact Person" required="required" data-validation-required-message="Please enter contact person name."disabled>
												<div class="help-block with-errors text-danger"></div>
											</div>
									  <div class="form-group col-md-4">
										...
										<div class="col-md-6">
										  <div class="form-check-inline form-check">
											<label for="inventory_required1" class="form-check-label">
											  <input type="radio" id="inventory_required1" name="inventory_required" value="1" class="form-check-input" required="required" data-validation-required-message="Please select constitution." disabled>Yes
											</label>
										  </div> 
										</div>
										<div class="col-md-6">
										  <div class="form-check-inline form-check">
											<label for="inventory_required2" class="form-check-label">
											  <input type="radio" id="inventory_required2" name="inventory_required" value="2" class="form-check-input" required="required" data-validation-required-message="Please select constitution." disabled>No
											</label>
											</div>
										</div>					
									  </div>
									...
									<input type="date" class="form-control"  name="financial_year" onfocusout="calculatedate(this.value);" value="<?php echo $fpo_info['financial_year']?>" id="financial_year" placeholder="Financial Year Begins" required="required" data-validation-required-message="Please enter financial year" title="If need date picker, click the arrow " disabled>
									<div class="help-block with-errors text-danger"></div>
									</div>
								...
								<div class="form-group col-md-4">
									...
									<input type="date" class="form-control"  name="financial_year_to" onfocusout="calculatedate(this.value);" readonly value="<?php echo $fpo_info['financial_year_to']?>" id="financial_year_to"  placeholder="Financial Year Closing" required="required" data-validation-required-message="Please enter financial year" title="If need date picker, click the arrow" disabled >
									<div class="help-block with-errors text-danger"></div>
								</div>
								<div class="form-group col-md-4">
									<label for="inputAddress2">Business Commence From <span class="text-danger">*</span></label>
									<input type="date" class="form-control" onfocusout="calculateformdate(this.value);"  name="business_commence" value="<?php echo $fpo_info['business_commence']?>" maxlength="10" id="business_commence" placeholder="Business Commence From" required="required" data-validation-required-message="Please enter business commence from" title="If need date picker, click the arrow " readonly disabled>
					 ...
					 <div class="col-md-12 text-center">
						...
						<a href="<?php echo base_url('popi/fpo');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
						<a href="<?php echo base_url('popi/fpo');?>" id="cancel" class="btn btn-outline-dark btn-fs" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
					</div>
				   </form>					
				  </div>
				</div>
...
$(document).ready(function(){
	  ...
	  //edit popi API CALL
			var fpg_status =$('input:radio[name=constitution]');  
			var sts='<?php echo $fpo_info['constitution']?>';
                        //live stocks purchase by loan  
				if(sts == 1){
					 if(fpg_status.is(':checked') === false) { 
						fpg_status.filter('[value=1]').prop('checked', true);
					}
				}else{
					if(fpg_status.is(':checked') === false) {
						fpg_status.filter('[value=2]').prop('checked', true);
					}
				}
			var fpg_inventory =$('input:radio[name=inventory_required]');  
			var sts1='<?php echo $fpo_info['inventory_required']?>';
                        //live stocks purchase by loan  
				if(sts1 == 1){
					 if(fpg_inventory.is(':checked') === false) { 
						fpg_inventory.filter('[value=1]').prop('checked', true);
					}
				}else{
					if(fpg_inventory.is(':checked') === false) {
						fpg_inventory.filter('[value=2]').prop('checked', true);
					}
				}
				
			var fpo_pincode ='<?php echo $fpo_info['pin_code']?>';
			if(fpo_pincode){
					$.ajax({
						url:"<?php echo base_url();?>popi/Login/getlocation/"+fpo_pincode,
						type:"GET",
						data:"",
						dataType:"html",
						cache:false,			
	...
	$('a.del').click(function() {
		...
		swal({
         ...
         if (result.value) {          
            ...
            $.ajax({
              url: "<?php echo base_url();?>popi/fpo/deletefpo/"+fpo_id,
              type: "GET",
              data: "",
              cache: false,
              success: function(response) { 
                  ...
                  if(responseArray.status == 1) {
                    setTimeout(function() {
                        window.location.replace("<?php echo base_url('popi/fpo')?>");
                    }, 1000);
                  } else {
