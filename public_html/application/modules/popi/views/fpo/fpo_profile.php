						  ...
						  <div class="row row-space">							
							...
							<div class="form-group col-md-6 ">
								...
								<div class="row">
								    ...
								    <div class="form-group col-md-12">
										...
										<input type="text" class="form-control" value="<?php echo $fpo_list[0]->tax_deduction ?>" id="tax_deduction" maxlength="10" name="tax_deduction" placeholder="Tax Deduction Account(TAN)" required="required" data-validation-required-message="Please enter tax deduction account."disabled>
									</div>
									<div class="form-group col-md-12">
										<label for="inputAddress2">IE Code Number</label>
										<input type="text" class="form-control" value="<?php echo $fpo_list[0]->ie_code?>" name="ie_code" maxlength="10" id="ie_code" placeholder="Goods & Service Tax Number (GST)" required="required" data-validation-required-message="Please enter GST"disabled>
									</div>
									 <div class="form-group col-md-12">
									...
									<input type="date" class="form-control" value="<?php echo $fpo_list[0]->business_from?>" name="business_from" maxlength="10" id="business_commence_from" placeholder="Business Commence From" required="required" data-validation-required-message="Please enter business commence from" title="If need date picker, click the arrow " min="2018-01-01" max="2050-12-31"disabled>
									<div class="help-block with-errors text-danger"></div>
								    </div>
							...
							<div class="form-group col-md-6 ">
								<div class="form-group col-md-12">
									...
									<input type="date" class="form-control"  name="date_formation" value="<?php echo $fpo_list[0]->date_formation;?>" id="date_formation" placeholder="Date of Formation" required="required" data-validation-required-message="Please enter date of formation." title="If need date picker, click the arrow "disabled min="2018-01-01" max="2050-12-31">
									<div class="help-block with-errors text-danger"></div>
								</div>
								<div class="form-group col-md-12">
									<label for="inputAddress2">Permanent Account Number(PAN) </label>
									<input type="text" class="form-control"  maxlength="10" value="<?php echo $fpo_list[0]->pan?>" id="pan" name="pan" placeholder="Permanent Account Number" required="required" data-validation-required-message="Please enter pan."disabled>
									<div class="help-block with-errors text-danger"></div>
								</div>
								<div class="form-group col-md-12">
									<label for="inputAddress2">Goods & Service Tax Number (GST)</label>
									<input type="text" class="form-control"  name="gst" value="<?php echo $fpo_list[0]->gst?>" maxlength="15" id="gst" placeholder="Goods & Service Tax Number (GST)" required="required" data-validation-required-message="Please enter GST"disabled>
								</div>
							...
							<table style="width:100%">
							  ...
							  <th>Type Of Business</th>
							   <td><input type="text" class="form-control" id="business_type" name="business_type" value="<?php echo $fpo_list[0]->business_type;?>" class="form-check-input" required="required" data-validation-required-message="Please select."disabled></td>
							  </tr>
							  <tr>
							  <th>Nature of Business </th>
							   <td><input type="text" class="form-control" id="business_nature" name="business_nature" value="<?php echo $fpo_list[0]->business_nature;?>" class="form-check-input" required="required" data-validation-required-message="Please select."disabled></td>
							  </tr>
							  <tr>
