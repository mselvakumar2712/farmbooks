      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('popi/fpg');?>">FPG</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('popi/fpg/updatefpg/'.$fpg_info->id)?>" method="post" name="sentMessage" novalidate="novalidate" id="editfpgform" >
                                       ...
                                       <div class="form-group col-md-6">
										...
										<div class="row row-space">
											...
											<div class="form-group col-md-6">						    
												...
												<select  class="form-control sel_taluk" id="taluk" name="taluk" required="required" disabled data-validation-required-message="Please select block.">
										...
										<div class="row row-space">
											<div class="form-group col-md-6">						    
												...
												<select  class="form-control sel_block" id="block" name="block" required="required" disabled data-validation-required-message="Please select block." >
										 ...
										 <div class="row row-space">
											<div class="form-group col-md-6">						    
												...
												<div class="form-group col-md-6">
													...
													<input type="text" maxlength="50" class="form-control" id="interest_group" value="<?php echo $fpg_info->FPG_Name ?>" name="interest_group" disabled placeholder="Name of the Farmer Producer Group" required="required" data-validation-required-message="Please enter name of the farmer interest group.">
													<p class="help-block text-danger"></p>
												</div>
										 </div>
										 <div class="row row-space">
													...
													<div class="col-md-6">
													  ...
													  <div class="form-check-inline form-check">
														...
														<label for="inline-radio1" class="form-check-label">
														  ...
														  <input type="radio" id="inline-radio1" name="status" value="1" class="form-check-input" disabled required="required" data-validation-required-message="Please select.">Active
													...
													<div class="col-md-6">
													  ...
													  <div class="form-check-inline form-check">
														...
														<label for="inline-radio2" class="form-check-label">
														  ...
														  <input type="radio" id="inline-radio2" name="status" value="2" class="form-check-input" disabled required="required" data-validation-required-message="Please select.">Inactive
										 ...
										 <div class="form-row">
											  ...
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('popi/fpg');?>">	<button id="back" href="" class="btn btn-outline-dark btn-fs text-center" type="button"><i class="fa fa-arrow-circle-left"></i> Back</button></a>
...
/* $('a.del').click(function() {
		...
		swal({
         ...
         if (result.value) {          
            ...
            $.ajax({
              url: "<?php echo base_url();?>popi/fpg/deletefpg/"+fpg_id,
              type: "POST",
              data: {
                 this_delete: fpg_id,
              },
              ...
              success: function() {        
                 setTimeout(function() {
                  window.location.replace("<?php echo base_url('popi/fpg')?>");
                 }, 1000);
              },
              error: function() {
...
$(document).ready(function(){
	  //edit popi API CALL
	document.getElementById("fpo_list").value='<?php echo $fpg_info->fpo_id ?>';
	var fpg_status =$('input:radio[name=status]');  
	var sts=<?php echo $fpg_info->status ?>;
