      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  name="sentMessage" action="<?php echo base_url('popi/fpg/postfpg')?>" method="post" id="fpg_form" novalidate="novalidate" action="">
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="row row-space">
										 ...
										 <div class="row row-space">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control"  id="interest_group" name="interest_group" minlength="3" maxlength="50" placeholder="Name of the Farmer Producer Group" required="required"  data-validation-required-message="Please enter name of the farmer producer group.">
													<p class="help-block text-danger"></p>
												</div>
										 </div>
										 <div class="row row-space">
										  ...
										  <div class="form-group col-md-12 text-center">
											...
											<a href="<?php echo base_url('popi/fpg');?>" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										 </div>											  
										</div>
									</div>
								</div>
