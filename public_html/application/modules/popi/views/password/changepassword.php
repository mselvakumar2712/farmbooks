               ...
               <div class="col-md-6 offset-md-3">
                  <div class="panel-default px-3 py-4" style="height:100%">
                     <div class="panel-body">
						<form id="loginForm" name="sentMessage" novalidate="novalidate" action="<?php echo base_url('popi/popi/changepassword');?>" method="post">
							 ...
							 <div class="form-group row mt-4">
								   <div class="col-sm-12 text-center">
									  <div id="success"></div>
										...
										<a href="<?php echo base_url('popi/dashboard');?>" id="cancel" class="btn btn-outline-dark " >Cancel</a>
								   </div>
							 </div>
						 </div>
						 </form>
...
//Change password API Call
	...
	if(changepassword.user_id !='' && changepassword.password && changepassword.old_password){	
	  $.ajax({
		url:"<?php echo base_url();?>popi/popi/change_password",
		type:"POST",
		data:changepassword,
		dataType:"html",
		cache:false,			
		success:function(response){		  
			...
			console.log(response);
			 if(responseArray.status == 1){
				...
				window.location = "<?php echo base_url('popi/login')?>";
			} else {
