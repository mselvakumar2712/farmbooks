                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<!--weeding-->
                           ...
                           <a href="<?php echo base_url('administrator/updatecrop');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
                          </div>
						</form>
...
function getvarietydosageDetail( variety_id ) {
    ...
    // $("#nutrient_brand_name option").remove() ;
       if( variety_id !='')
				{	
				$.ajax({
					url:"<?php echo base_url();?>administrator/updatecrop/varietydosage/"+variety_id,
					type:"GET",
					data:"",
					dataType:"html",
					cache:false,			
    ...
    // $("#nutrient_brand_name option").remove() ;
       if( variety_id !='')
				{	
				$.ajax({
					url:"<?php echo base_url();?>administrator/updatecrop/fertilizerdosage/"+variety_id,
					type:"GET",
					data:"",
					dataType:"html",
					cache:false,			
       ...
       if( variety_id !='')
		...
		$('form').submit(function(e){
				...
				console.log(updatecropData);
			 	$.ajax({
					url:"<?php echo base_url();?>administrator/updatecrop/updatecrop_add",
					type:"POST",
					data:updatecropData,
					dataType:"html",
					cache:false,			
