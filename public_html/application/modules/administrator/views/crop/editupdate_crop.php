                     ...
                     <input type="hidden"  name="updatebrandname" id="updatebrandname" > 
						...
						<div class="row row-space" style="display:none" id="nutrient_form_details">
							...
							<label for="inputState">Nutrient Name <span class="text-danger">*</span></label>
							  <select id="nutrient_name" name="nutrient_name" class="form-control"  onchange="getnutrientDetail(this.value);" required="required" data-validation-required-message="Please select nutrient name">
                        ...
                        <?php } ?>  								
						  ...
						  <div class="row row-space" style="display:none" id="fertilizer_form_details">
							...
							<label for="inputState">Fertilizer Name <span class="text-danger">*</span></label>
							  <select id="fertilizer_name" name="fertilizer_name"  onchange="getfertilizerDetail(this.value);" class="form-control" required="required" data-validation-required-message="Please select fertilizer name" >
											...
											<div class="col-md-6">
											  <div class="form-check-inline form-check">
												<label for="inline-radio2" class="form-check-label">
												  <input type="radio" id="drip" name="fertilizer_feed_type" value="2" class="form-check-input" >Drip
						...
						<div class="row row-space" style="display:none" id="pesticide_form_details">
							...
							<label for="inputState">Pesticide Name <span class="text-danger">*</span></label>
							  <select id="pesticide_name" name="pesticide_name" class="form-control"  onchange="getpesticideDetail(this.value);" required="required" data-validation-required-message="Please select pesticide name">
							 ...
							 <div class="form-group col-md-6">
								<label for="inputAddress">Date of Dosage <span class="text-danger">*</span></label>
								<input type="date" class="form-control" name="pesticide_dosage_date" id="pesticide_dosage_date" placeholder="Date of Dosage" required="required" data-validation-required-message="Please enter Date of Dosage."  min="2018-01-01" max="2050-12-31">
							   <p class="help-block text-danger"></p>
							  </div>
							 <div class="form-group col-md-6">
								 <label class=" form-control-label">Brand Name<span class="text-danger">*</span></label>
								  ...
								  <div class="form-group col-md-6">
										<label for="inputState">Dosage</label>
										    <select id="pesticide_dosage" name="pesticide_dosage" class="form-control" required="required" data-validation-required-message="Please select variety" >
												<option value="">Select Dosage</option>
												<option value="1">1</option>
												<option value="2">2</option>
												<option value="3">3</option>
								    ...
								    <div class="form-group col-md-3">
										<label for="inputAddress">Quantity <span class="text-danger">*</span></label>
										<input type="text" class="form-control numberOnly" name="pesticide_quantity" id="pesticide_quantity" maxlength="4" placeholder="Quantity" required="required" data-validation-required-message="Please enter Quantity." >
										<p class="help-block text-danger"></p>
									</div>
									<div class="form-group col-md-3">
										<label for="inputAddress">Quantity UOM <span class="text-danger">*</span></label>
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control numberOnly" name="cost_of_pesticide" maxlength="6" id="cost_of_pesticide" placeholder="Cost of Pesticides" required="required" data-validation-required-message="Please enter Cost of nutrient." >
									</div>
						</div>
						<!--weeding-->
							<div class="row row-space" style="display:none" id="weeding_form_details">
								...
								<div class="form-group col-md-6">
								 ...
								 <div class="form-group col-md-6">
									...
									<input type="date" class="form-control" name="weeding_dosage_date" id="weeding_dosage_date" placeholder="Date of Dosage" required="required" data-validation-required-message="Please enter Date of Dosage."  min="2018-01-01" max="2050-12-31">
								   <p class="help-block text-danger"></p>
								  </div>								  
								  <div class="form-group col-md-6">
										<label for="inputState">Dosage</label>
										    <select id="weeding_dosage" name="weeding_dosage" class="form-control" required="required" data-validation-required-message="Please select dosage" >
												<option value="">Select Dosage</option>
												<option value="1">1</option>
												<option value="2">2</option>
												<option value="3">3</option>
									...
									<div class="form-group col-md-6">
										  ...
										  <div class="row">
											<div class="col-md-4">
											  <div class="form-check-inline form-check">
												<label for="inline-radio1" class="form-check-label">
												  <input type="radio" id="manual" onclick="show(0)" name="type_weeding" value="1" class="form-check-input" required ><span class="ml-1">Manual</span>
											...
											<div class="col-md-4">
											  <div class="form-check-inline form-check">
												<label for="inline-radio2" class="form-check-label">
												  <input type="radio" id="machine" onclick="show(1)" name="type_weeding" value="2" class="form-check-input" ><span class="ml-1">Machine</span>
											...
											<div class="col-md-4">
											  <div class="form-check-inline form-check">
												<label for="inline-radio2" class="form-check-label">
												  <input type="radio" id="chemicals" onclick="show(2)" name="type_weeding" value="3" class="form-check-input" ><span class="ml-1">Chemicals</span> 
												</label>
											   </div>
											</div>	
										  </div>
										...
										<div class="form-group col-md-6 manual" style="display:none;" id="d0">
											...
											<input type="text" class="form-control numberOnly" name="weeding_no_of_man" id="weeding_no_of_man" maxlength="3" placeholder="No.of.Man" required="required" data-validation-required-message="Please enter no.of man." >
											<p class="help-block text-danger"></p>
										</div> 
										<div class="form-group col-md-6 machine" style="display:none;" id="d1">
											<label for="inputAddress">Machine Hours</label>
											<input type="text" class="form-control numberOnly" name="weeding_machine_hrs" id="weeding_machine_hrs" maxlength="4" placeholder="Machine Hours" required="required" data-validation-required-message="Please enter machine hours." >
											<p class="help-block text-danger"></p>
										</div> 
										<div class="form-group col-md-3">
											<label for="inputAddress">Quantity <span class="text-danger">*</span></label>
											<input type="text" class="form-control numberOnly" name="weeding_quantity" id="weeding_quantity" disabled maxlength="4" placeholder="Quantity" required="required" data-validation-required-message="Please enter Quantity." >
											<p class="help-block text-danger"></p>
										</div>
										<div class="form-group col-md-3">
											<label for="inputAddress">Quantity UOM <span class="text-danger">*</span></label>
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control numberOnly" name="cost_of_weeding" maxlength="6" id="cost_of_weeding" placeholder="Cost of Weeding" required="required" data-validation-required-message="Please enter Cost of weeding." >
										</div>
                           </div>
                           <div class="col-md-12 text-center">
                                 <div id="success"></div>
                                <button id="sendMessageButton" class="btn-fs btn btn-success text-center" type="submit"> <i class="fa fa-check-circle"></i> Update Crop </button>
										<a href="<?php echo base_url('administrator/updatecrop');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
                             </div> 
                           </form>					
                        </div>
                    </div>
  ...
  $(document).ready(function(){
	...
	responseArray=$.parseJSON(response);
		if(responseArray.status == 1){
            ...
            document.getElementById("updatebrandname").value=responseArray.updatecrop_list[0].brand_name;
            console.log(responseArray.updatecrop_list[0].variety_id);
