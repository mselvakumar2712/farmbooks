            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<form id="crop_standardForm" name="sentMessage" method="post" action="<?php echo base_url('administrator/crop/post_crop')?>" novalidate="novalidate" enctype='multipart/form-data'>
                            ...
                            <div class="row row-space">
                               ...
                               <p class="help-block text-danger"></p>
                                ...
                                <div class="form-group col-md-6" id="filediv">
                                    <label for="inputAddress2">Upload Photo <span class="text-danger">(Max upload file size is 20KB)</span></label>
                        ...
                        <a href="<?php echo base_url('administrator/crop');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
							  </div>
						  </div>
