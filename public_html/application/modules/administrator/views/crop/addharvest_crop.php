							  ...
							  <div class="form-group col-md-6">
								 ...
								 <div class="row row-space">
								  <div class="form-group col-md-6" id="sales_visible" >
									<!--<label for="inputState">Quantity for Sales</label>
									<input type="text" class="form-control numberOnly"  onfocusout="myFunction(this.value)" name="sales_qty" id="sales_qty" maxlength="6" placeholder="Quantity for Sales" >
									<p class="help-block text-danger"></p>-->
							...
							<div class="row row-space mt-3">
								<div class="form-group col-md-12 text-center">
									<div class="form-group">
                                        ...
                                        <a href="<?php echo base_url('administrator/updatecrop/cropharvest');?>"><input id="back" value="Cancel" class="btn swal-button-cancel" type="button"></a>
									</div>	
								</div>		
							</div>
							</div> 
...
$('form').submit(function(e){
	...
	const updateharvestdata = $('#add_updatecrop').serializeObject();
	   ...
	   console.log(updateharvestdata);
		 $.ajax({
			url:"<?php echo base_url();?>administrator/updatecrop/crop_harvest",
			type:"POST",
...
function getcropDetail( farmer_id ) {
	$("#crop_variety option").remove() ;
		...
		{ 
	$.ajax({
		url:"<?php echo base_url();?>administrator/updatecrop/harvestvarietymaster/"+farmer_id,
		type:"GET",
		data:"",
		dataType:"html",
		cache:false,			
