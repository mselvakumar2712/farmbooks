            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                     ...
                     <form  id="crop_standardForm" action="<?php echo base_url('administrator/crop/updatecrop/').$_REQUEST['id']?>" name="sentMessage" method="post" novalidate="novalidate" enctype="multipart/form-data">
                           ...
                           <div class="row row-space">
                            ...
                            <div class="row row-space">							                                          
                              <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="checkbox" id="direct_seed" name="direct_seed" value="1" class="form-check-input"  disabled>Direct Seedling
                                    </div>
                            ...
                            <div class="row row-space"><div class="form-group col-md-3">
												...
												<input type="text" class="form-control numberonly"  id="area" maxlength="3" minlength="" name="area" placeholder="Area" required disabled>
												<p class="help-block text-danger"></p>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="transplant_date"  id="transplant_date" placeholder="Date of Transplanting"   title="If need date picker, click the arrow" min="<?php echo $beforeMonth; ?>" max="<?php echo $afterMonth; ?>" onfocusout="calculateExpectedHarverst(this.value);" readonly>
									         <p class="help-block text-danger"></p>
                                </div>
                           </div>
                            <div class="row row-space"> 
								    ...
								    <label for="inputAddress2">Quantity of Seed Used <span class="text-danger">*</span></label>
									 <input type="text" class="form-control numberonly" maxlength="4" id="used_seed_qty" name="used_seed_qty" placeholder="Quantity of Seed Used" data-validation-required-message="Please enter seed quantity" required disabled>
								    <p class="help-block text-danger"></p>
                                </div>
										  <div class="form-group col-md-3">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control numberonly" id="seed_cost" step="0.01" name="seed_cost" placeholder="0.00" disabled>
                              <p class="help-block text-danger"></p>
                              </div>
                           </div>
                            <div class="row row-space">
                                ...
                                <div class="form-group col-md-6"  id="filediv">
                                  ...
                                  <div> <img id="cropImage" class="mt-2" src="#" alt="crop image" /></div>
                                </div>
                           </div><input type="hidden" name="imgurl" id="imgurl">
                        <div class="col-md-12 text-center">
                           <div id="success"></div>
                            <a href="<?php echo base_url('administrator/crop/edit_crop/').$_REQUEST['id']?>" id="edit" class="btn-fs btn btn-success text-center"><i class="fa fa-edit"></i> Edit New Crop Entry<a>
								   <a href="<?php echo base_url('administrator/crop');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
...
$('a.del').click(function() {
  ...
  $(document).ready(function(){
	       //edit crop API CALL
			var crop_id =<?php echo $_REQUEST['id']; ?>;console.log(crop_id);
            // jQuery method
			$.ajax({
