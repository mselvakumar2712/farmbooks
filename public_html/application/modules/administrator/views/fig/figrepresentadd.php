            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<form action="<?php echo base_url('administrator/fig/postfigrepresent')?>" name="sentMessage" method="post" id="figrepresent" novalidate="novalidate" >				
						<div class="row row-space">
						 ...
						 <div class="row row-space mt-3">
						    <div class="form-group col-md-4">
								...
								<input type="text" class="form-control numberOnly" minlength="10" maxlength="10" id="mobile_or_aadhaar" name="mobile_or_aadhaar" placeholder="Mobile/AADHAAR Number" required data-validation-required-message="Provide any Mobile or Aadhaar no.">
							...
							<div class="row mt-5">
							  <div class="col-md-12 text-center">
								...
								<a href="<?php echo base_url('administrator/fig/figrepresentativelist');?>" class="btn-fs btn btn-outline-dark mt-10"><i class="fa fa-close" aria-hidden="true"></i>  Cancel</a>	
							  </div>
						    </div>
		...
		//console.log(responseArray.popi_list);
		 if(responseArray.status == 1){
			...
			$.each(responseArray.popi_list,function(key,value){
			 popilist += '<option value='+value.user_id+'>'+value.institution_name+'</option>';
			});
	...
	{   
		 $.ajax({
			...
			console.log(response);
				...
				$("#fpo_list").append($('<option></option>').val(value.user_id).html(value.producer_organisation_name));
				});
				}
			},
