                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('administrator/fig/figrepresentativelist');?>">List FIG Representative</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
               <div class="container">
				...
				<a href="<?php echo base_url('administrator/fig/addfigrepresent');?>">
...
<script type="text/javascript">
 $(document).ready(function() {       
        //FIG list API CALL
     $.ajax({
		url:"<?php echo base_url();?>administrator/fig/figrepresentlist",
		type:"GET",
		data:"",
		dataType:"html",
		cache:false,
		...
		if(responseArray.status == 1){
			...
			figrepresent += '<tr><td>'+value.FIG_Name+'</td><td>'+member_name+'</td><td>'+representative_type+'</td><td>'+value.appointment_date+'</td><td><a href="<?php echo base_url("administrator/fig/viewfigrepresent/'+value.id+'");?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a><a href="<?php echo base_url("administrator/fig/viewfigrepresent/'+value.id+'");?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a></td></tr>';
			});
