								    ...
								    <div class="container-fluid">
                                        ...
                                        <div class="row row-space">                                            
                                                    ...
                                                    <div class="col-md-4">
                                                      <div class="form-check-inline form-check">
                                                        <label for="inline-radio1" class="form-check-label">
                                                          <input type="radio" id="member_type" name="member_type" value="1" class="form-check-input"><span class="ml-1">Person</span>
                                                        </label>
                                                      </div> 
                                                    </div>
                                                    <div class="col-md-8">
                                                      <div class="form-check-inline form-check">
                                                        <label for="inline-radio2" class="form-check-label">
                                                          <input type="radio" id="member_type" name="member_type" value="2" class="form-check-input"><span class="ml-1">Producer Organization</span>
                                                        </label>
                                                       </div>
                                                    </div>			
                                                  </div>
                                            ...
                                            <div class="col-md-6" id="member_search" style="display: none;">
                                                ...
                                                <input type="text" id="holder_id" name="holder_id" value="">
                                                <input type="text" id="fpo_id" name="fpo_id" value="">
                                                <input type="text" class="form-control numberOnly" id="search_allotment" maxlength="10" minlength="10" name="search_allotment" placeholder="Search with Mobile or Aadhaar" data-validation-required-message="Provide the search text or choose the member" value="">
                                        ...
                                        <hr style="border-bottom:1px solid black;">
                                            ...
                                            <div class="row row-space">
												<div class="form-group col-md-6">
													...
													<select class="form-control" id="fig_name1" name="fig_name1">
                                        ...
                                        <div class="farmer_to_member_form" id="farmer_to_member_form" style="display: none;">                                                                                                                               
                                            <div class="row row-space">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control numberOnly" maxlength="3" name="person_no_of_share" id="person_no_of_share" placeholder="No. of Shares">
                                                    <div class="help-block with-errors text-danger"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-space">												
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control numberOnly" maxlength="12" name="person_aadhaar_no" id="person_aadhaar_no" placeholder="Aadhaar Number" readonly>
                                                </div>
                                            </div>                                                   
                                        </div>
...
<!--                                        <hr style="border-bottom:1px solid black;">-->
                                        ...
                                        <div class="row row-space">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="date" class="form-control" id="fpo_date" name="fpo_date" placeholder="Date" max="2050-12-31" data-validation-required-message="provide the date">
                                                <div class="help-block with-errors text-danger"></div>
											</div>
                                        </div>   
										...
										<div class="row row-space">
												<div class="form-group col-md-4">
													...
													<input type="text" class="form-control numberOnly" onkeyup="getPincode(this.value)" pattern="[1-9][0-9]{5}" title="Enter only 6 digits" id="pin_code" name="pin_code" placeholder="PINCODE" data-validation-required-message="Please enter pin code">
													<p class="help-block text-danger"></p>
												</div>
												<div class="form-group col-md-4">
										...
										<div class="row row-space">											
											...
											<div class="form-group col-md-4">
												...
												<select class="form-control" id="gram_panchayat" name="gram_panchayat" data-validation-required-message="Please select gram panchayat" onchange="getVillageList(this.value);">
										...
										<div class="row row-space">
								            <div class="form-group col-md-4">
												...
												<select class="form-control" id="village" name="village" data-validation-required-message="Please select village">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" maxlength="75" id="street_name" name="street_name" placeholder="Street">
                                            </div>
								        </div>
								        ...
								        <div class="row row-space">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control numberOnly" minlength="10" maxlength="10" name="mobile_number" pattern="^[6-9]\d{9}$" onfocusout="verifyMobileNumber(this.value)" id="mobile_number" placeholder="Mobile Number" data-validation-required-message="Enter mobile number">
                                                <div class="help-block with-errors text-danger"></div>
                                            </div>
								            <div class="form-group col-md-2">
                                                <label class="form-control-label">No. of Shares <span class="text-danger">*</span></label>
											...
											<div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="contact_person" name="contact_person" maxlength="25" placeholder="Contact Person" data-validation-required-message="Enter contact number">
                                                <div class="help-block with-errors text-danger"></div>
                                            </div>
								        </div>
                                        ...
                                        <div class="row row-space">
                                            <div class="form-group col-md-4">
												...
												<input type="text" class="form-control" maxlength="10" id="pan_number" name="pan_number" placeholder="Ex:AAAAA0000A" data-validation-required-message="Enter the PAN Number">
								            </div>                                        
                                        </div>
                                        </div>
										...
										<div class="form-row mt-5">
								            <div class="form-group col-md-12 text-center">
											  <div id="success"></div>
								                <input id="sendMessageButton" value="Add as member" class="btn btn-success text-center" type="submit">
												<a href="<?php echo base_url('administrator/member');?>" class="btn btn-outline-dark">Cancel</a>	
											 </div>											 
								        </div>
    ...
    if(pin_code.length == 6) {
        $.ajax({
			...
			success:function(response) {
                ...
                var village = '';var state = '';var district = '';var block ='';var taluk ='';
