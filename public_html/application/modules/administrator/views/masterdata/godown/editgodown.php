								...
								<div class="card">
											...
											<div class="col-md-6">
											  <div class="form-check-inline form-check" <?php echo $godown_info['owner_type']==1?'':'style="display:none;"';?>>
												<label for="inline-radio1" class="form-check-label">
												  <input type="radio" id="owner_type" name="owner_type" readonly  value="1" disabled required="required"  class="form-check-input"><span class="ml-1">Farmer</span>
												</label>
											  </div> 
											</div>
											<div class="col-md-6">
											  <div class="form-check-inline form-check" <?php echo $godown_info['owner_type']==2?'':'style="display:none;"';?>>
												<label for="inline-radio2" class="form-check-label">
												  <input type="radio" id="owner_type" name="owner_type" readonly  value="2" disabled required="required"  class="form-check-input"><span class="ml-1">FPO</span>
												</label>
											   </div>
											</div>			
										  </div>
									...
									<div class="row row-space">
										...
										<div class="form-group col-md-4">
											...
											<input type="text" onkeyup="getPincode(this.value)" disabled  readonly  value="<?php echo $godown_info['pincode']?>" class="form-control this_pin_code numberOnly" id="pincode" pattern="[1-9][0-9]{5}" name="pincode" minlength="6" maxlength="6" placeholder="PINCODE" required="required" data-validation-required-message="Please enter pincode."disabled>						
										...
										<div class="form-group col-md-4">
											...
											<select id="taluk" name="taluk" disabled class="form-control sel_taluk" required="required"  data-validation-required-message="Please Select taluk.">
										...
										<div class="form-group col-md-4">
											...
											<select id="block" name="block" disabled class="form-control sel_block" required="required"   data-validation-required-message="Please Select block.">
										...
										<div class="form-group col-md-4">
											...
											<select id="gram_panchayat" name="gram_panchayat"  disabled class="form-control sel_panchayat" required="required" data-validation-required-message="Please Select gram panchayat." >
										...
										<div class="form-group col-md-4">
											...
											<select id="village" name="village" class="form-control sel_village" disabled  required="required" data-validation-required-message="Please Select village.">
