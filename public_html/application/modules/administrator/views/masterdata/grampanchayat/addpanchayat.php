      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add Gram Panchayat</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('administrator/masterdata/post_panchayat')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                 ...
                                 <div class="row row-space">
                                    <div class="form-group col-md-6">
                                       ...
                                       <input type="text" class="form-control "  id="gram_panchayat_name" name="gram_panchayat_name" placeholder="Block Name In English"  required="required" data-validation-required-message="Please enter gram panchayat name.">
                                       <p class="help-block text-danger"></p>
                                    </div>	
                                    <div class="form-group col-md-6">						    
                                       <label for="inputAddress2">Gram Panchayat Name (In Local Language) <span class="text-danger">*</span></label>
                                       <input type="text" class="form-control "  id="gram_panchayat_name_local" name="gram_panchayat_name_local" placeholder="Block Name In Local Language"  required="required" data-validation-required-message="Please enter gram panchayat name in local language.">
                                       <p class="help-block text-danger"></p>
                                    </div>		
                                 </div>	
                                 <div class="form-row">
                                    ...
                                    <a href="<?php echo base_url('administrator/masterdata/grampanchayatlist');?>" class="btn btn-outline-dark">Cancel</a>	
                                    </div>											 
											</div>
                                 </div>
										</div>
				...
				if(state) { 
					$.ajax({
                        ...
                        //console.log(value.id);						   
								div_data +="<option value="+value.district_code+">"+value.name+"</option>";
