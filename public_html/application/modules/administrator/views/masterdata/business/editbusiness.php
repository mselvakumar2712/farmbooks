      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('administrator/masterdata/natureofbusinesslist');?>">Nature of Business</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('administrator/masterdata/updatebusiness/'.$business_info['id'])?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >
										...
										<div class="container-fluid">
										  <div class="row row-space">
												<div class="form-group col-md-6">
													...
													<select  class="form-control" id="business_type" name="business_type" required="required" data-validation-required-message="Please Select business type." disabled>
										 ...
										 <div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('administrator/masterdata/natureofbusinesslist');?>" id="ok" class="btn btn-outline-dark">Back</a>
											<a href="<?php echo base_url('administrator/masterdata/natureofbusinesslist');?>" id="cancel" class="btn btn-outline-dark" style="display:none;">Cancel</a>
											</div>
										  </div>
										</div>
									</div>
				...
				swal({
				 ...
				 if (result.value) {          
					...
					$.ajax({
					  ...
					  success: function() {        
						 setTimeout(function() {
						  window.location.replace("<?php echo base_url('administrator/masterdata/natureofbusinesslist')?>");
						 }, 1000);
					  },
					  error: function() {
