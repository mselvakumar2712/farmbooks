      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('administrator/masterdata/post_taluk')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control "  id="taluk_name" name="taluk_name" placeholder="Taluk Name In English"  required="required" data-validation-required-message="Please enter taluk name.">
                                    <p class="help-block text-danger"></p>
                                 </div>
											<div class="form-group col-md-6">						    
												<label for="inputAddress2">Taluk Name (In Local Language)  <span class="text-danger">*</span></label>
												<input type="text" class="form-control "  id="taluk_name_local" name="taluk_name_local" placeholder="Taluk Name In Local Language"  required="required" data-validation-required-message="Please enter taluk name in local language.">
												<p class="help-block text-danger"></p>
											</div>		
										</div>	
										 <div class="form-row">
											  ...
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('administrator/masterdata/taluklist');?>" class="btn btn-outline-dark">Cancel</a>	
											  </div>
