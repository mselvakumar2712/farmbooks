      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('administrator/masterdata/post_block')?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="row row-space">
											<div class="form-group col-md-6">
												...
												<input type="text" class="form-control "  id="block_name" name="block_name" placeholder="Block Name In English"  required="required" data-validation-required-message="Please enter block name.">
												<p class="help-block text-danger"></p>
											</div>
											<div class="form-group col-md-6">						    
												<label for="inputAddress2">Block Name (In Local Language)  <span class="text-danger">*</span></label>
												<input type="text" class="form-control "  id="block_name_local" name="block_name_local" placeholder="Block Name In Local Language"  required="required" data-validation-required-message="Please enter block name in local language.">
												<p class="help-block text-danger"></p>
											</div>	
										</div>	
										 <div class="form-row">
											  ...
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('administrator/masterdata/blocklist');?>" class="btn btn-outline-dark">Cancel</a>	
											  </div>
