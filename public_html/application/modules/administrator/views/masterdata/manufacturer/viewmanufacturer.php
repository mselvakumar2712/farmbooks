									...
									<div class="card-body">
											...
											<div class="row row-space  mt-4">                                 							
												...
												<div class="form-group col-md-6">
													...
													<input class="form-control" id="name" value="<?php echo $manufacturer_info['name']?>" name="name"   placeholder="Manufacturer Name" required="required"  data-validation-required-message="Please enter manufacturer name ."disabled>				
													<p class="help-block text-danger"></p>
											    </div>
												<div class="form-group col-md-3"></div>
											</div>											
											<div class="col-md-12 text-center">
											<a href="<?php echo base_url('administrator/masterdata/editmanufacturer/'. $manufacturer_info['id']);?>" id="edit" class="btn btn-success text-center"><i class="fa fa-edit"></i> Edit<a>
											...
											<a href="<?php echo base_url('administrator/masterdata/manufacturerlist');?>" id="ok" class="btn btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
											<a href="<?php echo base_url('administrator/masterdata/manufacturerlist');?>" id="cancel" class="btn btn-outline-dark" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
											</div>
										  </div>
										</div>
									</div>
