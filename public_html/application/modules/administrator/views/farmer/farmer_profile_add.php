							...
							<div class="form-group col-md-12 mt-1">
								...
								<div class="form-group col-md-12 mt-1">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control" id="farmer_dob" name="farmer_dob" placeholder="Date of Birth" required="required" data-validation-required-message="Please enter date of birth." min="<?php echo date("Y-m-d",strtotime("-100 year")); ?>" max="<?php echo date("Y-m-d",strtotime("-10 year")); ?>">
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                    <div class="form-group col-md-3">
							 ...
							 <div id="form-step-1" role="form" data-toggle="validator">
								  <div class="form-group col-md-12 mt-2">
									...
									<div class="form-group col-md-6">
									  ...
									  <select id="inputState" class="form-control" id="farmer_land_holdings" name="farmer_land_holdings" required data-validation-required-message="Please select land holdings.">
								...
								<div id="div3" style="display:none;">
						           ...
						           <div class="form-group col-md-12 mb-0" id="land_holdings2_0">					              <div class="form-group col-md-6">
									...
									<div class="form-group col-md-4">
										<label for="inputAddress2">State <span class="text-danger">*</span></label>
										<select  class="form-control" id="wetland_state" name="wetland_state" readonly placeholder="District">
											<option value="">Select State </option>
										</select>
										<div class="help-block with-errors text-danger"></div>
									</div>
...
function getLiveStockType(value) {
        $.ajax({
			url:"<?php echo base_url();?>administrator/farmer/getLiveStocks/"+value,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,
...
$('select[id="live_stocks_type"]').on('change', function() {
    ...
    $.ajax({
			url:"<?php echo base_url();?>administrator/farmer/getLiveStocks/"+live_stocks_type,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,
...
$('select[id="live_stocks_name"]').on('change', function() {
    ...
    $.ajax({
			url:"<?php echo base_url();?>administrator/farmer/getLiveStockVariety/"+live_stocks_name,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,
...
function loadFarmImplementsName() {
    $.ajax({
      url:"<?php echo base_url();?>administrator/farmer/getFarmImplements",
		type:"GET",
		data:"",
		dataType:"html",
      cache:false,
...
function loadFarmImplementsMakeAndModel(name_value) {
    $.ajax({
        url:"<?php echo base_url();?>administrator/farmer/getFarmImplementsMakeAndModel/"+name_value,
		type:"GET",
		data:"",
		dataType:"html",
        cache:false,
...
$("#farmerNoMobile").change(function(event){
    if(this.checked){
        ...
        var randomCode = Math.floor(2000000000 + (Math.random() * 23456));
