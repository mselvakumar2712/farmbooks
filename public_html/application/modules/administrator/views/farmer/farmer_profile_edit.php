                ...
                <div class="col-md-12">
                    <div class="card">					
                        <div class="card-body">	
                            ...
                            <?php }?>
							<form action="<?php echo base_url('administrator/farmer/updateFarmer/'.$farmer_list[0]->id); ?>" id="farmer_profileForm" name="farmer_profileForm" method="post" enctype="multipart/form-data" >
						...
						<div class="col-md-12" style="text-align:right;margin-bottom:20px;">
                            ...
                            <div class="col-md-8">
                                <div class="land_detail_button" style="">
                                    <a href="<?php echo base_url('administrator/farmer/addland?id='.$farmer_list[0]->id);?>">
                                ...
                                <div class="farm_implement_button" style=";">
                                    <a href="<?php echo base_url('administrator/farmer/add_farmimplement?id='.$farmer_list[0]->id);?>">
                                        <button type="button" class="btn btn-success btn-labeled">
                                ...
                                <div class="live_stock_button" style="">
                                    <a href="<?php echo base_url('administrator/farmer/addlivestock?id='.$farmer_list[0]->id);?>">
                                        <button type="button" class="btn btn-success btn-labeled">
                        ...
                        <div id="step-1">
                            <input type="hidden" name="id" value="<?php echo $farmer_list[0]->id; ?>" id="id">
								...
								<div id="success"></div>
									...
									<a href="<?php echo base_url('administrator/farmer/profilelist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>	
								</div>
						       </form>
						     </div>
					      </div>
			...
			$('a.del').click(function(){
                ...
                swal({
                 ...
                 if (result.value) {          
                    ...
                    $.ajax({
                      url: "<?php echo base_url();?>administrator/farmer/deleteFarmer/"+farmer_id,
                      type: "POST",
                      data: {
                      ...
                      success: function() {        
                         setTimeout(function() {
                          window.location.replace("<?php echo base_url('administrator/farmer/profilelist')?>");
                         }, 1000);
                      },
                      error: function() {
