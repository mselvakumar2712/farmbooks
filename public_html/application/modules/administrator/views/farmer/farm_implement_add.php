						   ...
						   <div id="form-step-2" role="form" data-toggle="validator">
								...
								<div class="form-group col-md-12 mt-2">
                                 ...
                                 <div class="form-group col-md-12 text-center">											         <button id="sendMessageButton" class="btn btn-fs btn-success text-center" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
									<a href="<?php echo base_url('administrator/farmer/farmimplementlist');?>" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
				                </div>
						       </form>
						     </div>
					      </div>
...
$('form').submit(function(e){
        ...
        $.ajax({
			url:"<?php echo base_url();?>administrator/farmer/postFarmImplement",
			type:"POST",
			data:farmerdata,
			dataType:"html",
            cache:false,			
...
function updateFarmerByFarmerID(farmer_id) {
    $.ajax({
	    url:"<?php echo base_url();?>administrator/farmer/existedFarmerName/"+farmer_id,
        type:"GET",
		data:"",
		dataType:"html",
        cache:false,			
