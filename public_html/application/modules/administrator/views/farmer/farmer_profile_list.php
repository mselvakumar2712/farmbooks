                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('administrator/farmer/profilelist');?>">Farmer Profile </a></li>
                        </ol>
                    </div>
                </div>
            </div>
                           ...
                           <div class="container">
                               ...
                               <div class="row">
								<div class="form-group col-md-3">
									...
									<select class="form-control" id="search_state" name="search_state">
                               ...
                               <div class="row">
                                   <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-2 mt-4">
                                        <button align="center" name="searchSubmit" id="searchSubmit" class="btn mt-1 btn-fs btn-success text-center" type="button" style="padding: .375rem .25rem;"><i class="fa fa-search fa-1x" aria-hidden="true"></i> &nbsp;&nbsp;Search</button>
                                    </div>

                                    <div class="form-group col-md-6 mt-4" style="text-align:right;" >
                                        <a href="<?php echo base_url('administrator/farmer/addfarmer');?>">
...
$(document).ready(function(){
			$.ajax({
				url: "<?php echo base_url();?>administrator/farmer",
				type: "POST",
				dataType:"html",
				cache:false,			
                ...
                if(responseArray.farmer_list.length != 0) {
                    $.each(responseArray.farmer_list,function(key,value){
                        ...
                        farmer_list += '<tr><td>'+value.profile_name+'</td><td>'+dateFormat+' / '+value.age+'</td><td>'+value.mobile+'</td><td><?php if('+value.aadhar_no+'){echo 'Active';}else{echo 'In Active';}?></td><td><a href="<?php echo base_url("administrator/farmer/editfarmer/'+value.id+'");?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a><a href="<?php echo base_url("administrator/farmer/viewfarmer/'+value.id+'");?>" class="btn btn-warning btn-sm ml-1" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a></td></tr>';
                    });
                } else {
...
function getBlockByDistrict(districtCode){
    $.ajax({
			url:"<?php echo base_url();?>administrator/farmer/getBlocksByDistrict/"+districtCode,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,			
...
function loadFarmers(stateCode, districtCode, blockCode, panchayatCode, villageCode) {
    if(stateCode != "" && districtCode != "" && blockCode != "") {
        ...
        $.ajax({
				url:"<?php echo base_url();?>administrator/farmer/farmersByLocation",
				type:"POST",
                data:formedCode,
				dataType:"html",
				cache:false,			
