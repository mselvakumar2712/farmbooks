              		...
              		<div id="step-1">
							...
							<div class="form-group col-md-12 mt-1">
								...
								<div class="form-group col-md-4">
									...
									<select  class="form-control" id="farmer_village" name="farmer_village" data-validation-required-message="Please select village.">
							...
							<div id="step-2" >
							 <div id="form-step-1" role="form" data-toggle="validator">
                                ...
                                <div id="div5" style="display:none;">
									...
									<div class="form-group col-md-4">
										<label for="inputAddress2">Village </label>
										<select id="both_village" name="both_village" class="form-control" data-validation-required-message="Please select village">
										<option value="">Select Village</option>
										</select>
										<div class="help-block with-errors text-danger"></div>
									</div>						
