                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('administrator/Finance/taxgroup');?>">Tax Groups</a></li>
								...
								<div class="container">
									...
									<table class="table table-bordered">
										...
										<div class="form-group col-md-6">
										 ...
										 <div class="form-group col-md-6">
											<label for="inputAddress2">Tax applied to Shipping</label>
											<select id="tax_shipping" name="tax_shipping" class="form-control" >
											<option value="">Select Tax applied to Shipping</option>
									...
									<div class="row">
										<div class="col-md-12">
										  <p class="text-danger text-center">Select the taxes that are included in this group.</p>
										 </div>
									 </div>
									 <div class="row">
									 <div class="col-md-4">&nbsp;
