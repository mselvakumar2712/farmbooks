                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="#">List Share Applications</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">	
                           <div class="container">
							...
							<tbody id="memberlist">
                                ...
                                <td><?php echo ($share_applications[$i]->status == 1)? "Processed":"Allotted"; ?></td>
                                <td>
                                    <a href="<?php echo base_url('administrator/share/viewshareapplication/' . $share_applications[$i]->id); ?>" class="btn btn-success btn-sm" title="Edit">
