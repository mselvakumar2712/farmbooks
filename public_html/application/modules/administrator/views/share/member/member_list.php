                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('administrator/member');?>">List Member</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">	
                           <div class="container">
										<div class="" style="text-align:right;margin-bottom:20px;" >
											<a href="<?php echo base_url('administrator/member/addmember');?>">
                            ...
                            <?php for($i=0;$i<count($members);$i++){ ?>
                                ...
                                <td><?php if($members[$i]->member_type == 1){ 
										$str=substr_replace($members[$i]->aadhar_no, str_repeat("X", 8),0, 8);
										echo wordwrap($str , 4 , ' ' , true );
										}else{
											echo "";}?></td>
