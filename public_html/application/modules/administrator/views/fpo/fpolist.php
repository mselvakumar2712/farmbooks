						  ...
						  <table id="example" class="table table-striped table-bordered">
							...
							<?php foreach($fpo_info as $row): ?>
									<tr> 							
										...
										?></td>																			 
										<td >
										<a href="<?php echo base_url('administrator/fpo/viewfpo/' . $row->id); ?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
                              <a href="<?php echo base_url('administrator/fpo/viewfpo/' . $row->id); ?>"  class="btn btn-warning btn-sm mt-2" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
										</td>							
									</tr>
								<?php endforeach; ?>
							</tbody>
