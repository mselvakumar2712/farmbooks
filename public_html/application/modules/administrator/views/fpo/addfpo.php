				  ...
				  <div class="breadcrumbs">
					...
					<div class="content mt-3">
						<div class="animated fadeIn">
							<div class="card">
								<div class="card-body">
									<form action="<?php echo base_url('administrator/fpo/postfpo')?>" method="post" role="form" novalidate="novalidate" data-toggle="validator"  id="fpo_addForm" name="sentMessage"  accept-charset="utf-8">
													...
													<div id="form-step-0" class="form-horizontal" role="form" data-toggle="validator">
															...
															<div class="form-group col-md-12 mt-1">
																...
																<div class="form-group col-md-4">
																		...
																		<input type="text" class="form-control numberOnly this_pin_code" onkeyup="getPincode(this.value)" maxlength="6" pattern="[1-9][0-9]{5}" id="pin_code" name="pin_code" placeholder="PINCODE" required="required" data-validation-required-message="Please enter pin code.">
															...
															<div class="form-group col-md-12 mt-1">
																...
																<div class="form-group col-md-4">
																		...
																		<select class="form-control sel_taluk" name="taluk_id" id="taluk_id" required="required"  data-validation-required-message="Please Select Taluk .">
																...
																<div class="form-group col-md-4">
																		...
																		<select id="block" class="form-control sel_block" name="block" onchange="getPanchayatList(this.value);" required="required"  data-validation-required-message="Please Select Block .">
															...
															<div class="form-group col-md-12 mt-1">
																<div class="form-group col-md-4">						    
																		...
																		<select id="gram_panchayat" class="form-control sel_panchayat" id="gram_panchayat" name="gram_panchayat" required="required" onchange="getVillageList(this.value);" data-validation-required-message="Please Select gram panchayat .">
															...
															<div class="form-group col-md-12 mt-1">
																...
																<div class="form-group col-md-4">
																	...
																	<input type="text" class="form-control numberOnly" pattern="^[0][0-9]{2,8}$" id="std_code" maxlength="8" minlength="3" name="std_code" title="Landline number starts with '0'" placeholder="Ex:012">
																	<div class="help-block with-errors text-danger"></div>
																</div>
																<div class="form-group col-md-4">
												...
												<div  id="step-2">
													<div id="form-step-1" class="form-horizontal" role="form" data-toggle="validator">								
														...
														<div id="success"></div>
															...
															<a href="<?php echo base_url('administrator/fpo');?>" id="" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
														</div>
												</div>
											</div>													           
										</div>	
