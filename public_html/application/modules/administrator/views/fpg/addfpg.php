      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  name="sentMessage" id="fpg_form" novalidate="novalidate" action="">
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                        ...
                                        <div class="row row-space">
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control numberOnly this_pin_code" onkeyup="getPincode(this.value)" pattern="[1-9][0-9]{5}" title="please enter only 6 numbers" maxlength="6" id="pin_code" name="pin_code" placeholder="PINCODE" required="required"  data-validation-required-message="Please enter pin code.">
										...
										<div class="row row-space">
										 ...
										 <div class="row row-space">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" class="form-control" maxlength="50" id="interest_group" name="interest_group" minlength="3" maxlength="50" placeholder="Name of the Farmer Producer Group" required="required"  data-validation-required-message="Please enter name of the farmer producer group.">
													<p class="help-block text-danger"></p>
												</div>
										 </div>
										 <div class="row row-space">
											  ...
											  <div class="form-group col-md-12 text-center">
												...
												<a href="<?php echo base_url('administrator/fpg');?>" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
											 </div>
...
$('form').submit(function(e){
	e.preventDefault();
	const fpgdata = $('#fpg_form').serializeObject();
	if(fpgdata !='')
	{
	console.log(fpgdata);
		  $.ajax({
			url:"<?php echo base_url();?>administrator/fpg/postfpg",
			type:"POST",
			data:fpgdata,
			dataType:"html",
            cache:false,			
	...
	console.log(responseArray.fpo_list);
	 if(responseArray.status == 1){
		...
		$.each(responseArray.fpo_list,function(key,value){
		 fpg_list += '<option value='+value.user_id+'>'+value.producer_organisation_name+'</option>';
		});
