                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('administrator/inventory/directgrnlist');?>">Direct GRN</a></li>
                            <li class="active">Direct GRN Entry</li>
                        </ol>
                    </div>
                </div>
            </div>
										...
										<div class="container-fluid">
											...
											<div class="table-responsive">  
												<table class="table table-bordered" id="dynamic_field">
													...
													<tr>  
														...
														<td width="20%"><select  class="form-control" id="unit"  name="unit[]" required="required" data-validation-required-message="Please select item unit.">
										 ...
										 <div class="form-row">
											  ...
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('administrator/inventory/directgrnlist');?>" class="btn btn-outline-dark">Cancel</a>	
											  </div>
