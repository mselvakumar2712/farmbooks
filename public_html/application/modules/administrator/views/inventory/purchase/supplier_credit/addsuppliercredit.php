            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Supplier Credit Notes Entry</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('administrator/inventory/suppliercreditlist');?>">Supplier Credit Notes</a></li>
                            <li class="active">Supplier Credit Notes Entry</li>
                        </ol>
                    </div>
                </div>
            </div>
										...
										<div class="container-fluid">
										  ...
										  <div class="row ">
											...
											<div class="row ">
												...
												<label for="inputAddress2">Receive Between</label>
												<input  class="form-control" type="date"   id="receive_from" name="receive_from">												
												</div>
												<div class="form-group col-md-3">
												<label for="inputAddress2">And</label>
												<input  class="form-control" type="date"   id="receive_from" name="receive_from">												
												</div>
												<div class="form-group col-md-1">
												<label for="inputAddress2"></label>
												<input id="sendMessageButton" value="Search" class="btn btn-success" type="submit">													
												</div>
												<div class="form-group col-md-2 mt-4">
												<label for="inputAddress2"></label>
												<input id="sendMessageButton" value="Add All Items" class="btn btn-success" type="submit">													
												</div>
												<div class="form-group col-md-1">											
												</div>
												</div>
											...
											<div class="table-responsive"> 
												<table class="table table-bordered">
													...
													<tbody>
													<tr>
														<td colspan="11" class="text-center" >There are no received items for the selected supplier that have been invoiced.<br>Credits can only be applied to invoiced items.</td>
													</tr>
													</tbody>
												...
												<table class="table table-bordered" id="dynamic_field">
													<thead>
														<tr >
														<td colspan="4" class="text-center">GL Items for this Invoice</td>
													...
													<tr class="total">
														<td colspan="5" class="text-right text-danger"> Credit Note Total</td>
														<td colspan="2"><input type="text numberOnly" name="amount_total" readonly class="form-control text-danger" value="0.00" /></td>
