					...
					<div class="page-header float-right">
						<div class="page-title">
							<ol class="breadcrumb text-right">
								...
								<li><a class="active" href="<?php echo base_url('administrator/inventory/suppliers');?>">Suppliers</a></li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div id="smartwizard">
									...
									<div id="form-step-0" class="form-horizontal" role="form" data-toggle="validator">
										...
										<div class="form-group col-md-4 ">
											...
											<input type="text" class="form-control" maxlength="50" id="supplier_name" name="supplier_name" placeholder="Supplier Name" required="required" data-validation-required-message="Please enter supplier name.">
											 <div class="help-block with-errors text-danger"></div>
										</div>
										<div class="form-group col-md-4 ">
											<label for="">Supplier Short Name<span class="text-danger">*</span></label>
											<input type="text" class="form-control" maxlength="20" id="supp_short_name" name="supp_short_name" placeholder="Supplier Short Name" required="required" data-validation-required-message="Please enter short name.">
											 <div class="help-block with-errors text-danger"></div>
										</div>
										<div class="form-group col-md-4">
										...
										<div class="form-group col-md-4">
											...
											<input type="text" class="form-control" id="website" name="website" maxlength="25" placeholder="Website">						
										</div>
										<div class="form-group col-md-4">
											<label for="inputAddress2">Tax Group</label>
											<select id="taxt_group" name="taxt_group" class="form-control" >
										...
										<div class="form-group col-md-4">
											<label for="inputAddress2">Tax Customer No</label>
											<input type="text" class="form-control" maxlength="30" name="tax_customer_no"  id="tax_customer_no" placeholder="Tax Customer No">
											<div  class="help-block with-errors text-danger"></div>
										</div>
										</div>
										<h4 class="text-center text-success">Purchasing</h1>
										<div class="form-group col-md-12 mt-4">										
										<div class="form-group col-md-3">
											<label for="inputAddress2">Bank Name/Account</label>
											<input type="text" class="form-control" minlength="9" maxlength="30" name="bank_name"  id="bank_name" placeholder="Bank Name/Account" >
										</div>
										<div class="form-group col-md-3">
											<label for="inputAddress2">Credit Limit</label>
											<input type="text" class="form-control numberOnly" minlength="2" maxlength="10" name="credit_limit"  id="credit_limit" placeholder="Credit Limit">
											 <div class="help-block with-errors text-danger"></div>
										</div>
										<div class="form-group col-md-3">
										...
										<div class="form-group col-md-3">
											<label for="inputAddress2">Prices contain tax included</label><br>
											<input type="checkbox" id="price_tax" name="price_tax" value="1" class="form-check-input ml-4" >
										</div>
										</div>
										<h4 class="text-center text-success">Accounts</h1>
										<div class="form-group col-md-12 mt-4">										
										<div class="form-group col-md-4">
											<label for="inputAddress2">Accounts Payable Account</label>
											<select id="accounts_payable" name="accounts_payable" class="form-control" >
											<option value="">Select Accounts Payable Account</option>	
											</select>	 
										</div>
										<div class="form-group col-md-4">
											<label for="inputAddress2">Purchase Account</label>
											<select id="purchase_account" name="purchase_account" class="form-control" >
											<option value="">Select Purchase Account</option>	
											</select>	 
										</div>
										<div class="form-group col-md-4">
											<label for="inputAddress2">Purchase Discount Account</label>
											<select id="purchase_discount_account" name="purchase_discount_account" class="form-control" >
											<option value="">Select Purchase Discount Account</option>	
											</select>	 
										</div>
										</div>
										<h4 class="text-center text-success">Contact Data</h1>
										<div class="form-group col-md-12 mt-4">	
