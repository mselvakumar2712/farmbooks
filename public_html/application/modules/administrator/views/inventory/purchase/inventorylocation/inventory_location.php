  ...
  <body>
									...
									<div class="card-body">
										<div class="container-fluid"> 
											...
											<div class="form-group col-md-4">
												...
												<div class="form-group col-md-4">
													<label for="inputAddress2">Transfer Type</label>
											...
											<div class="row ">
											<div class="form-group col-md-4">
													<label for="inputAddress2">To Location</label>
													<input  class="form-control" type="date"   id="to" name="to">		
												</div>
													<div class="form-group col-md-3">
													<label for="inputAddress2">Date</label>
													<input  class="form-control" type="date" id="date_adjust" name="date_adjust">		
													</div>
											</div>
											</div>
											<h4 class="text-center text-success">Items</h4>
											<div class="table-responsive mt-3">  
												<table class="table table-bordered" id="dynamic_field">
													...
													<tr>  
														...
														<td width="20%"><input type="text" name="qunatity[]"  class="form-control numberOnly  name_list" /><p class="help-block text-danger"></p></td>  
														<td width="20%"><p class=" text-center" >each</p></td> 
	...
	$(document).ready(function() {
		...
		$('#add').click(function(){  
           i++;
		   var html=$(".total").html();
           $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added" ><td><input type="text" name="item_code" class ="form-control name_list"/><p class="help-block text-danger"></p></td> <td><select  class="form-control" id="item_description"  name="item_description[]" required="required" data-validation-required-message="Please Select item description."><option value="">Item Description </option><option value="1">Pesticides</option><option value="2">Nutrients</option></select></td><td><input type="text" name="quantity[]"  class="form-control numberOnly  name_list" required="" /><p class="help-block text-danger"></p></td>  <td><p class="text-center">each</p></td> <td><p class="text-center"><i class="fa fa-edit"></i></p></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
		});
