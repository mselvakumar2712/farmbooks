       ...
       <div class="breadcrumbs">
        ...
        <div class="content mt-3">	
            ...
            <div class="animated fadeIn">
			  <form  action="<?php echo base_url('administrator/inventory/getstockmovement')?>" method="post"  id="figform" name="sentMessage" novalidate="novalidate" >
				<div class="container">
				<div class="row ">
                    ...
                    <div class="card">
						<div class="card-body">
						  <table id="example" class="table table-striped table-bordered" width="100%">
							...
							<td><?php echo $row->purchase+$row->sales;?></td>
							</tr>
							<?php endforeach; ?>
							<?php } ?>
							</tbody>
