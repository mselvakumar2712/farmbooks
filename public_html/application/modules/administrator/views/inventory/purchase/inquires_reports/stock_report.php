       ...
       <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="#">List Stock Reports </a></li>
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
			  <form  action="<?php echo base_url('administrator/inventory/getstockreport')?>" method="post"  id="figform" name="sentMessage" novalidate="novalidate" >
				<div class="container">
				<div class="row ">
                    ...
                    <div class="card">
						<div class="card-body">
						  <table id="example" class="table table-striped table-bordered" width="100%">
							...
							<td><?php $total=($row->purchase+$row->sales);
							if( $total < 0){
                     echo $total;}
						  ?></td>
							</tr>
