                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('administrator/inventory');?>">Purchase Order</a></li>
										...
										<div class="container-fluid">
										  ...
										  <div class="row ">
											...
											<div class="row ">
												<div class="form-group col-md-4">
													...
													<input  class="form-control" type="date"  value="<?php echo date('Y-m-j'); ?>"  id="order_date" name="order_date" required="required"  data-validation-required-message="Please select order date.">
													<p class="help-block text-danger"></p>
												</div>	
												<div class="form-group col-md-4">
											...
											<div class="table-responsive">  
												<table class="table table-bordered" id="dynamic_field">
													...
													<tr>  
														...
														<p class="help-block text-danger"></p></td>  
														<td width="5%"><input type="date" name="delivery_date[]"  class="form-control name_list" required="required" /><p class="help-block text-danger"></p></td>  
										 ...
										 <div class="form-row">
											  ...
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('administrator/inventory/purchaseorderlist');?>" class="btn btn-outline-dark">Back</a>	
											  </div>
