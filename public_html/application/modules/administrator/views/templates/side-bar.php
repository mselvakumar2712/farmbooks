      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?php echo base_url('administrator/dashboard');?>"><img class="img-fluid" src="<?php echo asset_url()?>img/logo-mobile.png" style="margin:auto; max-height:60px;" alt="FPO"></a>
               <a class="navbar-brand hidden" href="./"><img class="img-fluid" src="<?php echo asset_url()?>img/logo-mobile.png" style="margin:auto; max-height:30px;" alt="FPO"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">		
                ...
                }else if($page_module=='tax'){
				      $this->load->view('tax-side-bar.php');
                }?>														 
            </div><!-- /.navbar-collapse -->
         </nav>
      </aside><!-- /#left-panel -->
