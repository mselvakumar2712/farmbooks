                     ...
                     <div class="dropdown-menu grid">
                        <div class="container-fluid">
                           ...
                           <div class="row  bordered mt-2">
							  ...
							  <div class="col-4 text-center">
								 <a class="mt-3" href="<?php echo base_url('administrator/dashboard/active_module/tax');?>" style="width: 100%; margin: 0; float: none; text-align:center"><img src="<?php echo asset_url()?>img/icons/tax1.png" class="img-fluid">
