...
/** Post Crop harvest Functionality **/	
    ...
    // echo json_decode($this->input->post()); die();
...
/** Post Crop harvest end **/
   public function variety($farmer_id) {        
		$variety_list = $this->Crop_Model->cropvarietyDropdown($farmer_id);
	...
	//Expenses Module
	 public function expenseslist() {
        $data['page'] = 'Expenses';
		  ...
		  $data['page_module'] = 'crop'; 
		  $data['expenses_info'] = $this->Crop_Model->expensesList();//print_r($data['expenses_info']);
