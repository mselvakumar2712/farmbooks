...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/approver/saleslist');?>">List of Sales</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">					
                        ...
                        <th>Status</th>
                           ...
                           if($row->status==0) 
									...
									?></td>																			 
									<td>
								   <a href="<?php echo base_url('fpo/approver/viewsales/'.$row->voucher_no.'/'.$row->inv_no.'/'.$row->account_code); ?>" id="<?php echo $row->voucher_no.'/'.$row->inv_no.'/'.$row->account_code; ?>" data-toggle="modal" data-target="#SalesDetails" class="btn btn-warning btn-sm mt-1" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
    ...
    <div id="SalesDetails" class="modal text-center">
...
$(document).ready(function() {
    ...
    var id =$(this).attr("id");
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/salesstatus/"+id+"/1",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
        ...
        $('a.reject').click(function(){
         ...
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/salesstatus/"+id+"/2",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
