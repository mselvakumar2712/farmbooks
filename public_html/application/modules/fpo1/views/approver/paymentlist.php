...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/approver/paymentlist');?>">List of Payment</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <th>Status</th>
                          ...
                          <td>
                           ...
                           <td class="text-center">
                              <a href="<?php echo base_url('fpo/approver/viewpayment/'.$row->voucher_no); ?>" id="<?php echo $row->counter; ?>" data-toggle="modal" data-target="#PaymentDetails" class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a> 
   ...
   <div id="PaymentDetails" class="modal text-center">
...
$(document).ready(function() {
   ...
   var id =$(this).attr("id");
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/paymentstatus/"+id+"/1",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
        ...
        $('a.reject').click(function() {
         ...
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/paymentstatus/"+id+"/2",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
