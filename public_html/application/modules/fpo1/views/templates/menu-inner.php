<!-- Header-->
<?php
   $ecommerce_url = "http://easzapps.net/EaszBB/";
   if(!empty($_SESSION['auto_login_key'])) {
      $key = $_SESSION['auto_login_key'];
      if($_SERVER["HTTP_HOST"] == "localhost") {
         $ecommerce_url = $_SERVER["REQUEST_SCHEME"].'://'.$_SERVER["HTTP_HOST"].'/sundar/wordpress-502/auto-login/?key='.$key;
      }
      else if(stripos($_SERVER["REQUEST_URI"], 'EaszBB')) {
         $ecommerce_url = $_SERVER["REQUEST_SCHEME"].'://'.$_SERVER["HTTP_HOST"].'/EaszBB/auto-login/?key='.$key;
      }
      else if(stripos($_SERVER["REQUEST_URI"], 'EaszMarket')) {
         $ecommerce_url = $_SERVER["REQUEST_SCHEME"].'://'.$_SERVER["HTTP_HOST"].'/UAT/EaszMarket/auto-login?key='.$key;
      }
   }
?>
                     ...
                     <div id="grid" class="grid">
                        <div class="container-fluid">
                           <div class="row grid-wrepper-row">
                              ...
                              <div class="col-4 text-center">
                                 <a class="mt-2 text-center" href="<?php echo base_url('fpo/dashboard/active_module/master_data');?>"><img src="<?php echo asset_url()?>img/icons/master.png" class="img-fluid">
                              ...
                              <div class="col-4 text-center" >
                               ...
                               <div class="col-4 text-center">
								...
								<div class="col-4 text-center">
									<a class="mt-2" href="#"><img src="<?php echo asset_url(); ?>img/icons/production.png" class="img-fluid">
