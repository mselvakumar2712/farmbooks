     ...
     <div class="container-fluid pl-0 pr-0">
       ...
       <div class="breadcrumbs">
		...
		<div class="content mt-3">
			...
			<form  action="<?php echo base_url('fpo/finance/updatebankaccount/'.$bank_info[0]->id)?>" id="viewBankAccountForm" name="sentMessage" method="post" novalidate="novalidate" >
                  <div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
												...
												<div class="form-group col-md-12 text-center">
													<div class="form-group">
														...
														<input id="edit" value="Edit" class="btn btn-success text-center" type="button">
														  ...
														  <!--<a href="<?php //echo base_url('fpo/finance/bank_accounts');?>" id="ok" class="btn btn-outline-dark">Back</a>
														  <a href="<?php //echo base_url('fpo/finance/bank_accounts');?>" id="cancel" class="btn btn-outline-dark" style="display:none;">Cancel</a>
													</div>
												</div>
											</div>
									</div>-->
									...
									<div class="container-fluid">  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
												...
												<input class="form-control inputfilter" placeholder="0.00" readonly id="opening_balance" name="opening_balance" required data-validation-required-message="Enter the opening balance" minlength="2" maxlength="10" value="<?php echo number_format($bank_info[0]->opening_balance, 2); ?>">
												<p class="help-block text-danger"></p>
											</div>                                            
								        </div>
                                	<div class="col-md-12 text-center">
											<a href="<?php echo base_url('fpo/finance/bank_accounts');?>" id="back" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										  </div>      										
										</div>
								</div>
							</div>
...
$('a.del').click(function() {
		...
		swal({
         ...
         if (result.value) {          
            ...
            $.ajax({
              url: "<?php echo base_url();?>fpo/finance/deletebankaccount/"+bank_name_id,
              type: "POST",
              data: {
              ...
              success: function() {        
                 setTimeout(function() {
                  window.location.replace("<?php echo base_url('fpo/finance/bank_accounts')?>");
                 }, 1000);
              },
              error: function() {
                  setTimeout(function() {
