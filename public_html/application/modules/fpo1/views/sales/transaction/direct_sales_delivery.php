      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('fpo/market/directsalesdelivery');?>"class="active">Direct Sales Delivery</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
		   <?php if($this->session->flashdata('success')){ ?>
			...
			<form method="POST" action="<?php echo base_url('fpo/Market/postdirect_delivery')?>" id="" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">          
										  <div class="row ">
											...
											<div class="row">							
												<div class="form-group col-md-3">
													<label for="inputAddress2">Delivery Date </label>
													<input class="form-control" type="date" id="delivery_date" name="delivery_date" required="required" value="<?php echo date("Y-m-d");?>" data-validation-required-message="Please select delivery date.">
													<p class="help-block text-danger"></p>
												</div>		
												<div class="form-group col-md-3">
													<label for="inputAddress2">Reference</label>
													<input class="form-control" value="<?php echo uniqid('trv_DD_'.rand(0,10000)); ?>" id="ref" name="ref" placeholder="Reference" required="required" data-validation-required-message="Please enter reference." readonly>
													<p class="help-block text-danger"></p>
												</div>
												<!--<div class="form-group col-md-3">
											...
											<h4 class="text-center text-success">Delivery Note Items</h4>
											<div class="table-responsive mt-3">  
												<table class="table table-bordered" id="dynamic_field">
													...
													<tr>  
														<td width="20%">
                                                            <input type="text" name="item_code[]" id="item_code0" class="form-control numberOnly" readonly required="required" />
                                                        </td>  
														<td width="30%">
														...
														<td width="10%">
                                                            <input type="text" name="qty[]" id="qty0" maxlength="6" class="form-control numberOnly" required="required" />
                                                            <p class="help-block text-danger"></p>
                                                        </td>  
														...
														<td width="10%">
                                                            <input type="text" name="price[]" id="price0" class="form-control numberOnly" required="" maxlength="6" />
                                                            <p class="help-block text-danger"></p>
                                                        </td>  
														<td width="10%">
                                                            <input type="text" name="discount[]" id="discount0" maxlength="2" class="form-control numberOnly" required="" />
                                                            <p class="help-block text-danger"></p>
                                                        </td>  							
														<td width="20%">
                                                            <input type="text" name="line_total[]" id="line_total0" class="form-control numberOnly" readonly required="" />
                                                        </td>  
														<td width="20%">
													...
													<tr>
														...
														<td colspan="1"><input type="text" id="shipping_charge" name="shipping_charge" readonly class="form-control" value="0.00" /></td>
														<td></td>
													</tr>
													<tr>
														<td colspan="6" class="text-right">Sub Total</td>
														<td colspan="1"><input type="text" id="sub_total" name="sub_total"  readonly class="form-control" value="0.00" /></td>
														<td></td>
													</tr>
													<tr class="total">
														<td colspan="6" class="text-right">Amount Total</td>
														<td colspan="1">
                                                            <input type="text" id="amount_total" name="amount_total" readonly class="form-control" value="0.00" />
                                                        </td>
...
<script type="text/javascript">    
    ...
    $('#dynamic_field').on('focusout', 'tr input[name="discount[]"]', function () {
