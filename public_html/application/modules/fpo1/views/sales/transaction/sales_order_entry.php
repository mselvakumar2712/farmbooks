                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('fpo/Market/salesorderentry');?>"class="active">Sales Order Entry</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
		   <?php if($this->session->flashdata('success')){ ?>
            ...
            <div class="animated fadeIn">
			    <form method="POST" action="<?php echo base_url('fpo/Market/postsales_order')?>" id="so_entry_form" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										   ...
										   <div class="row">
											...
											<div class="row">												
												...
												<div class="form-group col-md-3">
													...
													<input class="form-control" value="<?php echo uniqid('trv_So_'.rand(0,10000)); ?>" id="ref" name="ref" placeholder="Reference" required="required" data-validation-required-message="Please enter reference." readonly>
													<p class="help-block text-danger"></p>
												</div>		
											</div>
											...
											<div class="table-responsive mt-3">  
												<table class="table table-bordered" id="dynamic_field">
													...
													<tr>  
														<td width="20%">
                                                            <input type="text" name="item_code[]" id="item_code0" readonly class="form-control numberOnly" required="required" />
                                                        </td>  
														<td width="30%">
														...
														<td width="10%">
                                                            <input type="text" name="qty[]" id="qty0" class="form-control numberOnly" maxlength="6" required="required" />
                                                            <p class="help-block text-danger"></p>
                                                        </td>  
														...
														<td width="10%">
                                                            <input type="text" name="discount[]" id="discount0" class="form-control numberOnly" maxlength="2" required="" />
                                                            <p class="help-block text-danger"></p>
                                                        </td>  							
														<td width="20%">
