      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
		   <?php if($this->session->flashdata('success')){ ?>
			...
			<form  method="POST" action="<?php echo base_url('fpo/Market/postdirect_delivery')?>" id="figform" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										  ...
										  <div class="row ">
											...
											<div class="row ">																								
												...
												<div class="form-group col-md-3">
													...
													<input  class="form-control" value="<?php echo uniqid('trv_DD_'.rand(0,10000)); ?>"  id="ref" name="ref" placeholder="Reference" required="required"  data-validation-required-message="Please enter reference.">
													<p class="help-block text-danger"></p>
												</div>
												<!--<div class="form-group col-md-3">
											...
											<div class="table-responsive mt-3">  
												<table class="table table-bordered" id="dynamic_field">
													...
													<tbody>
													<tr>  
														<td width="20%"><input type="text" name="item_code[]" id="item_code0" class="form-control  name_list numberOnly" readonly required="required"  /></td>  
														...
														<td width="10%"><input type="text" name="discount[]" id="discount0" maxlength="2" class="form-control name_list numberOnly" required="" /><p class="help-block text-danger"></p></td>  							
													...
													<tr>
														...
														<td colspan="1"><input type="text numberOnly" id="shipping_charge" name="shipping_charge"  readonly class="form-control " value="0.00" /></td>
														<td></td>
													</tr>
													<tr>
														<td colspan="6" class="text-right"> Sub Total</td>
														<td colspan="1"><input type="text numberOnly" id="sub_total" name="sub_total"  readonly class="form-control " value="0.00" /></td>
														<td></td>
													</tr>
													<tr class="total">
														<td colspan="6" class="text-right"> Amount Total</td>
														<td colspan="1"><input type="text numberOnly" id="amount_total" name="amount_total" readonly class="form-control " value="0.00" /></td>
