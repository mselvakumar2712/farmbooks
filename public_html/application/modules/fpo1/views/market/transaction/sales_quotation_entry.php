										  ...
										  <div class="row ">
											...
											<div class="row ">
												...
												<div class="form-group col-md-3">
													...
													<input class="form-control" value="<?php echo uniqid('trv_SQ_'.rand(0,10000)); ?>" id="ref" name="ref" placeholder="Reference" required="required"  data-validation-required-message="Please enter reference.">
													<p class="help-block text-danger"></p>
												</div>		
											</div>
											...
											<div class="table-responsive mt-3">  
												<table class="table table-bordered" id="dynamic_field">
													...
													<tbody>
													<tr>  
														<td width="20%"><input type="text" name="item_code[]" id="item_code0" class="form-control name_list numberOnly" required="required" readonly /></td>  
											            ...
											            <?php } ?>
														   ...
														   <td width="10%"><input type="text " id="qty0" name="qty[]" maxlength="10" class="form-control  name_list numberOnly" required="required" /><p class="help-block text-danger"></p></td>  
														...
														<td width="10%"><input type="text" name="price[]" id="price0" class="form-control  numberOnly name_list"  required="" /><p class="help-block text-danger"></p></td>  
														<td width="10%"><input type="text" name="discount[]" id="discount0" class="form-control numberOnly name_list" required="" maxlength="2"/><p class="help-block text-danger"></p></td>  							
														<td width="20%"><input type="text" name="line_total[]" id="line_total0" class="form-control  numberOnly name_list" required="" /></td>  
