			  ...
			  <form  action="" id="figform" name="sentMessage" novalidate="novalidate" >
				...
				<div class="row ">
					...
					<div class="form-group col-md-3 text-center">
						...
						<input  class="form-control" type="date"  value="<?php echo date('Y-m-j'); ?>"  id="invoice_date" name="invoice_date" required="required"  data-validation-required-message="Please select date.">
