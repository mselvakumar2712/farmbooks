    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Issue of Right Share Certificate</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Issue of Right Share Certificate</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
                    <form action="<?php echo base_url('fpo/share/postrightcertificate'); ?>" novalidate="novalidate" method="post" >
					<div class="row">
					<div class="col-md-12">
					<div class="card">
						<div class="card-body">
						...
						<div class="row row-space mt-4" >
						   ...
						   <div class="form-group col-md-3">
							...
							<div class="form-group text-center col-md-3 mt-4 ml-4">
								<label id="certificate_id0"></label>	
							</div>
						</div>   
					</form>
							<form action="<?php echo base_url('fpo/share/postIssueRightCertificate')?>" novalidate="novalidate" method="post" >
									...
									<div class="form-row">
										<div class="form-group col-md-12 text-center">
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('fpo/share/rightsharecertificate'); ?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										</div>											 
									</div>
									<?php } ?>			
									<?php  if(empty($list_member)){ ?>
										...
										<div class="form-group col-md-12 text-center">
										<p class=" text-danger">There is no data to search right shares</p>
										</div>
										</div>
										<?php } ?>										
									</form>
