                           ...
                           <thead>
                              <tr>
                                 ...
                                 <tbody id="memberlist">                                  
                                      ...
                                      <td><input type="text" class="form-control numberOnly" maxlength="4" id="folio_number<?php echo $i;?>" value="<?php echo $farmer_list[$i]->folio; ?>"  name="folio_number[]"></td>
                                      ...
                                      <?php                                       
                                      $netTotal = $netTotal+$farmer_list[$i]->total_share;
                                      } ?>
                                  </tbody>
                                  <tfoot >
                                  <tr>
...
$(".shared").focusout(function(){
   ...
   $('.shared').each(function(){
      ...
      totalCapital=(Number(totalCapital)+Number($(this).val()));
   });
