      ...
      <div id="right-panel" class="right-panel">
         ...
         <div class="content mt-3">
            ...
            <div class="animated fadeIn">
               <form action="<?php echo base_url('fpo/share/postShareApplicationByFPO')?>" method="post" id="addshare_application" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                              <div class="container-fluid">                                                                         
                                 ...
                                 <div class="form-row">
                                       ...
                                       <a href="<?php echo base_url('fpo/share/fpo_shareapplication_list');?>" class="btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
                                    </div>											 
                                 </div>                                            
                              </div>
								   </div>
...
function getFPODetails(fpo_id) {
    $.ajax({
           url:"<?php echo base_url();?>fpo/share/getLocationByFpo/"+fpo_id,
           type:"GET",
           data:"",
           dataType:"html",
           cache:false,			
...
function searchFPOWithOption(search_fpo) {    
       $.ajax({
			url:"<?php echo base_url();?>fpo/share/searchFPO",
			type:"POST",
			data:search_fpo,
			dataType:"html",
         cache:false,			
