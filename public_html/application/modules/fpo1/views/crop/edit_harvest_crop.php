						  ...
						  <div class="row row-space" id="fertilizer_form_details">
						   <div class="form-group col-md-4">
							 <label for="inputState">Select Variety <span class="text-danger">*</span></label>
							  <select id="crop_variety" name="crop_variety" readonly class="form-control" required="required" data-validation-required-message="Please select crop variety" readonly >
							  </select>
							  <p class="help-block text-danger"></p>
							</div> 
							<div class="form-group col-md-4">
							 <label for="inputState">Date of Harvest <span class="text-danger">*</span></label>
							 <input type="date" class="form-control" name="harvest_date" id="harvest_date" placeholder="Date of Harvest" required="required" data-validation-required-message="Please enter date of harvest." >
							  <p class="help-block text-danger"></p>
							</div>
							<div class="form-group col-md-4">
							  ...
							  <div class="form-group col-md-6">
								  ...
								  <div class="row">
									<div class="col-md-4">
									  <div class="form-check-inline form-check">
										<label for="inline-radio1" class="form-check-label">
										  <input type="checkbox" id="harverst_method1" name="harvest_method[]" value="manual" class="form-check-input bothcheck1" required="required" data-validation-required-message="Please select." >Manual
										</label>
									  </div> 
									</div>
									<div class="col-md-4">
									  <div class="form-check-inline form-check">
										<label for="inline-radio2" class="form-check-label">
										  <input type="checkbox" id="harverst_method2" name="harvest_method[]" value="machine" class="form-check-input bothcheck1"  data-validation-required-message="Please select." >Machine 
									   </label>
									   </div>
									</div>	
									<div class="col-md-4">
									  <div class="form-check-inline form-check">
										<label for="inline-radio2" class="form-check-label">
										  <input type="checkbox" id="harverst_method3" name="harvest_method[]" value="both" class="form-check-input bothcheck"  data-validation-required-message="Please select." >Both
										 </label>
									   </div>
									</div>			
								  </div>
								  ...
								  <div class="form-group col-md-6 manual both" style="display:none;" id="harverst_method1">
									...
									<input type="text" class="form-control numberOnly" name="man_days" id="man_days" maxlength="3" placeholder="Labour Working in Days" required="required" data-validation-required-message="Please enter no. of man days." >
									<p class="help-block text-danger"></p>
								  </div>
								  </div>
								  <div class="row row-space">
								 <div class="form-group col-md-6 machine both" style="display:none;" id="harverst_method2">
									...
									<input type="text" class="form-control numberOnly" name="no_of_hours" id="no_of_hours" maxlength="3" placeholder="No of Hours Machine Used" required="required" data-validation-required-message="Please enter no. of hours." >
									<p class="help-block text-danger"></p>
								  </div>
