			  ...
			  <form  action="" id="figform" name="sentMessage" novalidate="novalidate" >
				<div class="container">
					<div class="row ">
						...
						<div class="col-md-12">
						<h3 class="text-center">Allocation of Bank Payment # 9</h3>
						<h4 class="text-center">Lucky Luke Inc.</h4>
						<p class="text-center mt-2">Date: 12/31/2016</p>
						<p class="text-center">Total: 1,000.00 USD</p>
						</div>
					</div>
				<!--<div class="row ">
						<div class="form-group col-md-3">						
