											...
											<div class="table-responsive">  
												<table class="table table-bordered low-padded" id="dynamic_field">
													...
													<tr id="row0">  
														...
														<td width="10%"><input type="text" id="mrp0" name="mrp[]" maxlength="6" class="form-control name_list numberOnly text-right" required="" /><p class="help-block text-danger"></p></td>  
		  ...
		  dataType:"html",        
			...
			success:function(response) {
				...
				if(responseArray.productCount.qty != null){
					console.log(temp_totalCount[selectedItem]);
