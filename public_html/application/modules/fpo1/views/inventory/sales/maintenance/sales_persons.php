...
<body>
       ...
       <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/Inventory/salestypes');?>">Sales Persons</a></li>
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
		        <form   id="" name="sentMessage" method="POST" action="<?php echo base_url('fpo/Inventory/postsalesperson')?>" novalidate="novalidate" >
						<div class="container">
							<div class="row ">
							...
							<div class="form-row">
						      ...
						      <input type="checkbox" id="in_active" name="in_active" class="form-check-input">show also Inactive</td>
						      </div>
							 </div>
	...
	$(document).ready(function() {         
            //CROP list API CALL
				$.ajax({
						url:"<?php echo base_url();?>fpo/Inventory/salespersonlist",
						type:"GET",
						data:"",
						dataType:"html",
						cache:false,			
...
$('.form-check-input').click(function() {
      //-->this will alert id of checked checkbox.
       if(this.checked){
         $.ajax({
						url:"<?php echo base_url();?>fpo/Inventory/salespersoninactivelist",
						type:"GET",
						data:"",
						dataType:"html",
						cache:false,			
