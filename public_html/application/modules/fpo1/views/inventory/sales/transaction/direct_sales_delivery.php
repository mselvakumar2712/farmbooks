                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('administrator/inventory/directsalesdelivery');?>"class="active">Direct Sales Delivery</a></li>
                        </ol>
                    </div>
                </div>
            </div>
										...
										<div class="container-fluid">
										  ...
										  <div class="row ">
												...
												<div class="form-group col-md-3">
													...
													<input  class="form-control" type="date"   id="delivery_date" name="delivery_date" required="required"  data-validation-required-message="Please select delivery date.">
													<p class="help-block text-danger"></p>
												</div>
												<div class="form-group col-md-3">
											...
											<div class="form-row">
											  ...
											  <div id="success"></div>
												<input id="sendMessageButton" value="Place Delivery" class="btn btn-success text-center" type="submit">							
