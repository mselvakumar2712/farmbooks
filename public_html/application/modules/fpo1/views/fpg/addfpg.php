      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('fpo/fpg/postfpg')?>" method="post" name="sentMessage" id="fpg_form" novalidate="novalidate" action="">
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="row row-space">
										 ...
										 <div class="row row-space">
											  ...
											  <div class="form-group col-md-12 text-center">
												...
												<a href="<?php echo base_url('fpo/fpg');?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i>  Cancel</a>	
											 </div>
										</div>
									</div>
								</div>
