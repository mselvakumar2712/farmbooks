            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<form action="<?php echo base_url('fpo/fig/postfigrepresent')?>" name="sentMessage" method="post" id="figrepresent" novalidate="novalidate" >				
						 ...
						 <div class="form-group col-md-6">
							...
							<div class="row mt-5">
							  <div class="col-md-12 text-center">
								...
								<a href="<?php echo base_url('fpo/fig/figrepresentativelist');?>" class="btn-fs btn btn-outline-dark mt-10"><i class="fa fa-close" aria-hidden="true"></i>  Cancel</a>	
							  </div>
						    </div>
