      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php //echo base_url('fpo/operation/postAddTrainingOfDirector');?>" method="post" id="directorTrainingForm" name="sentMessage" novalidate="novalidate" enctype="multipart/form-data">                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
												...
												<div class="row row-space"> 
													  ...
													  <div class="form-group col-md-6">
														...
														<div class="form-group col-md-3" id="costHolder">
															...
															<input type="text" id="involved_cost_value" name="involved_cost_value" maxlength="6" class="form-control numberOnly ml-2 text-right" placeholder="Total Cost" required="required" data-validation-required-message="Please provide the total cost">												
															<div class="help-block with-errors text-danger"></div>
														</div> 
												</div>
										...
										<div class="row row-space">
										  ...
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('fpo/operation/training_directorslist');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										  </div>											 
										</div>
									</div>
								</div>
	...
	$("#costHolder").hide();
     ...
     $('#sendMessageButton').click(function(event) {
         ...
         if(validate){
            ...
            $.ajax({
                url: "<?php echo base_url();?>fpo/operation/postAddTrainingOfDirector",
                method: 'post',
                data: data,
                cache: false,
                contentType: false,
