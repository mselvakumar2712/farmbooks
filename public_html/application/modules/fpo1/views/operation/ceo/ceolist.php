                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/ceolist');?>">List Chief Executive Officer</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                           ...
                           <div class="container">
								...
								<?php 
									if($active_ceo >0) {
										...
										?>
										<a href="<?php echo base_url('fpo/operation/addceo');?>">
							...
							<tbody id="ceolist">
                             ...
                             <?php if(isset($ceo->resigned_date)&& $ceo->resigned_date != '0000-00-00') {?>
                                <a href="<?php echo base_url('fpo/operation/viewceo/'.$ceo->id); ?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
                            ...
                            <?php }else{?>
											...
											<?php 
												if($ceo->status == 1) {
												?>
													<a href="<?php echo base_url('fpo/operation/editceo/'.$ceo->id); ?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
												<?php
                            }}
											?>
										</td>
