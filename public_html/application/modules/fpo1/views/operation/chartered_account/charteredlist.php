                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/charteredlist');?>">List Chartered Accountant</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">					
                        <div class="card-body">	
                           <div class="container">
								...
								<a href="<?php echo base_url('fpo/operation/addchartered');?>">
							...
							<?php foreach($accountant_list as $accountant) {
								?>
									<tr>
										...
										<td width="10%">
											<a href="<?php echo base_url('fpo/operation/viewchartered/'.$accountant->id); ?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
											<?php 
												if($accountant->status == 1) {
												?>
													<a href="<?php echo base_url('fpo/operation/editchartered/'.$accountant->id); ?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
												<?php
												}
											?>
										</td>
