      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/viewremoval');?>">Removal of Director</a></li>
                        </ol>
                    </div>
                </div>
            </div>
		...
		<?php if($this->session->flashdata('success')){ ?>
            ...
            <div class="animated fadeIn">
					<form  method="POST" action="<?php echo base_url('fpo/operation/update_removal')?>" method="POST" id="directorform" name="sentMessage" novalidate="novalidate">                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="col-md-12 text-center">
											<button href="<?php echo base_url('fpo/operation/editremoval/');?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Update</button>
