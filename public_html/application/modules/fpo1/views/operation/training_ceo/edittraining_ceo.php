      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/edittraining_ceo/'.$ceo['id']);?>">Edit Training to CEO</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php //echo base_url('fpo/operation/postUpdateTrainingOfCEO/'.$ceo['id'])?>"  method="post" id="trainginToCEOEditForm" name="sentMessage" novalidate="novalidate" enctype="multipart/form-data">
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
								...
								<?php }?>
                                             ...
                                             <select id="ceo_name" class="form-control" name="ceo_name" required data-validation-required-message="Please select the CEO name">
												...
												<div class="row row-space">
													...
													<div class="form-group col-md-4" id="costHolder">
														...
														<input type="text" id="involved_cost_value" name="involved_cost_value" class="form-control numberOnly ml-2 text-right" maxlength="6" placeholder="Total Cost" data-validation-required-message="Please provide the involved cost" value="<?php echo $ceo['involved_cost']; ?>">	
														<div class="help-block with-errors text-danger"></div>
													</div>  
												</div>
										...
										<div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('fpo/operation/training_ceolist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
...
$(document).ready(function() {
   ...
   $('#sendMessageButton').click(function(event) {
      ...
      if(validate){
         ...
         $.ajax({
             url: "<?php echo base_url();?>fpo/operation/postUpdateTrainingOfCEO/<?php echo $ceo['id']; ?>",
             method: 'post',
             data: data,
             cache: false,
             contentType: false,
