                    ...
                    <div class="card">					
                        <div class="card-body">	
                           ...
                           <div class="container">
								...
								<a href="<?php echo base_url('fpo/operation/addbaseline');?>">
							...
							<td class="text-center">
								<a href="<?php echo base_url('fpo/operation/editbaseline/'.$baseline_info->id); ?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
								<a href="<?php echo base_url('fpo/operation/viewbaseline/'.$baseline_info->id); ?>"  class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
							</td>
							</tr>
							<?php endforeach; ?>
							</tbody>
