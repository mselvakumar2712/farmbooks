      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/editincorporate');?>">Edit Upload Incorporation Documents</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('fpo/operation/update_incorporate/'.$user_info['id'])?>"  method="post"  id="directorform" name="sentMessage" novalidate="novalidate" >                   
									...
									<div class="card-body">
										...
										<div class="row row-space">
										  ...
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('fpo/operation/incorporatelist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
...
$(document).ready(function() {	
		...
		$(document).on('click', '.btn_remove', function(){  
           ...
           $('#row'+button_id+'').remove();  
			...
			var j=1;
			$.ajax({
			url: "<?php echo base_url();?>fpo/operation/grnpoitems/"+order_no,
			type: "GET",
			dataType:"html",
			cache:false,			
