									...
									<div class="card-body">
										<div class="container-fluid">
												<div class="row row-space mt-4"> 
													...
													<input type="text" id="involved_cost_value" name="involved_cost_value" class="form-control numberOnly ml-2 text-right" value="<?php echo $awareness['involved_cost']; ?>" placeholder="Cost Involved" data-validation-required-message="Please provide the involved cost" disabled>
																<div class="help-block with-errors text-danger"></div>
															</div>  
													  </div>													  												
										...
										<div class="col-md-12 text-center">
											<a href="<?php echo base_url('fpo/operation/editawareness/'.$awareness['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Awareness<a>
											<a href="<?php echo base_url('fpo/operation/awarenesslist/'.$awareness['id']);?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
