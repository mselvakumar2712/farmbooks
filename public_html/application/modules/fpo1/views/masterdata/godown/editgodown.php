      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('fpo/masterdata/godownlist');?>">Godown</a></li>
                            <li class="active">Edit Godown</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form  action="<?php echo base_url('fpo/masterdata/updategodown/'.$godown_info['id'])?>" method="post" id="figform" name="sentMessage" novalidate="novalidate" >
				  ...
				  <div class="row">
							<div class="col-md-12">
									...
									<div class="card-body">
										<div class="container-fluid">
											<div class="row row-space">
												<div class="form-group col-md-4">
													...
													<input type="text" class="form-control"  value="<?php echo $godown_info['name']?>"  maxlength="50" id="name" name="name" placeholder="Name"  required="required" data-validation-required-message="Please enter name .">
													<p class="help-block text-danger"></p>
												</div>
												<div class="form-group col-md-4">
													<label for="inputAddress2">Alias</label>
													<input type="text" class="form-control"  maxlength="50" value="<?php echo $godown_info['alias-name']?>" id="alias" name="alias" placeholder="Alias">
												</div>
												<div class="form-group col-md-4">
                                       ...
                                       <p class="help-block text-danger"></p>
												...
												<div class="form-group col-md-4">
													...
													<input type="text" class="form-control numberOnly"  value="<?php echo $godown_info['capacity']?>"  maxlength="10" id="capacity" name="capacity" placeholder="Capacity">
												</div>
												...
												<div class="form-group col-md-4">
													...
													<input type="text" class="form-control numberOnly" value="<?php echo $godown_info['no_of_compartments']?>" maxlength="3" id="compartments_no" name="compartments_no" placeholder="Number of Compartments "  required="required">
												</div>
										...
										<div class="form-group col-md-4">
											...
											<input type="text" readonly value="<?php echo $godown_info['pincode']?>" onkeyup="getPincode(this.value)"  class="form-control numberOnly this_pin_code" id="pincode" pattern="[1-9][0-9]{5}" name="pincode" minlength="6" maxlength="6" placeholder="PIN Code" required="required" data-validation-required-message="Please enter pincode.">						
											 <p class="help-block text-danger" id="pincode_validate"></p>
										</div>	
										<div class="form-group col-md-4">
											<label for="inputAddress2">State <span class="text-danger">*</span></label>
											<select   id="state" name="state" readonly class="form-control sel_state" required="required" data-validation-required-message="Please Select state.">
										...
										<div class="form-group col-md-4">
											...
											<select   id="district" readonly  name="district" class="form-control sel_district" required="required" data-validation-required-message="Please Select district.">
										...
										<div class="form-group col-md-4">
											...
											<textarea id="address" maxlength="50" name="address" class="form-control" ><?php echo $godown_info['street']?></textarea>
                              ...
                              <div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('fpo/masterdata/godownlist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
										  </div>
										</div>
									</div>
