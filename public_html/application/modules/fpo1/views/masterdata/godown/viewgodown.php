                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">View Godown</li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
									<div class="card-body">
										...
										<a href="#" id="" class="del btn btn-danger btn-fs"><i class="fa fa-trash"></i> Delete</a>	
											<a href="<?php echo base_url('fpo/masterdata/godownlist');?>" id="ok" class="btn-fs btn btn-outline-dark ml-2"><i class="fa fa-arrow-circle-left"></i> Back</a>
											<a href="<?php echo base_url('fpo/masterdata/godownlist');?>" id="cancel" class="btn-fs btn btn-outline-dark ml-2" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
											</div>-->
                              <div class="col-md-12 text-center">
											<a href="<?php echo base_url('fpo/masterdata/viewgodown/' . $godown_info['id']); ?>" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit<a>
											<a href="<?php echo base_url('fpo/masterdata/godownlist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>   
