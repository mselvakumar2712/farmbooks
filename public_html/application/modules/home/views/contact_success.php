   ...
   <body>
                  ...
                  <form id="contactus"  name="sentMessage" action="<?php echo base_url('home/postcontact');?>" method="post">
                     ...
                     <div class="input-group mb-3">
                      ...
                      <div class="input-group ">
                       <div class="input-group-prepend">
                         <div class="input-group-text " id="basic-addon3" style="width:20%;display:inline-block"><img src="<?php echo asset_url()?>img/home/india_flag.png" width="30%"/></img>+ 91</div>
                       </div>
      ...
      <script>
         jQuery(document).ready(function() {
            swal("Thank You!", "Your information has been submitted with Us. Our representative will get back to you shortly.", "success");
            setTimeout(function(){ 
