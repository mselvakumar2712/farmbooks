      ...
      <header>
         <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
               <div class="carousel-item active" style="background-image: url('<?php echo asset_url()?>img/img_3.jpg')">
              ...
              <div class="container-fluid img_logo">
                  ...
                  <div class="col-md-12 text-center">           
                    ...
                    <div class="col-md-12 text-center">           
                    <a href="<?php echo base_url('/');?>"><input id="launch" value="Launch" style="background-color: #2665ab;" class="text-white btn btn-lg btn-fs text-center mt-5" type="button"></a>				  
                  </div>
               </div>
            </div>            
         </div>
