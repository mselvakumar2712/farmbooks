               ...
               <div class="col-md-6 offset-md-3">
                  <div class="panel-default px-3 py-4" style="height:100%">
                     <div class="panel-body">
						<form id="loginForm" name="sentMessage" novalidate="novalidate" action="<?php echo base_url('fpo/fpo/changepassword');?>" method="post">
							 ...
							 <div class="form-group row mt-4">
								   <div class="col-sm-12 text-center">
									  <div id="success"></div>
										...
										<a href="<?php echo base_url('fpo/dashboard');?>" id="cancel" class="btn btn-outline-dark " >Cancel</a>
								   </div>
							 </div>
						 </div>
						 </form>
