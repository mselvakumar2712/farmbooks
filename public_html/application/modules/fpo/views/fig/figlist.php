                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/fig');?>">List FIG</a></li>
							...
							<tbody id="figlist">
								<?php foreach($fig_info as $row): ?>
									<tr> 							
										...
										?></td>																			 
										<td >
										<a href="<?php echo base_url('fpo/fig/viewfig/' . $row->id); ?>"  class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
										</td>							
									</tr>
								<?php endforeach; ?>
							</tbody>
