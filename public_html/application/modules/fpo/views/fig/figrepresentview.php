                ...
                <div class="page-header float-right">
                    <div class="page-title">
                      <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('fpo/fig/figrepresentativelist');?>">FIG Representative</a></li>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
						...
						<form action="<?php echo base_url('fpo/fig/updatefigrepresent/'.$figrepresent_list[0]->id)?>" name="sentMessage" method="post" id="editfigrepresent" novalidate="novalidate" >				
							...
							<div class="row">								
							  <div class="form-group col-md-12 text-center">
								<div id="success"></div>
									...
									<a href="<?php echo base_url('fpo/fig/figrepresentativelist');?>" id="ok"  class="btn-fs btn btn-outline-dark text-center mt-3"><i class="fa fa-arrow-circle-left"></i>  Back</a>
									<a href="<?php echo base_url('fpo/fig/figrepresentativelist');?>"><input id="cancel" href="" value="Cancel" class="btn-fs btn btn-outline-dark text-center mt-3" type="button" style="display:none"></a>
							  </div>
						    </div>
...
<script src="<?php echo asset_url()?>js/register.js"></script>	 
 ...
 <script>
	...
	function verifyMember(mobile_or_aadhaar_value) {
			$.ajax({
				url:"<?php echo base_url();?>fpo/Fig/verifyMember/",
				type:"POST",
	...
	$('a.del').click(function() {
		...
		swal({
         ...
         if (result.value) {          
            ...
            $.ajax({
              url: "<?php echo base_url();?>fpo/fig/deletefigrepresent/"+figrepresent_id,
              type: "POST",
              data: {
              ...
              success: function() {        
                 setTimeout(function() {
                  window.location.replace("<?php echo base_url('fpo/fig/figrepresentativelist')?>");
                 }, 1000);
              },
              error: function() {                 
                 setTimeout(function() {
