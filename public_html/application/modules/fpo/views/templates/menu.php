        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav  ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#products-menu"><i class="fas fa-bell mt-1"></i><span
                          class="badge"><?php echo ($this->session->userdata('bankinfo_count') + $this->session->userdata('partners_count')+$this->session->userdata('invinfo_count'));?></span></a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul id="mail-menu" class="dropdown-menu clearfix" role="menu" style="width:200px;">
                        ...
                        <li class="dropdown-item ml-1"><a class="ml-3" href=""><?php echo $result['partner_name']?></a></li>
