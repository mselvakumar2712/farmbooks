          <ul class="nav navbar-nav">
              <li class="menu-item-has-children dropdown <?php  if($page == 'Crop Master' ){echo 'show open';}?>">
                  <a href="#" data-toggle="dropdown" aria-haspopup="true" <?php echo $page_title == 'List Crop Master'||'Add Crop Master' ? 'aria-expanded="true"' : 'aria-expanded="false"';?>><i class="menu-icon fa fa-leaf"></i><span class="ml-1">Crop Master</span></a>
                  <ul class="sub-menu children dropdown-menu <?php  if($page == 'Crop Master' ){echo 'show';}?>">
                      <li><i class="fa fa-circle-o"></i><a <?php echo $page_title == 'List Crop Master' ? 'class="active"' : ''; ?> href="<?php echo base_url('administrator/cropmaster');?>">List Crop Master </a></li>
                      <li><i class="fa fa-circle-o"></i><a <?php echo $page_title == 'Add Crop Master' ? 'class="active"' : ''; ?> href="<?php echo base_url('administrator/cropmaster/addcrop');?>">Add Crop Master</a></li>
                  </ul>
              </li>
              ...
              <li class="menu-item-has-children dropdown <?php  if($page == 'Crop Subcategory Master' ){echo 'show open';}?>">
                  ...
                  <ul class="sub-menu children dropdown-menu <?php  if($page == 'Crop Subcategory Master' ){echo 'show';}?>">
                      ...
                      <li><i class="fa fa-circle-o"></i><a <?php echo $page_title == 'Add Crop Subcategory Master' ? 'class="active"' : ''; ?> href="<?php echo base_url('administrator/subcategory/addsubcategory');?>">Add Crop SubCategory Master</a>
                      </li>
                  </ul>
              </li>
