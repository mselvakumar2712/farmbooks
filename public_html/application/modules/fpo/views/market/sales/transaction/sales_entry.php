...
<body <?php  if($page_title == 'Sales Entry' ){echo 'class="open"';}else{}?>>
    <div class="container-fluid pl-0 pr-0">
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                ...
                <div class="animated fadeIn">
                    <form method="POST" action="<?php if($page_module == 'market') { echo base_url('fpo/market/postsales_entry'); } else if($page_module == 'finance') { echo base_url('fpo/finance/postsales_entry'); } ?>" id="figform"
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" maxlengh="15" readonly value="<?php echo $invoice_no; ?>" id="invoiceNo" name="invoiceNo" placeholder="Invoice No." required="required"
                                                      data-validation-required-message="Please enter invoice no.">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-2">
                                                    <label for="deliveryTo">Transaction Type <span class="text-danger">*</span></label>
                                                    <select autofocus class="form-control" id="transaction_type" name="transaction_type" style="width:100%" required="required" data-validation-required-message="Please select deliver to.">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select class="form-control" id="customerId" name="customerId" style="width:100%" required="required" data-validation-required-message="Please select customer.">
                                                        ...
                                                        <option value="<?php echo $customer[$i]->debtor_no; ?>"><?php echo $customer[$i]->name; ?><?php echo !empty($customer[$i]->mobile_number)?" ( ".$customer[$i]->mobile_number." )":''; ?></option>
                                                        <?php } ?>
                                                ...
                                                <table class="table table-bordered low-padded" id="dynamic_field">
                                                    ...
                                                    <tbody>
                                                        <tr id="row0">
                                                            ...
                                                            <td width="10%" class="text-center">
                                                                <input type="text" name="qty[]" id="qty0" class="form-control text-right numberOnly" min="1" maxlength="6" required="required" />
                                                            </td>
                                                            <td width="10%" class="text-center">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div id="divCGSTTotal"><input type="text" id="cgstTotal" name="cgstTotal" readonly class="form-control text-right" /></div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div id="divSGSTTotal"><input type="text" id="sgstTotal" name="sgstTotal" readonly class="form-control text-right" /></div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <div id="divIGSTTotal"><input type="text" id="igstTotal" name="igstTotal" readonly class="form-control text-right" /></div>
                                                            </td>
        ...
        <script type="text/javascript">
            ...
            <?php
            for ($i = 0; $i < count($supply_location); $i++) {
                ?>
            ...
            $(document).ready(function() {
                ...
                $('#item_description0').on('change', function(e) {
                    ...
                    if (deliveryTo != "" && customerId != "") {
                        updateItemTotal(selectedItem, 'itemCount0', 'unit0', 0, 0);
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn_add', function() {
                    ...
                    var validate = true;
                    $(this).parents('tr').find('input[type=text], select').each(function() {
                        if ($(this).attr('name') == "each_qty[]" || $(this).attr('name') == "each_unit[]" || $(this).attr('name') == "line_discount[]" || $(this).attr('name') == "mrp[]") {} else {
                    ...
                    if (validate) {
                        ...
                        str_add += '		<input type="text" id="qty' + i + '" name="qty[]" class="form-control text-right numberOnly" min="1" maxlengh="6" required="required"/>';
                        str_add += '	</td>';
                        str_add += '	<td width="10%" class="text-center">';
                        ...
                        str_add += '	</td>';
                        str_add += '	<td width="5%" class="text-center">';
                        str_add += '		<div class="seAddBtn"><button type="button" id="add_' + i + '" class="btn btn-success btn_add">+</button><button type="button" id="remove_' + i +
                            '" style="display:none" class="btn btn-danger btn_remove">-</button></div>';
                        str_add += '	</td>';
                        str_add += '</tr>';
                        if (gstEnable == 1) {
                        ...
                        $('#item_description' + i).on('change', function(e) {
                            ...
                            updateItemTotal(selectedItem, 'itemCount' + i, 'unit' + i, qty_Value, uom_Value);
                ...
                $(document).on('click', '#sendMessageButton', function() {
                    ...
                    if ($('#invoiceNo').val() == '' || $('#customerId').val() == '' || $('#supplyLocation').val() == '' || $('#deliveryTo').val() == '') {
                        ...
                        if (itemRows > 1) {
                            if ($('#item_description' + lastLineIndex).val() == '' && $('#qty' + lastLineIndex).val() == '' && $('#unit' + lastLineIndex).val() == '' && $('#price' + lastLineIndex).val() == '') {} else {
                                if ($('#item_description' + lastLineIndex).val() == '' || $('#qty' + lastLineIndex).val() == '' || $('#unit' + lastLineIndex).val() == '' || $('#price' + lastLineIndex).val() == '') {
                                    formValidate = false;
                                }
                            }
                            ...
                            success: function(response) {
                                ...
                                if (responseArray.status == 1) {
                                    ...
                                    $.each(responseArray.branch_list, function(key, value) {
                                        if (key == 0) {
                                            $("#deliveryTo").append($('<option selected="selected"></option>').val(value.branch_code).html(value.mailing_pincode + ',' + value.state_name + ',' + value.district_name + '-' +
                                                value.br_name));
                                        } else {
            ...
            function updateItemTotal(selectedItem, itemCount, UOM_Value, qty_value, uom_id) {
                if (selectedItem != '') {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (responseArray.productCount.qty != null) {
                                if (temp_totalCount[selectedItem]) {
                                    ...
                                    temp_totalCount[selectedItem] = Number(temp_totalCount[selectedItem]);
                                } else {
