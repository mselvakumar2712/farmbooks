            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Search All Sales Quotations</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('administrator/inventory/salesquotationinquiry');?>">Search All Sales Quotations</a></li>
				...
				<table class="table table-bordered">
					<thead>
						<tr bgcolor="#afd66b">		
							...
							<th class="text-center">Quote Total</th>
							<th class="text-center">Cureency</th>
