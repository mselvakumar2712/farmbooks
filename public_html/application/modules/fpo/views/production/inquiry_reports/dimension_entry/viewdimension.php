                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
							...
							<li><a class="active" href="#">View Dimension Entry</a></li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
												<div class="row row-space"> 
													...
													<div class="form-group col-md-4">
														...
														<input type="date" class="form-control" id="start_date" name="start_date" placeholder="" readonly>
													</div>
												</div>
												...
												<div class="row row-space">													
													<div class="form-group col-md-4">
														...
														<input type="text" class="form-control" id="name" name="name" required="required" data-validation-required-message="Please enter the name" placeholder="Name" readonly>
														<p class="help-block text-danger"></p>
													</div>
													<div class="form-group col-md-4">
														<label for="">Tags <span class="text-danger">*</span></label>
														<select class="form-control" id="tag_value" name="tag_value" readonly>
													...
													<div class="form-group col-md-4">
														...
														<input type="date" class="form-control" id="date_required" name="date_required" placeholder="" readonly>
													</div>
												</div>
										...
										<div class="row row-space">
											...
											<div id="success"></div>
											<a href="<?php echo base_url('fpo/production/editDimension/'); ?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Dimension Entry<a>
