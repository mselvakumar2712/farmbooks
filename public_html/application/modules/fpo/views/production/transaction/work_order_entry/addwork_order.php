                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
							...
							<li><a class="active" href="#">Add Work Orders</a></li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
												...
												<div class="row row-space">
													<div class="form-group col-md-4">
														...
														<input type="text" onkeyup="getPincode(this.value)" class="form-control numberOnly this_pin_code" id="pincode" pattern="[1-9][0-9]{5}" name="pincode" minlength="6" maxlength="6" placeholder="PINCODE" value="" required="required" data-validation-required-message="Please enter pincode.">
												...
												<div class="row row-space">
													<div class="form-group col-md-4">
														...
														<select id="taluk" name="taluk" class="form-control" required="required" data-validation-required-message="Please Select taluk.">
													...
													<div class="form-group col-md-4">
														...
														<select id="block" name="block" class="form-control" required="required" data-validation-required-message="Please Select block.">
													...
													<div class="form-group col-md-4">
														...
														<select  name="gram_panchayat" id="gram_panchayat" class="form-control" required="required" data-validation-required-message="Please Select gram panchayat.">
												...
												<div class="row row-space">	
													<div class="form-group col-md-4">
														...
														<select id="village" name="village" class="form-control" required="required" data-validation-required-message="Please Select village.">
													...
													<div class="form-group col-md-4">
														<label for="">Select Item <span class="text-danger">*</span></label>
														  <select class="form-control" id="item_value" name="item_value" required="required" data-validation-required-message="Please Select any item">
												...
												<div class="row row-space">													
													...
													<div class="form-group col-md-4">
														...
														<input type="text numberOnly" class="form-control text-right" id="labour_cost" name="labour_cost" required="required" placeholder="0.00">
														<p class="help-block text-danger"></p>
													</div>
													<div class="form-group col-md-4">
														<label for="">Overhead Cost </label>
														<input type="text numberOnly" class="form-control text-right" id="overhead_cost" name="overhead_cost" placeholder="0.00">
													</div>
												</div>
										...
										<div class="row row-space">
											...
											<div id="success"></div>
											<button id="sendMessageButton" class="btn btn-success btn-fs text-center" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save Work Order</button>
