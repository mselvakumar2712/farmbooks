                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
							...
							<li><a class="active" href="#">Edit Bills of Material</a></li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
									<div class="card-body">
											...
											<div class="row row-space">														
												...
												<div class="form-group col-md-4">
													<label for="">Work Centre <span class="text-danger">*</span></label>
													  <select class="form-control" id="work_centre" name="work_centre" required="required" data-validation-required-message="Please Select any work centre">
										...
										<div class="row row-space">
										  ...
										  <div id="success"></div>
											<button id="sendMessageButton" class="btn btn-success btn-fs text-center" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i> Update Bills of Material</button>
