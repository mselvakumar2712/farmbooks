                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="table-responsive mt-3" id="p_and_l_account_balance">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="right" class="text-danger"><strong><?php echo number_format((isset($incomeCost) && $incomeCost)?ltrim($incomeCost, '-'):0, 2);echo (isset($incomeCost) && substr($incomeCost, 0, 1) == '-')?' Dr':' Cr'; ?></strong></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php if(isset($openingStock) && $openingStock!=0){ ?>
                                                        <tr id="row_closing" bgcolor="#A9A9A9">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="80%" class="text-right text-danger"><strong>Total ( <span class="fa fa-inr" aria-hidden="true"></span> )</strong></td>
                                                            <td align="right" class="text-danger"><strong><?php echo number_format((isset($expenseCost) && $expenseCost)?ltrim($expenseCost, '-'):0, 2); echo (isset($expenseCost) && substr($expenseCost, 0, 1) == '-')?' Dr':' Cr'; ?></strong></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="table table-bordered" id='total_balance_show'>
                                                    <tr bgcolor="#afd66b">
                                                        ...
                                                        <th class="text-danger text-right">
                                                            <strong>
                                                              <?php
                                                              $prl = (isset($netIncome)?number_format(ltrim($netIncome, '-'), 2):number_format(ltrim($netExpense, '-'), 2));
                                                              if(isset($netIncome)){
                                                                echo (isset($netIncome) && substr($netIncome, 0, 1) == '-')?"<span color=''>{$prl}  Dr":"<span style='color:#0b6407;'>{$prl}  Cr</span>";
                                                              } else {
                                                                echo (isset($netExpense) && substr($netExpense, 0, 1) == '-')?"<span color=''>{$prl}  Dr":"<span style='color:#0b6407;'>{$prl}  Cr</span>";
                                                              }
                                                              ?>
                                                            </strong>
                                                        </th>
                        ...
                        if (responseArray.status == 1) {
                            ...
                            $.each(responseArray.glCategory, function(key, value) {
                                if (value.has_child != 0) {
                                    childNodeAppend += '<tr class="row_' + selectedCode + '" id="' + value.account_code + '" onclick="getChildrenNodeByAccountCode(this.id, ' + values + ', ' + value.has_child + ', 1, ' + value
                                        .person_type_id + ', ' + value.account + ')" bgcolor="' + bgColor + '">';
