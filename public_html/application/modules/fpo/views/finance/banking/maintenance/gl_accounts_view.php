     ...
     <div class="container-fluid pl-0 pr-0">
       ...
       <div class="breadcrumbs">
		...
		<div class="content mt-3">
			...
			<form action="<?php echo base_url('fpo/finance/updateglAccounts/')?>" method="post" id="gl_account_form" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">									
									<div class="container-fluid mt-5">  
										...
										<div class="form-row">
											  ...
											  <div id="success"></div>
												<!--<a href="<?php //echo base_url('fpo/finance/editglaccounts/'. $glgroup_info[0]->account_code);?>" class="btn btn-success text-center" ><i class="fa fa-edit"></i> Edit</a>-->
											    <a href="<?php echo base_url('fpo/finance/glaccounts');?>" id="cancel" class="btn btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
											  </div>											 
									     </div>
									</div>
								</div>
