...
<body>
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('fpo/finance/debitnote');?>"class="active">Debit Note</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
			...
			<form action="<?php echo base_url('fpo/finance/postDebitnote')?>" method="post" id="debit_note_form" name="sentMessage" novalidate="novalidate" >
                  <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
										  ...
										  <div class="row">
                                                <div class="form-group col-md-4">
													...
													<input class="form-control" type="date" autofocus min="<?php echo $formation_date;?>" id="entry_date" name="entry_date" required data-validation-required-message="provide the entry date" value="<?php echo date("Y-m-d"); ?>" max="<?php echo date("Y-m-d"); ?>">
											...
											<div class="row">											
												...
												<div class="form-group col-md-4">
													<label for="inputAddress">Debit Note ( <span class="fa fa-inr" aria-hidden="true"></span> ) <span class="text-danger">*</span></label>
													<input type="text" class="form-control numberOnly text-right" maxlength="6" id="debit_note" name="debit_note" placeholder="Debit Note " required="required" data-validation-required-message="Please enter debit note">
