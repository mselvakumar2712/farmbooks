                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?php echo base_url('administrator/inventory/salesorderentry');?>"class="active">Sales Order Entry</a></li>
                        </ol>
                    </div>
                </div>
            </div>
										...
										<div class="container-fluid">
										   ...
										   <div class="row ">
												...
												<div class="form-group col-md-3">
													...
													<input  class="form-control" type="date"   id="quotation_date" name="quotation_date"required="required" data-validation-required-message="Please select order date.">
													<p class="help-block text-danger"></p>
												</div>	
											</div>	
											<div class="row ">
										    ...
										    <div class="form-row">
											  ...
											  <div id="success"></div>
												<input id="sendMessageButton" value="Place Order" class="btn btn-success text-center" type="submit">							
