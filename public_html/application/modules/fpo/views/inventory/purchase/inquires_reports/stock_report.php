       ...
       <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/inventory/stockreports');?>">Stock Report</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">	
            ...
            <div class="animated fadeIn">
			  <form  action="<?php echo base_url('fpo/inventory/getstockreport')?>" method="post"  id="figform" name="sentMessage" novalidate="novalidate" >
				<div class="container">
				<div class="row ">
