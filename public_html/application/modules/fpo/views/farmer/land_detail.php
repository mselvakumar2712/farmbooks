                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2 mt-4">
                                                <button align="center" name="searchSubmit" id="searchSubmit" class="btn btn-success btn-fs mt-1 text-center" type="button" style="padding: .375rem .25rem;"><i class="fa fa-search fa-1x"
                ...
                if (responseArray.status == 1) {
                    ...
                    $.each(responseArray.land_list, function(key, value) {
                        ...
                        if (value.land_holdings == 1) {
                            land_list += '<tr><td>' + value.profile_name + '</td><td>' + ownership_type + '</td><td>' + value.name + '</td><td>' + land_type + '</td><td>' + address +
                                '</td><td><a href="<?php echo base_url("fpo/farmer/viewland/' + value.id +
                                '");?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a> <a href="<?php echo base_url("fpo/farmer/viewland/' + value.id +
                                '");?>" class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a></td></tr>';
                        }
                    });
