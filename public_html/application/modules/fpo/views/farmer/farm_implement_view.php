...
echo "<option>$i</option>";
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-check-inline form-check">
                                                                            <label for="inline-radio1" class="form-check-label">
                                                                                <input type="radio" id="farm_implements_insurance_coverage" name="farm_implements_insurance_coverage" value="1" class="form-check-input" disabled><span
                                                                                  class="ml-1">Yes</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-check-inline form-check">
                                                                            <label for="inline-radio2" class="form-check-label">
                                                                                <input type="radio" id="farm_implements_insurance_coverage" name="farm_implements_insurance_coverage" value="2" class="form-check-input" disabled><span
                                                                                  class="ml-1">No</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="form-group text-center col-md-12  mt-4 ">
                                                ...
                                                <a href="<?php echo base_url('fpo/farmer/farmimplementlist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
                                                <a href="<?php echo base_url('fpo/farmer/farmimplementlist');?>" id="cancel" class="btn btn-fs btn-outline-dark" style="display:none;"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $('a.del').click(function() {
        ...
        swal({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: "<?php echo base_url();?>fpo/farmer/deleteFarmImplement/" + farmimplement_id,
                    type: "POST",
                    data: {
                    ...
                    success: function() {
                        setTimeout(function() {
                            window.location.replace("<?php echo base_url('fpo/farmer/farmimplementlist')?>");
                        }, 1000);
                    },
                    error: function() {
    ...
    $(document).ready(function() {
        ...
        // jQuery method
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/editfarmimplement/" + farmimplement_id,
            type: "GET",
            dataType: "html",
            cache: false,
            success: function(response) {
                ...
                if (responseArray.status == 1) {
                    ...
                    if (responseArray.farmimplement_list[0].farm_implements == 1) {
                        ...
                        var href_value = "<?php echo base_url('fpo/farmer/add_farmimplement?id=');?>" + responseArray.farmimplement_list[0].farmer_id;
                        ...
                        var insurance_coverage = $('input:radio[name=farm_implements_insurance_coverage]');
                        if (responseArray.farmimplement_list[0].insurance_coverage == 1) {
                            if (insurance_coverage.is(':checked') === false) {
                                ...
                                $("#farm_implements_insurance_validity_to").attr("min", responseArray.farmimplement_list[0].ins_validity_from);
                                document.getElementById("farm_implements_insurance_validity_to").value = responseArray.farmimplement_list[0].ins_validity_to;
                            }
    ...
    function loadFarmImplementsName() {
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/getFarmImplements",
            type: "GET",
            data: "",
            dataType: "html",
            cache: false,
    ...
    function loadFarmImplementsMakeAndModel(name_value) {
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/getFarmImplementsMakeAndModel/" + name_value,
            type: "GET",
            data: "",
            dataType: "html",
            cache: false,
    ...
    $('form').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/updatefarmimplement/" + farm_implement_id,
            type: "POST",
            data: farmerdata,
            dataType: "html",
            cache: false,
            success: function(response) {
                ...
                if (responseArray.status == 1) {
                    ...
                    window.location = "<?php echo base_url('fpo/farmer/farmimplementlist')?>";
                }
            },
            error: function(response) {
                alert('Error!!! Try again');
