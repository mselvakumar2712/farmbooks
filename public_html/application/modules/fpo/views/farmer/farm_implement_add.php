                                    ...
                                    <div class="container">
                                        ...
                                        <form action="#" id="farmer_farmimplement" name="farmer_farmimplement" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div id="farm_implements_form" style="display:none;">
                                                        ...
                                                        <div class="form-group col-md-12 mt-2">
                                                            ...
                                                            <div class="form-group col-md-4" id="insurance_coverage_from" style="display:none">
                                                                ...
                                                                <input type="date" class="form-control" id="farm_implements_insurance_validity_from" name="farm_implements_insurance_validity_from" placeholder="Insurance Validity from"
                                                                  max="9999-12-31">
                                                                <div class="help-block with-errors text-danger"></div>
                                                            </div>
                                            ...
                                            <div class="form-group col-md-12 text-center"> <button id="sendMessageButton" class="btn btn-fs btn-success text-center" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
                                                <a href="<?php echo base_url('fpo/farmer/farmimplementlist');?>" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $('select[id="farm_implements_name"]').on('change', function() {
        ...
        loadFarmImplementsMake(name_value);
    });

    $('select[id="farm_implements_make"]').on('change', function() {
        var imp_id = $('#farm_implements_name').val();
        var name_value = $(this).val();
        getFarmImplementsModel(imp_id,name_value);
    });

    function loadFarmImplementsMake(name_value) {
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/getFarmImplementsMake/" + name_value,
            type: "GET",
            data: "",
            dataType: "html",
            cache: false,
            success: function(response) {
                ...
                if (responseArray.status == 1) {
                    ...
                    $.each(responseArray.farmImplement_make, function(key, value) {
                        farmImplement_makeandmodel1 += '<option value=' + value.Make + '>' + value.Make + '</option>';
    ...
    function getFarmImplementsModel(imp_id,name_value) {
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/getFarmImplementsModel/"+imp_id+"/" + name_value,
            type: "GET",
            data: "",
            dataType: "html",
            cache: false,
            success: function(response) {
                ...
                if (responseArray.status == 1) {
                    var farmImplement_makeandmodel2 = '<option value="">Select Model</option>';
                    $.each(responseArray.farmImplement_model, function(key, value) {
                        farmImplement_makeandmodel2 += '<option value=' + value.id + '>' + value.Model + '</option>';
                    });
    ...
    $('form').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/postFarmImplement",
            type: "POST",
            data: farmerdata,
            dataType: "html",
            cache: false,
    ...
    function updateFarmerByFarmerID(farmer_id) {
        $.ajax({
            url: "<?php echo base_url();?>fpo/farmer/existedFarmerName/" + farmer_id,
            type: "GET",
            data: "",
            dataType: "html",
            cache: false,
