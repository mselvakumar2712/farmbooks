    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
                    <form action="<?php echo base_url('fpo/share/postShareSurrender')?>" method="post" id="shareSurrenderForm" name="sentMessage" novalidate="novalidate" >
                    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                        ...
                                        <div class="transfer_to_member" id="transfer_to_member" style="">
                                            ...
                                            <div class="row row-space" id="transferContent">        
                                                ...
                                                <div class="form-group col-md-3">
													...
													<input type="hidden" class="form-control" name="selectedShareValue" id="selectedShareValue" required>
										...
										<div class="form-row" id="buttonContent">
								            <div class="form-group col-md-12 text-center">
											  <div id="success"></div>
												...
												<a href="<?php echo base_url('fpo/share/sharesurrender');?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
											 </div>											 
								        </div>
...
function highlight(e) {
    ...
    $("#buttonContent").show(); 
	var selectedShareValue = $("#allotment_detail tr.selected td:last").html(); 
	$("#selectedShareValue").val(selectedShareValue);
} 
