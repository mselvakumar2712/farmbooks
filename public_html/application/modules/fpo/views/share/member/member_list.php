                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/member'); ?>">List Member</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">	
							<div class="container">
								<div class="" style="text-align:right;margin-bottom:20px;">
									<a href="<?php echo base_url('fpo/member/addmember');?>">
							...
							<tbody id="memberlist">  
							 <?php for($i=0;$i<count($members);$i++){ ?>
								...
								<td><a href="<?php echo base_url('fpo/member/viewmember/'.$members[$i]->id); ?>" class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a></td>
                                </tr>
                                <?php } ?> 
                            </tbody>
						  </table>
