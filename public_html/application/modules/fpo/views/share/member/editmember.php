    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                    <form action="<?php echo base_url('fpo/member/postMember')?>" method="post" id="editmemberform" name="sentMessage" novalidate="novalidate" >
                    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
								    <div class="container-fluid">
                                        ...
                                        <div class="row row-space">                                            
                                                    ...
                                                    <div class="col-md-4">
                                                      <div class="form-check-inline form-check">
                                                        <label for="member_type1" class="form-check-label">
                                                          <input type="radio" id="member_type1" name="member_type" value="1" class="form-check-input member_type" required="required" data-validation-required-message="Please select member type" <?php echo ($member->member_type == 1)?'checked':''; ?> disabled><span class="ml-1">Person</span>
                                                        </label>
                                                      </div> 
                                                    </div>
                                                    <div class="col-md-8">
                                                      <div class="form-check-inline form-check">
                                                        <label for="member_type2" class="form-check-label">
                                                          <input type="radio" id="member_type2" name="member_type" value="2" class="form-check-input member_type" required="required" data-validation-required-message="Please select member type" <?php echo ($member->member_type == 2)?'checked':''; ?> disabled><span class="ml-1">Producer Organization</span>
                                                        </label>
                                                       </div>
                                                    </div>			
                                                  </div>
                                            ...
                                            <div class="col-md-6" id="member_search" style="display: none;">
                                                ...
                                                <input type="text" class="form-control numberOnly" id="search_allotment" maxlength="10" minlength="10" name="search_allotment" placeholder="Search with Mobile" data-validation-required-message="Provide the search text" value="" readonly>
                                        ...
                                        <hr style="border-bottom:1px solid black;">
                                            ...
                                            <div class="row row-space">
												<div class="form-group col-md-6">
													...
													<select class="form-control" id="fig_name1" name="fig_name1" data-validation-required-message="Please select FIG" readonly>
                                                        ...
                                                        <div class="col-md-4">
                                                          <div class="form-check-inline form-check">
                                                            <label for="inline-radio1" class="form-check-label">
                                                              <input type="radio" id="alloted_share_paid" name="alloted_share_paid" value="1" class="form-check-input" disabled><span class="ml-1">Yes</span>
                                                            </label>
                                                          </div> 
                                                        </div>
                                                        <div class="col-md-4">
                                                          <div class="form-check-inline form-check">
                                                            <label for="inline-radio2" class="form-check-label">
                                                              <input type="radio" id="alloted_share_paid" name="alloted_share_paid" value="2" class="form-check-input" disabled><span class="ml-1">No</span>
                                                            </label>
                                                           </div>
                                                        </div>			
                                                    </div>
                                        ...
                                        <div class="farmer_to_member_form" id="farmer_to_member_form" style="display: none;">                                                                                                                               
                                            <div class="row row-space">
												<div class="form-group col-md-4">
													...
													<select class="form-control" id="fig_name2" name="fig_name2" required="required" data-validation-required-message="Please select FIG" readonly>
														<option value="">Select FIG </option>
													</select>
													<p class="help-block text-danger"></p>
												</div>
												<div class="form-group col-md-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                          <div class="form-check-inline form-check">
                                                            <label for="inline-radio1" class="form-check-label">
                                                              <input type="radio" id="person_money_paid" required name="person_money_paid" data-validation-required-message="Please select share application money paid" value="1" class="form-check-input" disabled><span class="ml-1">Yes</span>
                                                            </label>
                                                          </div> 
                                                        </div>
                                                        <div class="col-md-6">
                                                          <div class="form-check-inline form-check">
                                                            <label for="inline-radio2" class="form-check-label">
                                                              <input type="radio" id="person_money_paid" required  name="person_money_paid" data-validation-required-message="Please select share application money paid" value="2" class="form-check-input" disabled><span class="ml-1">No</span>
                                                            </label>
                                                           </div>
                                                        </div>			
                                                    </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control numberOnly" maxlength="3" name="person_no_of_share" id="person_no_of_share" placeholder="No. of Shares" data-validation-required-message="Provide the share value" readonly>
                                                    <div class="help-block with-errors text-danger"></div>
                                                </div>
                                            </div>
...
<!--                                        <hr style="border-bottom:1px solid black;">-->
                                        ...
                                        <div class="row row-space">
								            <div class="form-group col-md-4">
													<label for="inputAddress2">Farmer Interest Group (FIG) <span class="text-danger">*</span></label>
													<select class="form-control" id="fig_name3" name="fig_name3" required="required" data-validation-required-message="Please select FIG" readonly>
														<option value="">Select FIG </option>
													</select>
													<p class="help-block text-danger"></p>
												</div>
											<div class="form-group col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                      <div class="form-check-inline form-check">
                                                        <label for="inline-radio1" class="form-check-label">
                                                          <input type="radio" id="fpo_money_paid" name="fpo_money_paid" value="1" class="form-check-input" data-validation-required-message="Select any one of the field" disabled><span class="ml-1">Yes</span>
                                                        </label>
                                                      </div> 
                                                    </div>
                                                    <div class="col-md-6">
                                                      <div class="form-check-inline form-check">
                                                        <label for="inline-radio2" class="form-check-label">
                                                          <input type="radio" id="fpo_money_paid" name="fpo_money_paid" value="2" class="form-check-input" data-validation-required-message="Select any one of the field" disabled><span class="ml-1">No</span>
                                                        </label>
                                                       </div>
                                                    </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="date" class="form-control" id="fpo_date" name="fpo_date" placeholder="Date" value="<?php echo date("Y-m-d");?>" max="2050-12-31" data-validation-required-message="provide the date" readonly>
                                                <div class="help-block with-errors text-danger"></div>
											</div>
                                        </div>   
										...
										<div class="row row-space">
												<div class="form-group col-md-4">
													...
													<input type="text" class="form-control numberOnly this_pin_code" readonly onkeyup="getPincode(this.value)" pattern="[1-9][0-9]{5}" title="Enter only 6 digits" id="pin_code" name="pin_code" placeholder="PINCODE" data-validation-required-message="Please enter pin code" readonly>
								        ...
								        <div class="row row-space">
								            ...
								            <div class="form-group col-md-2">
                                                <label class="form-control-label">No. of Shares <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control numberOnly" maxlength="3" name="fpo_no_of_share" id="fpo_no_of_share" placeholder="No. of Shares" data-validation-required-message="Enter the shares" readonly>
                                                <div class="help-block with-errors text-danger"></div>
                                            </div>
											<div class="form-group col-md-6">
                    ...
                    swal({
                      ...
                      if(result.value) {
                          if(chk_member_type == 1) {
                              ...
                              if(responseArray.member_data[0]){
                                  $('#holder_id').val(responseArray.member_data[0]['user_id']); 
                                  getFPODetails(responseArray.member_data[0]['user_id']);
...
function getAllFIGByFPO(fpo_id, fig_id) {
        $.ajax({
			...
			success:function(response) {
                ...
                $.each(responseArray.fig_list, function(key, value){
					if(value.id == fig_id){
						fig_names += '<option value='+value.id+' selected>'+value.FIG_Name+'</option>';
					} else {
...
$(document).ready(function(){
    $('#buttonContent').show();
    var fpo_id = "<?php echo $member->fpo_id; ?>";
	var fig_id = "<?php echo $member->fig_id; ?>";
    getAllFIGByFPO(fpo_id, fig_id);    
	
	var member_type = "<?php echo $member->member_type; ?>";
	if(member_type == 1){                
        $('#member_search').show();
		$('#farmer_to_member_form').show();
		if("<?php echo $member->share_paid; ?>" == 1){
			$("input[name=person_money_paid][value=1]").attr('checked', true);
		} else {
			$("input[name=person_money_paid][value=2]").attr('checked', true);
		}
		$("#search_allotment").val("<?php echo $member->farmerMobile; ?>");
		$("#person_no_of_share").val("<?php echo $member->totalShare; ?>");
		$('#person_mobile').val("<?php echo $member->farmerMobile; ?>");  
		$('#person_aadhaar_no').val("<?php echo $member->profile_name; ?>"); 
    }else{
        $('#member_search').show();
		$('#fpo_to_member_form').show();
		getFPODetails("<?php echo $member->member_id; ?>");
		if("<?php echo $member->share_paid; ?>" == 1){
			$("input[name=fpo_money_paid][value=1]").attr('checked', true);
		} else {
			$("input[name=fpo_money_paid][value=2]").attr('checked', true);
		}
		$("#search_allotment").val("<?php echo $member->fpoMobile; ?>");
		$("#fpo_no_of_share").val("<?php echo $member->totalShare; ?>");
    }
});
