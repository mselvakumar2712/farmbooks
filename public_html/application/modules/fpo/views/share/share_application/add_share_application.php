                                 ...
                                 <div class="farmer_to_member_form" id="farmer_to_member_form" style="">
                                    <div class="row row-space mt-4">
                                       <div class="form-group col-md-4">
                                          ...
                                          <input type="text" class="form-control numberOnly" id="search_farmer" maxlength="10" minlength="10" name="search_farmer" placeholder="Search with Mobile" data-validation-required-message="Provide the search text" value="" pattern="^[2-9]\d{9}$" title="Select any FPO and try this">
...
<script>
   ...
   $("#search_farmer").change(function() {
      ...
      if(search_farmer_value != "") {
         if(search_farmer_value.length == 10 && (search_farmer_value.charAt(0) >= 2 || search_farmer_value.charAt(0) == 7 || search_farmer_value.charAt(0) == 8 || search_farmer_value.charAt(0) == 9)) {
