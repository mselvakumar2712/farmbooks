                        ...
                        <div class="card-body">	
                           <div class="container">
								<div class="" style="text-align:right;margin-bottom:20px;" >
									<a href="<?php echo base_url('fpo/share/addshareapplication_fpo');?>">
							...
							<tbody id="memberlist">
								...
								?></td>
								<td>
                                    <a href="<?php echo base_url('fpo/share/viewshareapplication_fpo/' . $share_applications[$i]->id); ?>" class="btn btn-warning btn-sm" title="Edit">
