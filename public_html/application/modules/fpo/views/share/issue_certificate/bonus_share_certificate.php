    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Issue of Bonus Share Certificate</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Issue of Bonus Share Certificate</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            ...
            <div class="animated fadeIn">
                    <form action="<?php echo base_url('fpo/share/postbonuscertificate')?>" novalidate="novalidate" method="post" >
					<div class="row">
					<div class="col-md-12">
					<div class="card">
						<div class="card-body">
						...
						<div class="row row-space mt-4">
						   ...
						   <div class="form-group col-md-3">
							...
							<div class="form-group col-md-1 mt-4 text-center">
								<button id="submitSearch"  class="btn-fs btn btn-success text-center" type="submit">Search</button>
							 </div>	
							...
							<form action="<?php echo base_url('fpo/share/postIssueBonusCertificate'); ?>" novalidate="novalidate" method="post" >
                    
									<?php if(isset($list_member)) {
                                        for($i=0;$i<count($list_member);$i++) { ?>
										<input type="hidden" id="member_type" name="<?php echo "list_member[".$i."][member_type]"; ?>" value="<?php echo $list_member[$i]->member_type; ?>">
									...
									<div class="row row-space mt-4" id="list_details">    
										...
										<div class="form-group col-md-2">
											...
											<input type="text" class="form-control shares" id="no_shares<?php echo $i; ?>" name="list_member[<?php echo $i; ?>][no_shares]" value="<?php echo $list_member[$i]->share_allotted; ?>" placeholder="No. of Shares" readonly>
											<p class="help-block text-danger"></p>
										</div>
										<div class="form-group col-md-2">
											<label for="inputAddress2">Certificate No. <span class="text-danger">*</span></label>	
											<input type="text" class="form-control numberOnly certificate" id="certificate_num<?php echo $i; ?>" name="list_member[<?php echo $i; ?>][certificate_num]" value="<?php echo (!empty($list_member[$i]->certificate_num))?$list_member[$i]->certificate_num:''; ?>" maxlength="15" placeholder="Certificate Number" >
										...
										<div class="form-group col-md-3">
											...
											<input type="text" class="form-control numberOnly no_from" name="list_member[<?php echo $i; ?>][distinctive_from]" id="distinctive_from<?php echo $i; ?>" value="<?php echo (!empty($list_member[$i]->distinctive_from))?$list_member[$i]->distinctive_from:''; ?>" maxlength="12" placeholder="Distinctive number from" >
											<p class="help-block text-danger"></p>
										</div>
										<div class="form-group col-md-3">
									...
									<div class="form-row">
										<div class="form-group col-md-12 text-center">
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('fpo/share/bonussharecertificate'); ?>" class="btn-fs btn btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										</div>											 
									 </div>
									<?php } if(empty($list_member)){ ?>
										<div class="form-row mt-4 ">
										<div class="form-group col-md-12 text-center">
										<p class=" text-danger">There is no data to search bonus shares</p>
										</div>
										</div>
										<?php } ?>	
									</form>
