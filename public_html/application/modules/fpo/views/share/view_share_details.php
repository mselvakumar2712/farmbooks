                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="<?php echo base_url('fpo/share/shareholders');?>">Shareholders</a></li>
            ...
            <div class="animated fadeIn">			   			
							...
							<div class="card-body">
								...
								<tbody id="memberlist">
									...
									<tr>
										...
										<td><?php echo fpo_display_date($share_details[$i]->created_on); ?></td>
										...
										<td>
											<?php 
												if($share_details[$i]->allotment_nature == 1) {
													...
													echo "Right";
												}else if($share_details[$i]->allotment_nature == 4) {
													echo "Transferred";
												}else if($share_details[$i]->allotment_nature == 5) {
													echo "Surrendered";
												}
											?>
										</td>
				...
				<div class="row">		
					<div class="col-md-12 text-center">
						<a href="<?php echo base_url('fpo/share/shareholders');?>" id="ok" class="btn btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
					</div>
				</div>
            </div><!-- .animated -->
        </div><!-- .content -->
