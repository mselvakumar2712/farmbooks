      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/addreappointment'); ?>">Add Reappointment of Director</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('fpo/operation/post_reappointment')?>" method="post" id="directorform" name="sentMessage" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
...
function calculatedate(appointment_date){  
	...
	var farmationDate = new Date($("#appointment_date").attr("min"));
...
function getdirectordetail( director_id ) {
    ...
    if(director_id != ''){    
	   $.ajax({
		  url:"<?php echo base_url();?>fpo/operation/getdirectordetail/"+director_id,
		  type:"GET",
           data:"",
		  dataType:"html",
		  cache:false,			
        ...
        swal("Sorry!", "Select any one of the director's");
    } 
}
