                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/viewcompany_secretary/'.$secretary['id']);?>">View Company Secretary</a></li>
                        </ol>
                    </div>
                </div>
            </div>
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="col-md-12 text-center">
											...
											?>
												<a href="<?php echo base_url('fpo/operation/editcompany_secretary/'.$secretary['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Secretary<a>
											<?php
											}
											?>
											<a href="<?php echo base_url('fpo/operation/company_secretarylist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
										</div>
									</div>
								</div>
