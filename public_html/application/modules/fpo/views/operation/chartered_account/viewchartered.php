                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/viewchartered/'.$accountant['id']);?>">View Chartered Accountant</a></li>
                        </ol>
                    </div>
                </div>
            </div>
									...
									<div class="card-body">
										...
										<div class="col-md-12 text-center">
											<?php 
												...
												?>
													<a href="<?php echo base_url('fpo/operation/editchartered/'.$accountant['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Accountant<a>
												<?php
												}
											?>
											<a href="<?php echo base_url('fpo/operation/charteredlist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
