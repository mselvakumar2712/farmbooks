								...
								<div class="card">
									...
									<div class="container-fluid">
										...
										<div class="col-md-12 text-center">
											<a href="<?php echo base_url('fpo/operation/editcluster/'.$cluster['id']);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit Cluster<a>
											<a href="<?php echo base_url('fpo/operation/clusterlist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
										</div>
									</div>
								</div>
							</div>
