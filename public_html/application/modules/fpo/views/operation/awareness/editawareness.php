      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
							...
							<li><a href="<?php echo base_url('fpo/operation/awarenesslist');?>">Awareness Program</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php //echo base_url('fpo/operation/postUpdateAwareness/'.$awareness['id'])?>" method="post" id="editawarenessform" name="sentMessage" novalidate="novalidate" enctype="multipart/form-data">                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
									...
									<div class="container-fluid">
												...
												<input type="text" id="involved_cost_value" name="involved_cost_value" class="form-control numberOnly ml-2 text-right" placeholder="Cost Involved" value="<?php echo $awareness['involved_cost']; ?>" data-validation-required-message="Please provide the involved cost">
															<div class="help-block with-errors text-danger"></div>
														</div>  
													  </div>
										...
										<div class="col-md-12 text-center">
											...
											<a href="<?php echo base_url('fpo/operation/awarenesslist');?>" id="cancel" class="btn btn-fs btn-outline-dark"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
										</div>
									</div>
								</div>
							</div>
...
$(document).ready(function() {
   ...
   $('#sendMessageButton').click(function(event) {
      ...
      $.ajax({
          url: "<?php echo base_url();?>fpo/operation/postUpdateAwareness/<?php echo $awareness['id']; ?>",
          method: 'post',
          data: data,
          cache: false,
          contentType: false,
          ...
          success: function (response) {
               window.location = '<?php echo base_url();?>fpo/operation/awarenesslist';
          },
          error: function (err) {
              console.log(err);
          }
