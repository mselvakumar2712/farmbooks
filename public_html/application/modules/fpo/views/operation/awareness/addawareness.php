      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php //echo base_url('fpo/operation/postAddAwareness')?>" method="post" id="awarenessform" name="sentMessage" novalidate="novalidate" enctype="multipart/form-data">                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                    ...
                                    <label for="">Total Cost ( <span class="fa fa-inr"></span> ) <span class="text-danger">*</span></label>
															<input type="text" id="involved_cost_value" name="involved_cost_value" class="form-control numberOnly ml-2 text-right" maxlength="6" placeholder="Total Cost" data-validation-required-message="Please provide the involved cost">												
															<div class="help-block with-errors text-danger"></div>
														</div>  
													  </div>
														<div class="row row-space">
										...
										<div class="row row-space">
										  ...
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('fpo/operation/awarenesslist');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										  </div>											 
										</div>
									</div>
								</div>
...
$(document).ready(function() {
  ...
  $(document).on('click', '.remove', function() {
   ...
   $('#sendMessageButton').click(function(event) {
      ...
      $.ajax({
          url: "<?php echo base_url();?>fpo/operation/postAddAwareness",
          method: 'post',
          data: data,
          cache: false,
          contentType: false,
