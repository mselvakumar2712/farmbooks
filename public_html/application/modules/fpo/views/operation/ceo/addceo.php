      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/addceo');?>">Add Chief Executive Officer</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('fpo/operation/post_ceo') ?>"  method="post"  id="ceoform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<div class="row row-space">
										  ...
										  <div id="success"></div>
											...
											<a href="<?php echo base_url('fpo/operation/ceolist');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>	
										  </div>											 
										</div>
									</div>
								</div>
