      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/addannualmeeting');?>">Add Annual Meeting</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('fpo/operation/post_annualmeeting')?>"  method="post" enctype="multipart/form-data"  id="directorform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="container-fluid">
												...
												<div class="row row-space">
												  ...
												  <div id="success"></div>
													...
													<a href="<?php echo base_url('fpo/operation/annualmeetinglist');?>" class="btn btn-outline-dark btn-fs ml-2"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
												  </div>											 
												</div>
									</div>
								</div>
...
{
	 $.ajax({
		  url:"<?php echo base_url();?>fpo/operation/getsharecount",
		  type:"GET",
           data:"",
		  dataType:"html",
		  cache:false,			
