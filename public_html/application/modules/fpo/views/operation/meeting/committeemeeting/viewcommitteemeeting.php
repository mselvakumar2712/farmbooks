      ...
      <div class="container-fluid pl-0 pr-0">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/operation/viewcommitteemeeting');?>">View Committee Meeting</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
					<form action="<?php echo base_url('fpo/operation/post_committeemeeting'); ?>" method="post" id="directorform" name="sentMessage" novalidate="novalidate" >                   
				    <div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
                                        ...
                                        <?php }}?>
												...
												<div class="col-md-12 text-center">
													<a href="<?php echo base_url('fpo/operation/editcommitteemeeting/'.$commiteemeeting[0]->id);?>" id="edit" class="btn btn-fs btn-success text-center"><i class="fa fa-edit"></i> Edit<a>
													<a href="<?php echo base_url('fpo/operation/committeemeetinglist');?>" id="ok" class="btn btn-fs btn-outline-dark"><i class="fa fa-arrow-circle-left"></i> Back</a>
												</div>
									</div>
								</div>
							</div>
