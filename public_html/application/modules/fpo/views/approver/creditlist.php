...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/approver/creditlist');?>">List of Credit</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">					
                        ...
                        <th>Status</th>
							...
							<tbody id="contralist">
								<?php foreach($credit_list as $row): ?>
								<tr> 
                          ...
                          <td align="right">
                           ...
                           if($row->status==0) 
									...
									?></td>																			 
									<td>
									 <a href="<?php echo base_url('fpo/approver/viewcredit/' . $row->voucher_no); ?>" data-toggle="modal" data-target="#CreditDetails" class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
   ...
   <div id="CreditDetails" class="modal text-center">
...
$(document).ready(function() {
   ...
   var id =$(this).attr("id");
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/creditstatus/"+id+"/1",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
        ...
        $('a.reject').click(function() {
         ...
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/creditstatus/"+id+"/2",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
