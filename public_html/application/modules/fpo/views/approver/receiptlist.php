...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a class="active" href="<?php echo base_url('fpo/approver/receiptlist');?>">List of Profiles</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                     ...
                     <div class="card-body">	
                        ...
                        <th>Status</th>
                           ...
                           <td class="text-center">
                              <a href="<?php echo base_url('fpo/approver/viewreceipt/'.$row->voucher_no); ?>" id="<?php echo $row->counter; ?>" data-toggle="modal" data-target="#ReceiptDetails" class="btn btn-warning btn-sm" title="View"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a> 
    ...
    <div id="ReceiptDetails" class="modal text-center">
...
$(document).ready(function() {
   ...
   var id =$(this).attr("id");
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/receiptstatus/"+id+"/1",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
        ...
        $('a.reject').click(function() {
         ...
         swal({
          ...
          if (result.value) {  
           jQuery.ajax({
            url:"<?php echo base_url();?>fpo/approver/receiptstatus/"+id+"/2",
            type:"GET",
            data:"",
            dataType:"html",
            cache:false,			
