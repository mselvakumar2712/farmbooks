            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form name="sentMessage" method="post" action="<?php echo base_url('fpo/updatecrop/crop_harvest'); ?>" novalidate="novalidate" id="add_updatecrop">
							   <div class="row row-space">
									...
									<div class="form-group col-md-6">
										...
										<input type="date" class="form-control" name="harvest_date" id="harvest_date" placeholder="Date of Harvest" required="required" data-validation-required-message="Please enter date of harvest." value="<?php echo date('Y-m-d'); ?>" max="<?php echo $currentYear; ?>">
										<p class="help-block text-danger"></p>
									</div>
								</div>
                              ...
                              <div class="row row-space">
                                 <div class="form-group col-md-8" id="div1"></div>
                           ...
                           <div class="row row-space">
                             ...
                             <div class="form-group col-md-3 manual both" style="display:none;">
							 ...
							 <div class="form-group col-md-3 machine both" style="display:none;">
							...
							<div class="row row-space">
                                <div class="form-group col-md-3">
                                 ...
                                 <input type="text" class="form-control numberOnly text-right" name="harvest_cost" id="harvest_cost" maxlength="6" placeholder="0.00">
                                </div>
                                <div class="form-group col-md-4">
							...
							<div class="row row-space">
								<div class="form-group col-md-6" id="sales_visible"></div>
						     </div>
...
$('form').submit(function(e){	
	...
	const updateharvestdata = $('#add_updatecrop').serializeObject();
		...
		swal('Sorry!', 'Please provide mandatory fields');
	}
});
...
function getcropDetail(farmer_id){
	...
	if(farmer_id!=''){ 
			...
			success:function(response) {
				...
				if(responseArray.status==1){
					if(Object.keys(responseArray).length > 0) {
						$("#crop_variety").append($('<option></option>').val('').html('Select Variety'));
					} else {
						$("#crop_variety").append($('<option></option>').val('').html('Select Variety'));  
					}
		...
		swal('Sorry!', 'Please provide the farmer');
		$("#crop_variety").append($('<option></option>').val('').html('Select Variety'));
	}
}	
