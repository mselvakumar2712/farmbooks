                    ...
                    <div class="card">
                        <div class="card-body">
									<div class="container-fluid">
										<form id="" name="sentMessage" action="<?php echo base_url('fpo/updatecrop/postexpenses_update')?>" method="post" novalidate="novalidate" >              
											...
											<div class="row rowspace">	
												<div class="form-group col-md-3">	
													...
													<input type="text" class="form-control numberOnly " name="cost_of_nutrient" id="cost_of_nutrient" placeholder="Cost of Nutrient">	
												</div>	
												<div class="form-group col-md-3">	
											...
											<div class="row rowspace">												
												...
												<div class="form-group col-md-3">
													...
													<input type="text" class="form-control numberOnly" onfocusin="focusFunction(event)" name="total" id="total" placeholder="Total Expenses" required="required" >
												   <p class="help-block text-danger"></p>
												</div>
											</div>
									...
									<div class="form-group col-md-12 text-center">
										...
										<a href="<?php echo base_url('fpo/updatecrop/expenseslist');?>" class="btn btn-outline-dark btn-fs"><i class="fa fa-close" aria-hidden="true"></i> Cancel</a>
									</div>                                  
								</form>
							</div>
						</div>
...
$("#farmer_id").change(function() {
	...
	if(farmer_id!=''){
		$.ajax({
			url:"<?php echo base_url();?>fpo/updatecrop/cropvarietymastersDropdown/"+farmer_id,
			type:"GET",
			data:"",
			dataType:"html",
			cache:false,			
...
$("#variety").change(function(){   
	...
	if(variety_id!=''){
        ...
        $.ajax({
			url:"<?php echo base_url();?>fpo/updatecrop/costseed/"+variety_id,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,			
        ...
        $.ajax({
			url:"<?php echo base_url();?>fpo/updatecrop/updatecost/"+variety_id,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,			
                ...
                if(responseArray.status == 1){
					$.each(responseArray.updatecost_list,function(key,value){
						...
						if(value.update_type==2){
							document.getElementById("cost_of_fertilizer").value = str;
						} else if(value.update_type==3){
							document.getElementById("cost_of_pesticides").value = str;
						} else if(value.update_type==1){
							document.getElementById("cost_of_nutrient").value = str;
						} else {
							document.getElementById("cost_of_weeding").value = str;
						} 
				    });
				}
            },
		...
		$.ajax({
			url:"<?php echo base_url();?>fpo/updatecrop/costharvest/"+variety_id,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,			
		...
		/*	
		$.ajax({
			url:"<?php echo base_url();?>fpo/updatecrop/postharvestdetail/"+variety_id,
			type:"GET",
			data:"",
			dataType:"html",
            cache:false,			
	...
	*/
		...
		swal('Sorry!', 'Please provide the variety field');
	} 
});     
