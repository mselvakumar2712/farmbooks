                    ...
                    <form id="crop_standardForm" name="sentMessage" method="post" action="<?php echo base_url('fpo/crop/post_crop'); ?>" novalidate="novalidate" enctype='multipart/form-data'>
                      <div class="row row-space">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select id="land_id" name="land_id" class="form-control">
                      ...
                      <div class="row row-space">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="date" class="form-control" name="seed_date" id="seed_date" placeholder="Date of seed plant" data-validation-required-message="Please enter date of seed plant" title="If need date picker, click the arrow"
                            min="<?php echo $beforeMonth; ?>" max="<?php echo $afterMonth; ?>" onfocusout="calculateExpectedHarverst(this.value);">
                          <p class="help-block text-danger"></p>
                        </div>
                      ...
                      <div class="row row-space">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="date" class="form-control" name="transplant_date" id="transplant_date" placeholder="Date of Transplanting" title="If need date picker, click the arrow" min="<?php echo $beforeMonth; ?>"
                            max="<?php echo $afterMonth; ?>" onfocusout="calculateExpectedHarverst(this.value);">
                        </div>
                      </div>
                      ...
                      <div class="row row-space">
                        ...
                        <div class="form-group col-md-2">
                          ...
                          <input type="text" class="form-control numberOnly text-right" maxlength="6" minlength="2" step="0.01" name="seed_cost" placeholder="0.00">
                        </div>
                        <div class="form-group col-md-4">
  ...
  <script type="text/javascript">
    ...
    function getCropDetail(category_id) {
      ...
      if (category_id != '') {
          ...
          success: function(response) {
            ...
            if (responseArray.status == 1) {
              if (Object.keys(responseArray).length > 0) {
                $("#crop_subcategory").append($('<option></option>').val('').html('Select Sub-Category'));
              } else {
                $("#crop_subcategory").append($('<option></option>').val('').html(''));
              }
        ...
        swal('Sorry!', 'Please provide category field');
      }
    }
    ...
    function getsubcategoryDetail(subcategory_id) {
      ...
      if (subcategory_id != '') {
        ...
        swal('Sorry!', 'Please provide sub-category field');
      }
    }
    ...
    function getCropnameDetail(name_id) {
      ...
      if (name_id != '') {
        ...
        swal('Sorry!', 'Please provide cropname field');
      }
    }
 ...
 */
    ...
    function calculateExpectedHarverst(transplant_date) {
      ...
      if (cropname_id != '') {
        ...
        document.getElementById("seed_date").value = '';
        swal('Sorry!', 'Please select crop fields');
      }
    }
      ...
      if (farmer_id != '') {
        $.ajax({
          ...
          success: function(response) {
            ...
            responseArray = $.parseJSON(response);
            if (responseArray.status == 1) {
              $("#land_id").append($('<option></option>').val('').html('Select Land Identification'));
    ...
    if (window.File && window.FileList && window.FileReader) {
      $("#crop_photo").on("change", function(e) {
        ...
        for (var i = 0; i < filesLength; i++) {
          ...
          var filetype = f.type;
          if (filetype == 'image/jpeg' || filetype == 'image/jpg' || filetype == 'image/png') {} else {
            fileCount = fileCount - filesLength;
            $("#crop_photo").val('');
