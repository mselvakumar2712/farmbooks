...
class Setting_Model extends CI_Model
{
    ...
    public function getShareValueByFpo()
    {
    ...
    public function getShareSettingFpo()
    {
        $fpo_id = $this->session->userdata('user_id');
    ...
    public function paidUpcapital()
    {
        ...
        $this->db->where(array('fpo_gl_trans.fpo_id' => $fpo_id,'fpo_gl_trans.account_code' => '3010102'));
        return $this->db->get()->row();
    }
    ...
    public function getPurchaseTransactionById($fpo_id)
    {
    ...
    public function update_sellingprice($sellingPrice, $purchaseOrderID)
    {
