...
class Farmer_Model extends CI_Model
{
    ...
    public function farmersLandDetailsList()
    {
        ...
        $this->db->where(array('trv_land_holdings.status' => 1,'trv_farmer.created_by' => $this->session->userdata('user_id'),'trv_farmer.land_holdings' => 1));
    ...
    public function farmersFarmImplementsList()
    {
        ...
        $this->db->where(array('trv_farm_implements.status' => 1, 'trv_farmer.created_by' => $this->session->userdata('user_id'),'trv_farmer.farm_implements' => 1));
    ...
    public function farmersLiveStocksList()
    {
        ...
        $this->db->where(array('trv_live_stocks.status' => 1, 'trv_farmer.created_by' => $this->session->userdata('user_id'),'trv_farmer.live_stocks' => 1));
        return $this->db->get()->result();
    }
